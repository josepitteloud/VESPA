...
---------V02 - Results just for Adsmartable Boxes
...
---V02 -- Add Pivot for just Adsmartable Boxes-----
...
,min(stb.x_model_number) as model_number
  INTO vespa_analysts.project042_adsmartable_box_details -- drop table vespa_analysts.project042_adsmartable_box_details;
...
--alter table vespa_analysts.project042_adsmartable_box_details delete adsmartable_box;
alter table vespa_analysts.project042_adsmartable_box_details add adsmartable_box  tinyint;

update vespa_analysts.project042_adsmartable_box_details
set adsmartable_box =case when pvr_type in ('PVR5','PVR6','PVR7') 
            OR ( pvr_type='PVR4' AND  manufacturer in ('Pace','Samsung','Thomson')) 
          then 1 else 0 end
from vespa_analysts.project042_adsmartable_box_details
;
commit;

alter table vespa_analysts.project042_adsmartable_box_details add subscriber_id  integer;

update vespa_analysts.project042_adsmartable_box_details
set subscriber_id =b.subscriberid
from vespa_analysts.project042_adsmartable_box_details as a
...
/*
alter table vespa_analysts.project042_adsmartable_box_details add pvr  tinyint;
alter table vespa_analysts.project042_adsmartable_box_details add box_type  varchar(2);

update vespa_analysts.project042_adsmartable_box_details
set pvr =case when pvr_type like '%PVR%' then 1 else 0 end
,box_type =case when box_type like '%HD%' then 'HD' else 'SD' end
from vespa_analysts.project042_adsmartable_box_details
;
*/
commit;
...
---Pivot For Live or Playback Viewing
--drop table #live_playback_channel_pivot_adsmartable_only;
select  channel_name_inc_hd
, spot_duration 
,viewing_time_of_day
, case when break_type = 'CB' then '01: Centre Break' when break_type = 'EB' then '02: End Break' else '03: Other' end as break_position
...
into #live_playback_channel_pivot_adsmartable_only
from vespa_analysts.vespa_spot_data_By_channel as a
left outer join vespa_analysts.project042_adsmartable_box_details as b
on a.subscriber_id=b.subscriber_id
where b.adsmartable_box =1
group by channel_name_inc_hd
, spot_duration 
,viewing_time_of_day
,break_position
...
--select channel_name_inc_hd , count(*) from #live_playback_channel_pivot group by channel_name_inc_hd;
--select count(*) from  #live_playback_channel_pivot_adsmartable_only;
select * from #live_playback_channel_pivot_adsmartable_only;
output to 'C:\Users\barnetd\Documents\Project 042 - Definition of a view\live_playback_pivot_data_adsmartable_only.csv' format ascii;


---Pivot For Live Viewing Only
--drop table #live_playback_channel_pivot_adsmartable_only;
select  channel_name_inc_hd
, spot_duration 
,viewing_time_of_day
...
into #live_channel_pivot_adsmartable_only
from vespa_analysts.vespa_spot_data_By_channel as a
left outer join vespa_analysts.project042_adsmartable_box_details as b
on a.subscriber_id=b.subscriber_id
where b.adsmartable_box =1
...
--select channel_name_inc_hd , count(*) from #live_playback_channel_pivot group by channel_name_inc_hd;
--select count(*) from  #live_playback_channel_pivot_adsmartable_only;
select * from #live_channel_pivot_adsmartable_only;
output to 'C:\Users\barnetd\Documents\Project 042 - Definition of a view\live_pivot_data_adsmartable_only.csv' format ascii;
