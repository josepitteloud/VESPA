...
create table vespa_analysts.second_by_second_20120115_sky1_summary
(
second_viewed                      datetime                not null
,viewed                             smallint                not null
,viewed_live                        smallint                null
...
set @programme_time_end =cast('2012-01-15 17:51:00' as datetime);
...
insert into vespa_analysts.second_by_second_20120115_sky1_summary

select second_viewed
,sum(viewed)
,sum(viewed_live)
,sum(viewed_playback)
,sum(viewed_playback_within_163_hours)
...
,sum(viewed_playback_within_6_days_163h)

,sum(viewed_playback_within_163h_14_days)
,sum(viewed_playback_within_14_21_days)
,sum(viewed_playback_within_21_31_days)
...
delete from vespa_analysts.second_by_second_20120115_sky1 where second_viewed is not null or second_viewed is null;
...
,sum(viewed_12x_speed)
,sum(viewed_30x_speed)
from vespa_analysts.second_by_second_20120115_sky1_summary
...
commit;
select count(*) from vespa_analysts.second_by_second_20120115_sky1_summary;

select * from vespa_analysts.second_by_second_20120115_sky1_summary
