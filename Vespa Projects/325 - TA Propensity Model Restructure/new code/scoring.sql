...
-- )
-- select 201502
--       ,'sharmaa.view_attachments_201502'
--       ,''
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,Snapshot_Date)))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[2_Years_Prior])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[1_Year_Prior])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[10_Months_Prior])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[9_Months_Prior])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[6_Months_Prior])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[3_Months_Prior])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[1_Month_Prior])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[1_Month_Future])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[2_Months_Future])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[3_Months_Future])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[4_Months_Future])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[5_Months_Future])))
--       ,dateadd(dd,-1,dateadd(mm,1,dateadd(dd,1,[6_Months_Future])))
-- from sourcedates
-- where [reference] = 201501
-- ;
...
;
                -- output
            insert into TA_MODELING_RAW_DATA_scoring(
                   account_number
                  ,[reference]
                  ,dtv_first_act_date
                  ,[10_Months_Prior]
...
;
  ...
  select account_number
    into #accounts
    from TA_MODELING_RAW_DATA_scoring
group by account_number
;
...
create hg index hgacc on #changes(account_number);
  ...
  update TA_MODELING_RAW_DATA_scoring as bas
...
--truncate table TA_MODELING_RAW_DATA_scoring

select top 10 * from TA_MODELING_RAW_DATA_scoring
...
select SC_In_Next_4_Months_Flag,count() from TA_MODELING_RAW_DATA_scoring
group by SC_In_Next_4_Months_Flag

select PO_In_Next_4_Months_Flag,count() from TA_MODELING_RAW_DATA_scoring
group by PO_In_Next_4_Months_Flag
