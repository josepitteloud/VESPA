...
*/
  ...
  as begin
            ...
            select account_number
             ...
             where (@country = 0 and panel_no in (5, 11, 10, 15))
          ...
          group by account_number
            ...
            delete from temp_panbal_SAV
             where account_number in (select account_number from temp_dupes)
                ...
                if @country = 0 begin
                      ...
                      select wat.account_number
                        from waterfall_base as wat
                             left join temp_panbal_SAV as sav on sav.account_number = wat.account_number
                       where wat.knockout_level = 9999
