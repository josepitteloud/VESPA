...
/*
left join accs as acc on sav.account_number = acc.account_number
*/
             where panel in (2, 7, 11, 12, 10)
/*
or acc.account_number is not null
*/
...
left join accs as acc on sav.account_number = acc.account_number
*/
             where panel in (5, 6, 15)
/*
and acc.account_number is null
*/
          ...
          group by account_number
            ...
            select segment_id
                  ,sum(case when (pty_country_code = 'GBR' and @country = 0) or (pty_country_code = 'IRL' and @country = 1) then 1 else 0 end) as Sky_Base_Households
