...
CREATE or REPLACE procedure vespa_comscore_skygo_channelmap_refresh(
...
--set @data_run_date = '2014-08-02'
    ...
    IF object_id('VESPA_Comscore_SkyGo_Channel_Mapping_tbl') IS NULL
        BEGIN
            CREATE TABLE VESPA_Comscore_SkyGo_Channel_Mapping_tbl(
                        station_name       varchar(70)          DEFAULT NULL,
            ...
            create index VESPA_Comscore_skygo_cm_servkey_idx on VESPA_Comscore_SkyGo_Channel_Mapping_tbl(service_key)
            create index VESPA_Comscore_skygo_cm_stname_idx  on VESPA_Comscore_SkyGo_Channel_Mapping_tbl(station_name)
            commit
        END
    ...
    create DTTM index VESPA_Comscore_SkyGo_channel_lookup_a_vespa_idx on VESPA_Comscore_SkyGo_channel_lookup_a_tmp(vespa_channel_max)
    commit
    ...
    select cm.station_name, sk.channel_name, sk.service_key
      into VESPA_Comscore_SkyGo_Channel_Mapping_tbl_tmp
      from barbera.VESPA_Comscore_SkyGo_RawChannels_tmp cm
             LEFT JOIN
           barbera.VESPA_Comscore_SkyGo_channel_lookup_b_tmp sk ON lower(cm.station_name) = lower(sk.channel_name)
     group by cm.station_name, sk.channel_name, sk.service_key
    ...
    DELETE FROM VESPA_Comscore_SkyGo_Channel_Mapping_tbl m
      from VESPA_Comscore_SkyGo_Channel_Mapping_tbl_tmp t
     where m.station_name = t.station_name

    INSERT into VESPA_Comscore_SkyGo_Channel_Mapping_tbl
       select *
         from VESPA_Comscore_SkyGo_Channel_Mapping_tbl_tmp
    commit
    ...
    drop table VESPA_Comscore_SkyGo_Channel_Mapping_tbl_tmp
    drop table barbera.VESPA_Comscore_SkyGo_RawChannels_tmp
