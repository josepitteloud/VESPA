...
select  case when Cable_area is null then 'Unknown' when cable_area='N/A' then 'Unknown' else cable_area end as cable_area_type
,count(*) as unweighted_accounts
,sum(overall_project_weighting) as weighted_accounts
,sum(case when adsmartable=1 then 1 else 0 end) as adsmartable_unweighted_accounts
,sum(case when adsmartable=1 then overall_project_weighting else 0 end) as adsmartable_weighted_accounts
...
select case when HomeOwner is null then 'Unknown' else HomeOwner end as HomeOwner_group
,count(*) as unweighted_accounts
,sum(overall_project_weighting) as weighted_accounts
,sum(case when adsmartable=1 then 1 else 0 end) as adsmartable_unweighted_accounts
,sum(case when adsmartable=1 then overall_project_weighting else 0 end) as adsmartable_weighted_accounts
...
select case when Kids_Aged_LE4  is null then 'Unknown' when Kids_Aged_LE4  ='M' then 'Unknown' else Kids_Aged_LE4   end as Kids_Aged_LE4_group
,count(*) as unweighted_accounts
,sum(overall_project_weighting) as weighted_accounts
,sum(case when adsmartable=1 then 1 else 0 end) as adsmartable_unweighted_accounts
,sum(case when adsmartable=1 then overall_project_weighting else 0 end) as adsmartable_weighted_accounts
...
select case when Kids_Aged_5to11     is null then 'Unknown' when Kids_Aged_5to11     ='M' then 'Unknown' else Kids_Aged_5to11     end as Kids_Aged_5to11_group
,count(*) as unweighted_accounts
,sum(overall_project_weighting) as weighted_accounts
,sum(case when adsmartable=1 then 1 else 0 end) as adsmartable_unweighted_accounts
,sum(case when adsmartable=1 then overall_project_weighting else 0 end) as adsmartable_weighted_accounts
...
select case when Kids_Aged_12to17       is null then 'Unknown' when Kids_Aged_12to17        ='M' then 'Unknown' else Kids_Aged_12to17       end as Kids_Aged_12to17_group
,count(*) as unweighted_accounts
,sum(overall_project_weighting) as weighted_accounts
,sum(case when adsmartable=1 then 1 else 0 end) as adsmartable_unweighted_accounts
,sum(case when adsmartable=1 then overall_project_weighting else 0 end) as adsmartable_weighted_accounts
...
select case when Mirror_has_children   is null then 'Unknown' when Mirror_has_children='M' then 'Unknown' when Mirror_has_children='missing' then 'Unknown'  else Mirror_has_children   end as Mirror_has_children_GROUP
,count(*) as unweighted_accounts
,sum(overall_project_weighting) as weighted_accounts
,sum(case when adsmartable=1 then 1 else 0 end) as adsmartable_unweighted_accounts
,sum(case when adsmartable=1 then overall_project_weighting else 0 end) as adsmartable_weighted_accounts
...
select case when Mirror_ABC1     is null then 'Unknown'  else Mirror_ABC1  end as Mirror_ABC1_Group 
,count(*) as unweighted_accounts
,sum(overall_project_weighting) as weighted_accounts
,sum(case when adsmartable=1 then 1 else 0 end) as adsmartable_unweighted_accounts
,sum(case when adsmartable=1 then overall_project_weighting else 0 end) as adsmartable_weighted_accounts
...
select case when Sky_Go_Reg is null then 'c) Unknown'  when sky_go_reg=1 then 'a) Yes'  when sky_go_reg=0 then 'b) No' else  'c) Unknown' end as sky_go_reg_group
,count(*) as unweighted_accounts
,sum(overall_project_weighting) as weighted_accounts
,sum(case when adsmartable=1 then 1 else 0 end) as adsmartable_unweighted_accounts
,sum(case when adsmartable=1 then overall_project_weighting else 0 end) as adsmartable_weighted_accounts
...
select case when sky_id is null then 'Unknown' else sky_id end as sky_id_group
,sum(spot_duration/30) as unweighted_impacts
,sum(overall_project_weighting*(spot_duration/30)) as weighted_impacts
,sum(case when adsmartable is null then 0 else adsmartable*spot_duration/30 end) as adsmartable_hh_unweighted_impacts
,sum(case when adsmartable is null then 0 else adsmartable*overall_project_weighting*(spot_duration/30) end) as adsmartable_hh_weighted_impacts
...
,sum(overall_project_weighting*(spot_duration/30)) as thirty_second_impact_equivalents
...
,entertainment_extra_status
,premium_details
,case when mosaic_group is null then 'p )Unclassified' when mosaic_group ='missing' then 'p )Unclassified' else mosaic_group end as mosaic
...
,case when box_type is null then 'Unknown' else box_type end as box_type_for_hh
, case when bt_fibre_area is null then 'Unknown' else bt_fibre_area end as bt_fibre_area_type    
,case when Cable_area is null then 'Unknown' when cable_area='N/A' then 'Unknown' else cable_area end as cable_area_type
, case when exchange_id     is null then 'Unknown' else exchange_id     end as exchange_id_name
,case when  exchange_status   is null then 'UNKNOWN' else exchange_status end as exchange_status_type
,case when  exchange_unbundled   is null then 'UNKNOWN' else exchange_unbundled end as exchange_unbundled_type 
...
,case when government_region   is null then 'Unknown' else government_region   end as government_region_group
,case when HomeOwner is null then 'd) Unknown' when HomeOwner='missing' then 'd) Unknown' else HomeOwner end as HomeOwner_group
,case when household_composition
 is null then 'UNCLASSIFIED' else household_composition end as household_composition_group
...
,case when Kids_Aged_LE4  is null then 'Unknown' when Kids_Aged_LE4  ='M' then 'Unknown' else Kids_Aged_LE4   end as Kids_Aged_LE4_group
,case when Kids_Aged_5to11     is null then 'Unknown' when Kids_Aged_5to11     ='M' then 'Unknown' else Kids_Aged_5to11     end as Kids_Aged_5to11_group
, case when Kids_Aged_12to17       is null then 'Unknown' when Kids_Aged_12to17        ='M' then 'Unknown' else Kids_Aged_12to17       end as Kids_Aged_12to17_group
...
,case when Mirror_has_children   is null then 'Unknown' when Mirror_has_children='M' then 'Unknown' when Mirror_has_children='missing' then 'Unknown'  else Mirror_has_children   end as Mirror_has_children_GROUP
,case when Mirror_ABC1     is null then 'Unknown'  else Mirror_ABC1  end as Mirror_ABC1_Group 
,case when Total_miss_pmt  is null then 'No' when  Total_miss_pmt>0 then 'Yes' else 'No'  end as Total_miss_pmt_group
...
,case when current_offer  is null then 'No' when  current_offer>0 then 'Yes' else 'No'  end as sports_downgrades_group
, case when barb_desc_itv       is null then 'Unknown' else barb_desc_itv     end as region
,case when Sky_Go_Reg is null then 'c) Unknown'  when sky_go_reg=1 then 'a) Yes'  when sky_go_reg=0 then 'b) No' else  'c) Unknown' end as sky_go_reg_group
, case when cust_tenure is null then 'Unknown'   else cust_tenure end as cust_tenure_group
...
on a.account_number = b.account_number
where b.account_number is not null
--and right(b.account_number,2) in ('36')
;

select * from #all_vals;
output to 'C:\Users\barnetd\Documents\Project 114 - Adsmart\test_onepc_output.csv' format ascii;
...
.a.spot_channel_name
,b.*
into project114_0_point_1_pc_sample
from Project_114_viewing_table as a
left outer join project_114_base_Accounts as b
on a.account_number = b.account_number
where b.account_number is not null
