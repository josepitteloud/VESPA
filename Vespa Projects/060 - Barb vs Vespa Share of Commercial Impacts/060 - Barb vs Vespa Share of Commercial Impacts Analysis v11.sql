...
select * into vespa_analysts.project060_all_viewing_same_minutes from vespa_analysts.project060_all_viewing 
where
...
set @minute_start_time_local = cast ('2012-05-02 15:00:00' as datetime);
set @minute_end_time_local = cast ('2012-05-02 15:10:00' as datetime);
