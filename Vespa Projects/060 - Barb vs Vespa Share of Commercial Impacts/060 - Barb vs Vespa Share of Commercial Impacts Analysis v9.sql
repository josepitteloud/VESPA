...
set @minute_start_time_local = cast ('2012-05-02 03:00:00' as datetime);
set @minute_end_time_local = cast ('2012-05-02 03:10:00' as datetime);
...
commit
create hg index idx1 on vespa_analysts.project060_rank_viewing_in_minute(subscriber_id)
create hg index idx2 on vespa_analysts.project060_rank_viewing_in_minute(real_time_minute)
...
where most_watched_record =1 and total_seconds_viewed_of_broadcast_minute>=15 and total_seconds_viewed_in_minute_by_subscriber>=30 
