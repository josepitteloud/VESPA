...
SET @var_period_start           = '2012-04-20';
...
from
        vespa_analysts.project060_all_viewing_20120428 base left outer join vespa_analysts.vespa_max_caps_live_playback caps
    on (
...
update vespa_analysts.project060_spot_summary_viewing_figures20120428
set sales_house = case when b.sales_house is null then 'Unknown' else b.sales_house end
from vespa_analysts.project060_spot_summary_viewing_figures20120428 as a
left outer join vespa_analysts.barb_sales_house_lookup as b
on cast(a.sales_house_identifier as integer)=cast(b.sales_house_identifier as integer)
;
...
select *,cast(weighted_views as real) * cast((cast(spot_duration_integer as real)/30) as decimal(32,12)) as thirty_second_equivalent_impacts  from vespa_analysts.project060_spot_summary_viewing_figures20120428;
...
from
        vespa_analysts.project060_all_viewing_20120427 base left outer join vespa_analysts.vespa_max_caps_live_playback caps
    on (
        date(base.adjusted_event_start_time) = caps.event_start_day
        and datepart(hour, base.adjusted_event_start_time) = caps.event_start_hour
        and base.live = caps.live
...
update vespa_analysts.project060_spot_summary_viewing_figures20120427
set sales_house = case when b.sales_house is null then 'Unknown' else b.sales_house end
from vespa_analysts.project060_spot_summary_viewing_figures20120427 as a
left outer join vespa_analysts.barb_sales_house_lookup as b
on cast(a.sales_house_identifier as integer)=cast(b.sales_house_identifier as integer)
;
...
select *,cast(weighted_views as real) * cast((cast(spot_duration_integer as real)/30) as decimal(32,12)) as thirty_second_equivalent_impacts  from vespa_analysts.project060_spot_summary_viewing_figures20120427;
output to 'C:\Users\barnetd\Documents\Project 060 - Share of Consolidated Impacts\soci_pivot_data_28th_april.csv' format ascii;
--select count(*) from vespa_analysts.project060_spot_summary_viewing_figures;
