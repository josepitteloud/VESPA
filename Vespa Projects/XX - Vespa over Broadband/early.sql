...
drop table vobb_link_data_early6k;

create table     vobb_link_data_early6k(Subscriber_ID  int
                                        ,Account_Number varchar(30)
                                        ,Model          varchar(30)
                                        ,Location       varchar(30)
...
from '/ETL013/prod/sky/olive/data/share/clarityq/export/Decision_Sciences/Jon/vobb_link_data_early6k.csv'
QUOTES OFF
ESCAPES OFF
NOTIFY 1000
skip 1
;
  ...
  insert into vobb_link_data_early6k(Subscriber_ID
                          ,Account_Number
                          ,Model
                          ,Location
                          ,panel_expected
...
;
  ...
  select cal.calendar_date
    ...
    from sk_prod.sky_calendar               as cal
         cross join vobb_link_data_early6k  as lnk
   ...
   where cal.calendar_date between '2013-12-25' and date(now())
;
  ...
  select subscriberid
   ...
   where cal.calendar_date between '2013-12-25' and now()
