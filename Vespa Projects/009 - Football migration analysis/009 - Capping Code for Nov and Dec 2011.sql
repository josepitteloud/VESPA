...
*
*   MAXIMUM duration lengths are in 'vespa_201111_201112_201112_max_caps'
...
SET @var_rep_period_end    = '2011-12-31';

-- drop the table if it exists
IF object_id('vespa_201111_201112_201112_max_caps') IS NOT NULL DROP TABLE vespa_201111_201112_max_caps;
-- recreate table
create table vespa_201111_201112_max_caps
(
...
-- add indexes to vespa_201111_201112_max_caps
create hng index idx1 on vespa_201111_201112_max_caps(event_start_day);
create hng index idx2 on vespa_201111_201112_max_caps(event_start_hour);
create hng index idx3 on vespa_201111_201112_max_caps(live);

-- create min caps
IF object_id('vespa_201111_201112_201112_min_cap') IS NOT NULL DROP TABLE vespa_201111_201112_min_cap;
create table vespa_201111_201112_min_cap (
    cap_secs as integer
);
insert into vespa_201111_201112_min_cap (cap_secs) values (6);


grant select on vespa_analysts.vespa_201111_201112_max_caps to public;
grant select on vespa_analysts.vespa_201111_201112_min_cap to public; 

---Add Values for 4 am on 7th and 3 and 4 am on 8th for Playback Activity - Set to 75min---

--input into vespa_analysts.vespa_201111_201112_max_caps from 
--'C:\Users\barnetd\Documents\Project 009 - Retaining an audience\November Capping Data Additions.csv' format ascii;



--drop table vespa_analysts.vespa_201111_201112_max_caps_test;

-- select count(*) from vespa_201111_201112_max_caps
-- 1440 = 30*48 (48 records per day) - check   - Comes out at 1437
--select * from vespa_201111_201112_max_caps order by event_start_day ,event_start_hour , live
--select  event_start_day , count(*) , sum(live) from vespa_201111_201112_max_caps group by event_start_day order by event_start_day;
--select  event_start_day , count(*) , sum(live) from vespa_201111_201112_max_caps_test group by event_start_day order by event_start_day;
