...
set @min_tx_start_time = (select min(tx_start_datetime_utc) from  vespa_analysts.VESPA_all_viewing_records_20110811_20110818 );
set @max_tx_end_time = (select max(tx_end_datetime_utc) from  vespa_analysts.VESPA_all_viewing_records_20110811_20110818 );
...
,channel_name_inc_hd  varchar(xx)
