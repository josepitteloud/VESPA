...
select	step1.datehour_
		...
		,count	(distinct
					(
						case	when step1.dk_Action_id in(02400,03000,00001,02000,02010,02002,02005) then step1.dk_serial_number||'-'||step1.home_session_lvl2_id||'-'||step1.home_session_lvl2_grain 
								else null 
						end
					)
