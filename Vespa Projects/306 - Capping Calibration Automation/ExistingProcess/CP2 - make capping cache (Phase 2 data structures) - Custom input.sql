...
-- ####################################################################################################
-- ####################################################################################################
--            This version uses a CUSTOM INPUT table - "Capping2_00_Raw_Uncapped_Events"
-- ####################################################################################################
-- ####################################################################################################
-- ####################################################################################################
...
if object_id('CP2_build_days_caps_CUSTOM') is not null drop procedure CP2_build_days_caps_CUSTOM;
commit;

go

create procedure CP2_build_days_caps_CUSTOM
...
if object_id('CP2_Profile_Boxes_CUSTOM') is not null drop procedure CP2_Profile_Boxes_CUSTOM;
commit;

go

create procedure CP2_Profile_Boxes_CUSTOM
...
end; -- procedure CP2_Profile_Boxes_CUSTOM
