...
create or replace procedure V306_CP2_M01_Process_Manager
                                                                        ...
                                                                        --- days offset from true ntile silo
                                                                        ,       @ntile_offset           int               =       0        --- use 0 for normal runs
                                                                        ,       @run_type               tinyint               =         0        --- 0 = run normally, 1 = ntile creation only, 2 = apply capping only
as begin
        ...
        execute V306_CP2_M00_Initialise @hard_initialise,@run_type
        commit
...
*/
            ...
            execute V306_CP2_M07_5_Save_metadata_params
                ...
                begin
                        ...
                        execute V306_CP2_M05_Build_Day_Caps_1
                                                                        @capping_date
                                                                        , @iter_calibration
                        commit
                if @run_type in (0,1)  begin
                        execute V306_CP2_M05_Build_Day_Caps_2
                                                                        @capping_date
                                                                        , @iter_calibration
                        end
                        commit
                if @run_type in (0,2)  begin
                      execute V306_CP2_M05_Build_Day_Caps_3
                                                                       @capping_date
                                                                        , @iter_calibration
                                                                                ,@ntile_offset
                        end
