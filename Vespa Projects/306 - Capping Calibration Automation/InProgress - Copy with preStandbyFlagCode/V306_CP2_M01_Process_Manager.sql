...
create or replace procedure V306_CP2_M01_Process_Manager
                                                                        ...
                                                                        ,       @include_pre_standby_event_flag bit     =     0        -- if =1 then pre_standby events will be included within the NTile setting process
as begin
            ...
            execute V306_CP2_M07_5_Save_metadata_params
                ...
                begin
                        ...
                        execute V306_CP2_M05_Build_Day_Caps
                                                                          @capping_date
                                                                        , @iter_calibration
                                                                        , @include_pre_standby_event_flag     -- if =1 then pre_standby events will be included within the NTile setting process
                        commit
