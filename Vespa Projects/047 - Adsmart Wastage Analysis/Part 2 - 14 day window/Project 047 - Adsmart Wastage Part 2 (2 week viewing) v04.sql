...
--drop table vespa_analysts.vespa_spot_data_By_channel_02_16_Jan;

if object_id('vespa_analysts.vespa_spot_data_By_channel_02_16_Jan_spots_02_Jan') is not null drop table vespa_analysts.vespa_spot_data_By_channel_02_16_Jan_spots_02_Jan;
...
into vespa_analysts.vespa_spot_data_By_channel_02_16_Jan_spots_02_Jan
from vespa_analysts.project047_spots_and_traded_demographics_02Jan_16_jan as a
...
where  cast(corrected_spot_transmission_start_datetime as date) in ( '2012-01-02') and 
cast(viewing_record_start_time_local_inc_staggercast as date) in ('2012-01-02','2012-01-03')
...
--exec gen_create_table 'vespa_analysts.vespa_spot_data_By_channel_02_16_Jan_spots_02_Jan';



--select count(*) from vespa_analysts.vespa_spot_data_By_channel_02_16_Jan_spots_02_Jan;
--select count(*) from vespa_analysts.vespa_spot_data_By_channel_02_16_Jan;
...
--select count(*) from vespa_analysts.vespa_spot_data_by_channel_02_16_jan_spots;
