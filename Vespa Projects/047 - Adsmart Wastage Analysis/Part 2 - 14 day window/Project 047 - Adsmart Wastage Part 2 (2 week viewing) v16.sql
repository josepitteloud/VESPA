...
---PART B - Profile details for Box----
---PART C - Create HH Profile Variables and Demographics for Spot Analysis (Using Current ILU data)---
---PART D - Load in Spot Traded demographic information (Supplied by Chris Thomas)---
---PART E - Create Viewing by Spot Summary table---
---PART F - Comparison of Individual Spots - Sky 1---
---PART G - Reach and Frequency Analysis---
---PART H - Repeat Analysis but Using V2 Capping From Julie Chung---

----Tables Used/Created-----

vespa_analysts.project047_sky_channels_live_2nd_15th_jan - All Live Viewing On Sky Channels 2nd-15th Jan

vespa_analysts.project047_all_boxes_returning_data_2_weeks -Box Info for those returning data in this period

vespa_analysts.project047_all_boxes_returning_data_2_weeks_hh_info - As above but with HH Key level demographics added

vespa_analysts.project047_spots_and_traded_demographics_02Jan_16_jan - All Spots for Sky Channels during this period

vespa_analysts.vespa_spot_data_by_channel_02_16_jan_spots - Live Viewing (in seconds) of each spot (at a box level)

vespa_analysts.vespa_spots_with_trading_metric_counts_with_hh_attributes_02_16_jan - Matching spots to HH demographic data

vespa_analysts_project_047_spot_and_demo_audience_figures_with_hh_attributes_02_16_jan - Summary of viewing vs Traded demographic at a spot level

vespa_max_caps_jan_feb_2012 - Created using code From Project 042:
...
---Deletion of capped records commented out initially - for evaluation purposes (Where capped flag in 2,3 data still in table but no end viewing date added so not present in any analysis)---
/*
...
---Reweight accoring to the proportion of Accounts that return data in a cell compared to the original weights
...
--select head_hh_agef , count(*) from #household_summary_details group by head_hh_agef order by head_hh_agef;
...
from vespa_analysts.project047_all_boxes_returning_data_2_weeks;
commit;
create hg index idx1 on  #box_hh_keys(cb_key_household);
...
left outer join #box_hh_keys as b
...
---PART F Version 2 (For v2 of Capping)  - Comaprison of Individual Spots - Sky 1---
select  channel_name_inc_hd
,corrected_spot_transmission_start_datetime
,corrected_spot_transmission_end_datetime
,spot_duration
...
----Example Outputs for Capping Values per Hour at certain Times/Channels------
...
--select *  from vespa_analysts.project047_sky_channels_live_2nd_15th_jan where account_number = '200000854493'
