...
,sum(case when channel_type ='02: News & Sports' then 0 else total_hh_viewing end) as total_spots_viewed_excluding_news_sport
,sum(case when channel_type ='02: News & Sports' then 0 else target_demographic_households_viewing end) as target_hh_spots_viewed_excluding_news_sport
,sum(case when channel_type ='02: News & Sports' then 0 else total_hh_viewing-target_demographic_households_viewing-unknown_demographic end) as mirror_hh_spots_viewed_excluding_news_sport
,sum(case when channel_type ='02: News & Sports' then 0 else unknown_demographic end) as unknown_hh_spots_viewed_excluding_news_sport
