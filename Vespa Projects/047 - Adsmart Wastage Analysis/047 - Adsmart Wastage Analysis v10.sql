...
--drop table #adsmartable_hh;

select account_number
,max(case when x_pvr_type='PVR5' OR (( x_pvr_type='PVR4' AND ( x_manufacturer='Pace' OR x_manufacturer='Samsung'))) then 1 else 0 end) as adsmartable
into #adsmartable_hh
from vespa_analysts.vespa_data_subscribers_20120115 
group by account_number
;
