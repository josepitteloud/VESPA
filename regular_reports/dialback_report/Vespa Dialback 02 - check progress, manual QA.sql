...
**                  - Results Extraction
**
** Following the weekly refresh script ("Vespa Dialback 01 - build reports.sql")
...
EXECUTE citeam.logger_get_latest_job_events 'VespaDialback', 3;

--EXECUTE citeam.logger_get_latest_job_events 'Dialback Test ***', 3;
...
-- to find the events. This will be fixed once the Scheduler comes online
-- and non-test builds will be properly identified.
...
--EXECUTE citeam.logger_get_latest_job_events 'VespaDialback', 2;
EXECUTE citeam.logger_get_latest_job_events 'Dialback Test ***', 2;
