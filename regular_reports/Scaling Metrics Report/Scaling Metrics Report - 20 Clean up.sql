...
# Description:  Scaling Metrics Report - Clean up script
#
# List of steps:
...
if object_id('SC_Metrics_Rep_Clean_Up') is not null then drop procedure SC_Metrics_Rep_Clean_Up end if;
create procedure SC_Metrics_Rep_Clean_Up
...
begin
      ...
      set @varProcessIdentifier        = 'SCMetRep_Cleanup_v01'
      ...
      execute logger_add_event @varBuildId, 3, '####### Scaling Metrics Report [Clean up] - process started #######', null
      ...
      execute logger_add_event @varBuildId, 3, 'Temporary objects deleted', null
        ...
        -- ##############################################################################################################
      execute logger_add_event @varBuildId, 3, '####### Scaling Metrics Report [Clean up] - process completed #######', null
