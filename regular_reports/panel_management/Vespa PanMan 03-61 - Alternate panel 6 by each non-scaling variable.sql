-- Project Vespa: Panel Management Report Output - summary of all Alternate Panel 6 single variable stuff for variables not used in scaling
select
    variable_value
    ,Sky_Base_Households
    ,Panel_Households
...
where panel = 'ALT6' and scaling_or_not = 0
order by
