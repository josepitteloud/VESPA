-- Project Vespa: Panel Management Report Output - summary of all Alternate Panel 7 single variable stuff for variables used in scaling
select
    variable_value
    ,Sky_Base_Households
    ,Panel_Households
...
where panel = 'ALT7' and scaling_or_not = 1
order by
