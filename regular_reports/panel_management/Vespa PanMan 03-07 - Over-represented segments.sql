-- Project Vespa: Panel Management Report: Sample of over-represented segments
select top 30
...
order by Acceptably_reporting_index desc, Sky_Base_Households desc--Good_HH_Vespa_Live_Index, Sky_Base_Households desc
;