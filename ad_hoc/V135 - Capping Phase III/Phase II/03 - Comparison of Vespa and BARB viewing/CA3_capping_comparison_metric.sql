...
begin
        ...
        insert into CP3_comparison_metrics
                ...
                where   start_hour >= '23:00:00' or start_hour <= '03:00:00'
             group by   event_date
                       ,type_of_event
                       ,weekday_indicator
                       ,capping_correction
        ...
        insert into CP3_comparison_metrics
                select
                       ...
                       ,rank() over (partition by type_of_event, weekday_indicator order by abs(difference_metric)) as rank
                 from   CP3_capping_calibration_comparison
                where   start_hour >= '04:00:00' and start_hour <= '14:00:00'
             group by   event_date
                       ,type_of_event
                       ,weekday_indicator
                       ,capping_correction
        ...
        insert into CP3_comparison_metrics
                select
                       ...
                       ,rank() over (partition by type_of_event, weekday_indicator order by abs(difference_metric)) as rank
                 from   CP3_capping_calibration_comparison
                where   start_hour >= '15:00:00' and start_hour <= '19:00:00'
             group by   event_date
                       ,type_of_event
                       ,weekday_indicator
                       ,capping_correction
        ...
        insert into CP3_comparison_metrics
                select
                       ...
                       ,rank() over (partition by type_of_event, weekday_indicator order by abs(difference_metric)) as rank
                 from   CP3_capping_calibration_comparison
                where   start_hour >= '20:00:00' and start_hour <= '22:00:00'
             group by   event_date
                       ,type_of_event
                       ,weekday_indicator
                       ,capping_correction
