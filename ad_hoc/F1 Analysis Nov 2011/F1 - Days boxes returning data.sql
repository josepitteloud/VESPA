...
--Spanish GP
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-05-21 05:00:00' and '2011-05-22 04:59:59' then 1
...
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-05-22 05:00:00' and '2011-05-23 04:59:59' then 1
...
--Monaco GP
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-05-28 05:00:00' and '2011-05-29 04:59:59' then 1
...
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-05-29 05:00:00' and '2011-05-30 04:59:59' then 1
...
--Canadian GP
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-06-11 05:00:00' and '2011-06-12 04:59:59' then 1
...
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-06-12 05:00:00' and '2011-06-13 04:59:59' then 1
...
--European GP
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-06-25 05:00:00' and '2011-06-26 04:59:59' then 1
...
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-06-26 05:00:00' and '2011-06-27 04:59:59' then 1
...
--British GP
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-07-09 05:00:00' and '2011-07-10 04:59:59' then 1
...
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-07-10 05:00:00' and '2011-07-11 04:59:59' then 1
...
--German GP
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-07-23 05:00:00' and '2011-07-24 04:59:59' then 1
...
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-07-24 05:00:00' and '2011-07-25 04:59:59' then 1
...
--Hungarian GP
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-07-30 05:00:00' and '2011-07-31 04:59:59' then 1
...
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-07-31 05:00:00' and '2011-08-01 04:59:59' then 1
...
--Belgian GP
,max(case   when event_type = 'evEmptyLog' and document_creation_date between '2011-08-27 05:00:00' and '2011-08-28 04:59:59' then 1
