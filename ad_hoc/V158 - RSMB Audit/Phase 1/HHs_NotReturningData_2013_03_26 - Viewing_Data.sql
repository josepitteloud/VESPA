...
select rank() over ( partition by subscriber_id
       ...
       ,case
        ...
        ,case
         ...
         ,capped_full_flag
         ,capped_partial_flag
into  VEA_03_09_Dec_Viewing_Events_DP_PROG_NEW
from sk_prod.VESPA_DP_PROG_VIEWED_201212
where panel_id = 12
...
and Duration > 6
--174,902,392 Row(s) affected

--Building up the indexes to speed up the whole process -----

create hg index idx9 on VEA_03_09_Dec_Viewing_Events_DP_PROG_NEW(pk_viewing_prog_instance_fact);
create hg index idx10 on Vespa_Augs_201212_03_09(Cb_Row_id);
...
into     VEA_03_09_Dec12_Viewing_Events_Combined
from VEA_03_09_Dec_Viewing_Events_DP_PROG_NEW VEA
inner join Vespa_Augs_201212_03_09 AUG
on VEA.pk_viewing_prog_instance_fact = AUG.cb_row_id
--145,827,900 Row(s) affected
...
select  account_number
       ...
       from VEA_03_09_Dec12_Viewing_Events_Combined
   )P
   group by account_number
--460,228 Row(s) affected
...
from    VEA_03_09_Dec12_Viewing_Events_Combined VE
...
from Viewing_Aggregated_Data_Proportion
--460,228 Row(s) affected
