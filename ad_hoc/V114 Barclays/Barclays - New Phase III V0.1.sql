...
-------------------------------------------------------
----- THIS IS PHASE III BARCLAYS PROJECT; THE ROLL UPS 2.A AND 2.B for  ****** ALL SPOTS! ******
-------------------------------------------------------
...
select top 10 * from #saleshouse_responders2
...
-- which template do i put this in??
...
add part_barclays_impacts




---- DAY OF WEEK &    DAY PART
