text
create procedure pitteloudj.SABB_Forecast_Loop_Table_2_Update_For_Nxt_Wk
as
begin
  --------------------------------------------------------------------------
...
grant execute on pitteloudj.SABB_Forecast_Loop_Table_2_Update_For_Nxt_Wk to CITeam