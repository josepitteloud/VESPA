...
*/	--------------------------------------------------------------------------------------------------------------------------------------------	
	...
	SELECT a.account_number
		...
		, 'curr_count' 	= MAX(CASE WHEN a.end_date = @mx_dt THEN y.visit ELSE 0 END)
		, 'count_1w' 	= MAX(CASE WHEN a.end_date = DATEADD(day, - 7, @mx_dt) THEN y.visit ELSE 0 END)
		, 'Calls_LW' 	= CASE WHEN curr_count < count_1w THEN 0 ELSE curr_count - count_1w END
		, 'L_12' 		= MAX(CASE WHEN a.end_date BETWEEN DATEADD(month, - 12, @mx_dt) AND DATEADD(week, - 1, @mx_dt) THEN y.visit ELSE 0 END)
		, 'L_9' 		= MAX(CASE WHEN a.end_date BETWEEN DATEADD(month, - 9, @mx_dt) AND DATEADD(week, - 1, @mx_dt) THEN y.visit ELSE 0 END)
		, 'L_6' 		= MAX(CASE WHEN a.end_date BETWEEN DATEADD(month, - 6, @mx_dt) AND DATEADD(week, - 1, @mx_dt) THEN y.visit ELSE 0 END)
		, 'L_3' 		= MAX(CASE WHEN a.end_date BETWEEN DATEADD(month, - 3, @mx_dt) AND DATEADD(week, - 1, @mx_dt) THEN y.visit ELSE 0 END)
