text
create procedure spencerc2.SABB_BB_Calls_prob as
begin
  ...
  update #BB_CALLS_prob_1 as a
    ...
    join pitteloudj.DTV_fcast_weekly_base_2 as b on a.account_number = b.account_number and b.end_Date = @mx_dt
  commit work
  select 'Prob_Group'=1,
    Calls_LW,
    segment_sa,
