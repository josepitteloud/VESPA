text
create procedure spencerc2.SABB_ForeCAST_Create_ForeCAST_Loop_Table_2( 
...
begin
  ...
  drop table if exists spencerc2.Pred_Rates
  drop table if exists spencerc2.ForeCAST_Loop_Table_2
...
*/
  ...
  commit work
  create hg index id1 on spencerc2.ForeCAST_Loop_Table_2(account_number)
  create lf index id2 on spencerc2.ForeCAST_Loop_Table_2(churn_type)
  create lf index id3 on spencerc2.ForeCAST_Loop_Table_2(SABB_forecast_segment)
  create lf index id4 on spencerc2.ForeCAST_Loop_Table_2(BB_Status_Code)
  create lf index id5 on spencerc2.ForeCAST_Loop_Table_2(subs_week_and_year)
  create lf index id6 on spencerc2.ForeCAST_Loop_Table_2(weekid)
  commit work
...
grant execute on spencerc2.SABB_ForeCAST_Create_ForeCAST_Loop_Table_2 to CITeam,vespa_group_low_security