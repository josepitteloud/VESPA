...
when channel_name_inc_hd='ITV3+1' then 'ITV3'
...
,sum(case when viewing_duration>=180 then viewing_duration else 0 end) as total_viewing_duration_3min_plus_events
...
,sum(case when viewing_type='d) Over 60_minutes after tx VOSDAL' then viewing_duration else 0 end) as total_viewing_duration_over_60_minutes_after_tx_VOSDAL
