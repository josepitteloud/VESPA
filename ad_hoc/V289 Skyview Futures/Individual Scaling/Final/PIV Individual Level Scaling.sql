...
exec V289_M11_01_SC3_v1_1__do_weekly_segmentation '2013-09-26', 20, '2014-07-17'
exec V289_M11_02_SC3_v1_1__prepare_panel_members '2013-09-26', '2014-07-02', 20

exec V289_M11_03_SC3I_v1_1__add_individual_data '2013-09-26', '2014-07-17', 20
exec V289_M11_04_SC3I_v1_1__make_weights '2013-09-26', '2014-07-17', 20
...
from
     ...
     inner join
        SC3_Segments_lookup_v1_1 l_sc3
...
where
        ...
        and (person_gender = 'M' or person_gender = 'F' or person_ageband = '0-19') -- exclude U gender. See comments below
commit
--- There are a small number of individuals from Experian data that have a undefined ('U') gender
-- Exclude accounts numbers that have at least one individual with U gender
-- Note that we don't know the gender of 0-19 so we will not count these when we exclude accounts
...
from
     ...
     and d.person_ageband = l_sc3i.age_band
where
        person_gender = 'M' or person_gender = 'F' or person_ageband = '0-19' -- exclude U gender unless 0-19.
commit
