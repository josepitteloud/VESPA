...
SET @snapshot_start_dt  = '2013-02-01';  --Had to restart loop half way through
--SET @snapshot_start_dt  = '2012-09-01';  --Original
SET @snapshot_end_dt    = '2013-02-26';
...
alter table  V159_epg_data Add pack    varchar(25);
...
--select channel_name_inc_hd , genre_description, sub_genre_description , count(*) as records,sum(Pay_channel)  from V159_epg_data group by channel_name_inc_hd,genre_description, sub_genre_description order by channel_name_inc_hd ,records desc;


--select channel_name ,pack , count(*),sum(Pay_channel) from V159_epg_data group by channel_name,pack order by channel_name;
--create initial backup --
--select * into V159_Daily_viewing_summary_backup from V159_Daily_viewing_summary; commit;
...
commit;
--SELECT TOP 100 * FROM vespa_analysts.VESPA_DAILY_AUGS_20130227
...
,first_pc_date
,sum(case when viewing_day  between first_pc_date-90 and first_pc_date-1 then 1 else 0 end) as viewing_days_01_to_90_days_pre_pc
...
;
--select viewing_days_01_to_90_days_pre_pc , count(*) from #v159_viewing_around_pc_date group by viewing_days_01_to_90_days_pre_pc order by viewing_days_01_to_90_days_pre_pc
...
---Split on an account level (30 Minute Splits)---

select floor(pre_pc_viewing_duration_exc_premiums/viewing_days_01_to_28_days_pre_pc/1800) as daily_average_viewing_half_hours_pre
,floor( post_pc_viewing_duration_exc_premiums/viewing_days_01_to_28_days_post_pc/1800) as daily_average_viewing_half_hours_post
,sum(pre_pc_viewing_duration_exc_premiums) as total_pre_pc_duration
,sum(post_pc_viewing_duration_exc_premiums) as total_post_pc_duration
,sum(viewing_days_01_to_28_days_pre_pc) as days_viewing_pre_pc
,sum(viewing_days_01_to_28_days_post_pc) as days_viewing_post_pc
...
from #v159_viewing_around_pc_date
where viewing_days_01_to_28_days_pre_pc>=20 and viewing_days_01_to_28_days_post_pc>=20 
group by daily_average_viewing_half_hours_pre,daily_average_viewing_half_hours_post
order by daily_average_viewing_half_hours_pre,daily_average_viewing_half_hours_post
;


---Split on an account level (10 Minute Splits)---

select case when floor(pre_pc_viewing_duration_exc_premiums/viewing_days_01_to_28_days_pre_pc/900) >16 then 16 else
 floor(pre_pc_viewing_duration_exc_premiums/viewing_days_01_to_28_days_pre_pc/900) end as daily_average_viewing_15min_pre
,case when floor(post_pc_viewing_duration_exc_premiums/viewing_days_01_to_28_days_post_pc/900) >16 then 16 else
 floor(post_pc_viewing_duration_exc_premiums/viewing_days_01_to_28_days_post_pc/900) end as daily_average_viewing_15min_post
,sum(pre_pc_viewing_duration_exc_premiums) as total_pre_pc_duration
,sum(post_pc_viewing_duration_exc_premiums) as total_post_pc_duration
,sum(viewing_days_01_to_28_days_pre_pc) as days_viewing_pre_pc
,sum(viewing_days_01_to_28_days_post_pc) as days_viewing_post_pc
...
from #v159_viewing_around_pc_date
where viewing_days_01_to_28_days_pre_pc>=20 and viewing_days_01_to_28_days_post_pc>=20 
group by daily_average_viewing_15min_pre,daily_average_viewing_15min_post
order by daily_average_viewing_15min_pre,daily_average_viewing_15min_post
;

---Link Pending Cancel Reason to Activity

alter table V159_account_level_viewing_summary add pc_reason_level_1 varchar(100);

update V159_account_level_viewing_summary
set pc_reason_level_1=b.wh_attempt_reason_description_1
from V159_account_level_viewing_summary as a
left outer join mar_churn_TA_attempts_all as b
on a.account_number = b.account_number and a.first_pc_date = b.attempt_date
where b.ta_saved=0
;
commit;

select pc_reason_level_1 , count(*) as records 
from V159_account_level_viewing_summary as a
left outer join  #v159_viewing_around_pc_date as b
on a.account_number = b.account_number
where viewing_days_01_to_28_days_pre_pc>=20 and viewing_days_01_to_28_days_post_pc>=20 
group by pc_reason_level_1 order by records desc;

commit;

---repeat with a 10 week pre pending cancel split--
--drop table #v159_1_week_viewing_pre_pc_date;
select a.account_number
,first_pc_date
,sum(case when viewing_day  between first_pc_date-90 and first_pc_date-1 then 1 else 0 end) as viewing_days_01_to_90_days_pre_pc

--Viewing Summary 01_to_07 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-7 and first_pc_date-1 then 1 else 0 end) as pre_pc_01_to_07_days_with_viewing
,sum(case when viewing_day  between first_pc_date-7 and first_pc_date-1 then viewing_duration else 0 end) as pre_pc_viewing_duration_01_to_07_days
,sum(case when viewing_day  between first_pc_date-7 and first_pc_date-1 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_01_to_07_days
,sum(case when viewing_day  between first_pc_date-7 and first_pc_date-1 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_01_to_07_days
,sum(case when viewing_day  between first_pc_date-7 and first_pc_date-1 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_01_to_07_days
,sum(case when viewing_day  between first_pc_date-7 and first_pc_date-1 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_01_to_07_days

--Viewing Summary 08_to_14 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-14 and first_pc_date-8 then 1 else 0 end) as pre_pc_08_to_14_days_with_viewing
,sum(case when viewing_day  between first_pc_date-14 and first_pc_date-8 then viewing_duration else 0 end) as pre_pc_viewing_duration_08_to_14_days
,sum(case when viewing_day  between first_pc_date-14 and first_pc_date-8 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_08_to_14_days
,sum(case when viewing_day  between first_pc_date-14 and first_pc_date-8 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_08_to_14_days
,sum(case when viewing_day  between first_pc_date-14 and first_pc_date-8 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_08_to_14_days
,sum(case when viewing_day  between first_pc_date-14 and first_pc_date-8 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_08_to_14_days

--Viewing Summary 15_to_21 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-21 and first_pc_date-15 then 1 else 0 end) as pre_pc_15_to_21_days_with_viewing
,sum(case when viewing_day  between first_pc_date-21 and first_pc_date-15 then viewing_duration else 0 end) as pre_pc_viewing_duration_15_to_21_days
,sum(case when viewing_day  between first_pc_date-21 and first_pc_date-15 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_15_to_21_days
,sum(case when viewing_day  between first_pc_date-21 and first_pc_date-15 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_15_to_21_days
,sum(case when viewing_day  between first_pc_date-21 and first_pc_date-15 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_15_to_21_days
,sum(case when viewing_day  between first_pc_date-21 and first_pc_date-15 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_15_to_21_days

--Viewing Summary 22_to_28 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-28 and first_pc_date-22 then 1 else 0 end) as pre_pc_22_to_28_days_with_viewing
,sum(case when viewing_day  between first_pc_date-28 and first_pc_date-22 then viewing_duration else 0 end) as pre_pc_viewing_duration_22_to_28_days
,sum(case when viewing_day  between first_pc_date-28 and first_pc_date-22 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_22_to_28_days
,sum(case when viewing_day  between first_pc_date-28 and first_pc_date-22 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_22_to_28_days
,sum(case when viewing_day  between first_pc_date-28 and first_pc_date-22 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_22_to_28_days
,sum(case when viewing_day  between first_pc_date-28 and first_pc_date-22 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_22_to_28_days

--Viewing Summary 29_to_35 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-35 and first_pc_date-29 then 1 else 0 end) as pre_pc_29_to_35_days_with_viewing
,sum(case when viewing_day  between first_pc_date-35 and first_pc_date-29 then viewing_duration else 0 end) as pre_pc_viewing_duration_29_to_35_days
,sum(case when viewing_day  between first_pc_date-35 and first_pc_date-29 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_29_to_35_days
,sum(case when viewing_day  between first_pc_date-35 and first_pc_date-29 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_29_to_35_days
,sum(case when viewing_day  between first_pc_date-35 and first_pc_date-29 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_29_to_35_days
,sum(case when viewing_day  between first_pc_date-35 and first_pc_date-29 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_29_to_35_days

--Viewing Summary 36_to_42 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-42 and first_pc_date-36 then 1 else 0 end) as pre_pc_36_to_42_days_with_viewing
,sum(case when viewing_day  between first_pc_date-42 and first_pc_date-36 then viewing_duration else 0 end) as pre_pc_viewing_duration_36_to_42_days
,sum(case when viewing_day  between first_pc_date-42 and first_pc_date-36 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_36_to_42_days
,sum(case when viewing_day  between first_pc_date-42 and first_pc_date-36 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_36_to_42_days
,sum(case when viewing_day  between first_pc_date-42 and first_pc_date-36 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_36_to_42_days
,sum(case when viewing_day  between first_pc_date-42 and first_pc_date-36 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_36_to_42_days

--Viewing Summary 01_to_07 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-49 and first_pc_date-43 then 1 else 0 end) as pre_pc_43_to_49_days_with_viewing
,sum(case when viewing_day  between first_pc_date-49 and first_pc_date-43 then viewing_duration else 0 end) as pre_pc_viewing_duration_43_to_49_days
,sum(case when viewing_day  between first_pc_date-49 and first_pc_date-43 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_43_to_49_days
,sum(case when viewing_day  between first_pc_date-49 and first_pc_date-43 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_43_to_49_days
,sum(case when viewing_day  between first_pc_date-49 and first_pc_date-43 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_43_to_49_days
,sum(case when viewing_day  between first_pc_date-49 and first_pc_date-43 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_43_to_49_days

--Viewing Summary 01_to_07 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-56 and first_pc_date-50 then 1 else 0 end) as pre_pc_50_to_56_days_with_viewing
,sum(case when viewing_day  between first_pc_date-56 and first_pc_date-50 then viewing_duration else 0 end) as pre_pc_viewing_duration_50_to_56_days
,sum(case when viewing_day  between first_pc_date-56 and first_pc_date-50 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_50_to_56_days
,sum(case when viewing_day  between first_pc_date-56 and first_pc_date-50 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_50_to_56_days
,sum(case when viewing_day  between first_pc_date-56 and first_pc_date-50 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_50_to_56_days
,sum(case when viewing_day  between first_pc_date-56 and first_pc_date-50 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_50_to_56_days

--Viewing Summary 01_to_07 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-63 and first_pc_date-57 then 1 else 0 end) as pre_pc_57_to_63_days_with_viewing
,sum(case when viewing_day  between first_pc_date-63 and first_pc_date-57 then viewing_duration else 0 end) as pre_pc_viewing_duration_57_to_63_days
,sum(case when viewing_day  between first_pc_date-63 and first_pc_date-57 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_57_to_63_days
,sum(case when viewing_day  between first_pc_date-63 and first_pc_date-57 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_57_to_63_days
,sum(case when viewing_day  between first_pc_date-63 and first_pc_date-57 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_57_to_63_days
,sum(case when viewing_day  between first_pc_date-63 and first_pc_date-57 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_57_to_63_days

--Viewing Summary 64_to_70 Days Pre Pending Cancel---
,sum(case when viewing_day  between first_pc_date-70 and first_pc_date-64 then 1 else 0 end) as pre_pc_64_to_70_days_with_viewing
,sum(case when viewing_day  between first_pc_date-70 and first_pc_date-64 then viewing_duration else 0 end) as pre_pc_viewing_duration_64_to_70_days
,sum(case when viewing_day  between first_pc_date-70 and first_pc_date-64 then total_duration_pay_exc_premiums else 0 end) as pre_pc_viewing_duration_exc_premiums_64_to_70_days
,sum(case when viewing_day  between first_pc_date-70 and first_pc_date-64 then total_duration_premiums else 0 end) as pre_pc_viewing_premiums_64_to_70_days
,sum(case when viewing_day  between first_pc_date-70 and first_pc_date-64 then total_duration_terrestrial else 0 end) as pre_pc_viewing_terrestrial_64_to_70_days
,sum(case when viewing_day  between first_pc_date-70 and first_pc_date-64 then total_duration_free_non_terrestrial else 0 end) as pre_pc_viewing_free_non_terrestrial_64_to_70_days


into #v159_1_week_viewing_pre_pc_date
from  V159_account_level_viewing_summary as a
left outer join V159_Daily_viewing_summary as b
on a.account_number=b.account_number
where  first_pc_date is not null and first_po_date-28>first_pc_date
...
--select top 500 * from #v159_1_week_viewing_pre_pc_date;

select sum(pre_pc_64_to_70_days_with_viewing) as days_viewing_64_to_70_days
,sum(pre_pc_viewing_duration_exc_premiums_64_to_70_days) as duration_64_to_70_days

,sum(pre_pc_57_to_63_days_with_viewing) as days_viewing_57_to_63_days
,sum(pre_pc_viewing_duration_exc_premiums_57_to_63_days) as duration_57_to_63_days

,sum(pre_pc_50_to_56_days_with_viewing) as days_viewing_50_to_56_days
,sum(pre_pc_viewing_duration_exc_premiums_50_to_56_days) as duration_50_to_56_days

,sum(pre_pc_43_to_49_days_with_viewing) as days_viewing_43_to_49_days
,sum(pre_pc_viewing_duration_exc_premiums_43_to_49_days) as duration_43_to_49_days

,sum(pre_pc_36_to_42_days_with_viewing) as days_viewing_36_to_42_days
,sum(pre_pc_viewing_duration_exc_premiums_36_to_42_days) as duration_36_to_42_days

,sum(pre_pc_29_to_35_days_with_viewing) as days_viewing_29_to_35_days
,sum(pre_pc_viewing_duration_exc_premiums_29_to_35_days) as duration_29_to_35_days

,sum(pre_pc_22_to_28_days_with_viewing) as days_viewing_22_to_28_days
,sum(pre_pc_viewing_duration_exc_premiums_22_to_28_days) as duration_22_to_28_days

,sum(pre_pc_15_to_21_days_with_viewing) as days_viewing_15_to_21_days
,sum(pre_pc_viewing_duration_exc_premiums_15_to_21_days) as duration_15_to_21_days

,sum(pre_pc_08_to_14_days_with_viewing) as days_viewing_08_to_14_days
,sum(pre_pc_viewing_duration_exc_premiums_08_to_14_days) as duration_08_to_14_days

,sum(pre_pc_01_to_07_days_with_viewing) as days_viewing_01_to_07_days
,sum(pre_pc_viewing_duration_exc_premiums_01_to_07_days) as duration_01_to_07_days

from #v159_1_week_viewing_pre_pc_date
...
commit;
select  channel_name , genre_description , count(*) as records
FROM sk_prod.Vespa_programme_schedule
WHERE (broadcast_start_date_time_utc between '2013-01-10'  and  '2013-01-11')
group by channel_name , genre_description
order by channel_name , records desc
;
select count(*) from V159_Daily_viewing_summary;
commit;
*/
