...
drop table dbarnett.v250_rights_deduped_by_channel;
--Hard Code Service Keys to take into consideration BBC channesl where same programme broadcast at different times so only 1 service key
--Used per channel---
--select top 100 * from dbarnett.v250_rights_deduped_by_channel;
--select distinct analysis_right_new from dbarnett.v250_sports_rights_epg_data_for_analysis order by analysis_right_new
...
into dbarnett.v250_rights_deduped_by_channel
from dbarnett.v250_sports_rights_epg_data_for_analysis as a
where record_id = 2297633 or service_key in (6000,4523
,3615
,1758
,3150
,3022
...
commit;
-----------------------------REPEAT FOR GROUPED EPG DATA------------------------

drop table dbarnett.v250_rights_broadcast_by_live_status_grouped;
select analysis_right_grouped as analysis_right
,live
,broadcast_date
,sum(programme_duration) as total_broadcast
,count(*) as programmes_broadcast
into dbarnett.v250_rights_broadcast_by_live_status_grouped
from dbarnett.v250_rights_deduped_by_channel
...
drop table dbarnett.v250_rights_broadcast_overall_grouped;
select analysis_right_grouped as analysis_right
,broadcast_date
,sum(programme_duration) as total_broadcast
,count(*) as programmes_broadcast
into dbarnett.v250_rights_broadcast_overall_grouped
from dbarnett.v250_rights_deduped_by_channel
where analysis_right_grouped in ('ECB Cricket Sky Sports'
,'England Football Internationals - ITV'
,'F1 - BBC'
...
commit;
--select * from dbarnett.v250_rights_broadcast_overall_grouped;
---Add grouped info in to list


insert into  dbarnett.v250_rights_broadcast_by_live_status
(select * from dbarnett.v250_rights_broadcast_by_live_status_grouped)
; commit;


insert into  dbarnett.v250_rights_broadcast_overall
(select * from dbarnett.v250_rights_broadcast_overall_grouped)
; commit;
...
---Append grouped to no grouped tables to get info for all rights----
