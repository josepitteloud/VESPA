...
;
commit;
--select WWESS_Total_Viewing_Events from dbarnett.v250_unannualised_right_activity_by_live_non_live;
...
---Split into 2
--select top 10 * from dbarnett.v250_rights_broadcast_overall
--select count(*) from dbarnett.v250_rights_broadcast_overall
--select distinct analysis_right  from dbarnett.v250_rights_broadcast_overall

select * into dbarnett.v250_rights_broadcast_overall_part_01 from dbarnett.v250_rights_broadcast_overall
where analysis_right in ('Welsh Home International Football 2012-2014 Sky Sports'
,'Premier League Darts 2010-2013 - Sky Sports'
,'Other Basketball'
,'ESPN Boxing'
,'UEFA Champions League -  Sky Sports (other Live)'
,'Eurosport Golf'
,'ITV4 Unknown'
,'ITV1 Motor Sport'
,'U.S Open Tennis 2013-2015 Sky Sports'
,'BBC Tennis'
,'England World Cup Qualifying (Away) - ITV'
,'Asian Tour Golf 2012-2013 Sky Sports'
,'BBC Athletics'
,'F1 (non-Live)- BBC'
,'BBC Watersports'
,'Other Fishing'
,'England Friendlies (Football) - ITV'
,'ITV4 Darts'
,'Community Shield - ITV'
,'Africa Cup of Nations - ITV'
,'World snooker championship - BBC'
,'Sky Sports Snooker/Pool'
,'Challenge Extreme'
,'Other Tennis'
,'Ligue 1 - BT Sport'
,'Formula One 2012-2018 - (Race Live) Sky Sports'
...
,'ESPN Racing'
,'UEFA Champions League -  Sky Sports (Wed)'
,'Channel 4 Watersports'
,'ECB non-Test Cricket Sky Sports'
,'SFL - ESPN'
,'Serie A - BT Sport'
,'Sky Sports Boxing'
,'World Cup Qualifiers - BT Sport'
,'Conference - BT Sport'
,'USPGA Championship (2007-2016) Sky Sports'
,'Channel 5 Cricket'
,'ECB Cricket Sky Sports'
,'Sky Sports Basketball'
,'BBC Football'
,'UEFA Champions League -  Sky Sports (non Live)'
,'International Friendlies - BT Sport'
,'USA Football - BT Sport'
,'Eurosport Wintersports'
,'BBC Equestrian'
,'ESPN Cricket'
,'Other Boxing'
,'Serie A - ESPN'
,'F1 - Sky Sports'
,'Rugby Internationals (Wales) - BBC'
,'Premier League Football - Sky Sports (Sun 4pm)'
,'Royal Ascot - Channel 4'
,'Spanish Football 2012/13 To 14/15 - Sky Sports'
,'Africa Cup of Nations - Eurosport'
,'Other Wintersports'
,'Eurosport Darts'
,'Matchroom Output Deal  2010-2012 (Pool)- Sky Sports'
,'Premiership Rugby - Sky Sports'
,'Six Nations - BBC'
,'BBC Golf'
,'IAAF World Athletics Championship - Eurosport'
,'ITV4 Cricket'
,'Sky Sports Wrestling'
,'Matchroom Output Deal  2010-2012 (Snooker)- Sky Sports'
,'Heineken Cup 2010/11 To 2013/14- Sky Sports'
,'Premier League - BT Sport'
,'Eurosport Snooker/Pool'
,'BT Sport Boxing'
,'SPL - ESPN'
,'ITV4 Snooker/Pool'
,'Channel 4 Wintersports'
,'Sky Sports Baseball'
,'French Open Tennis - Eurosport'
,'World Club Championship - BBC'
,'Sky Sports Ice Hockey'
,'Australian Football - BT Sport'
,'Sky Sports Motor Sport'
,'Cycling - U C I World Tour Sky Sports'
,'ESPN American Football'
,'Sky Sports Wintersports'
,'SPL - Sky Sports'
...
,'Sky Sports Tennis'
,'Other Golf'
,'World Athletics Championship - More 4'
,'ESPN Rugby'
,'India Home Cricket 2012-2018 Sky Sports'
,'Sky 1 and Sky 2 Unknown'
,'Sky Sports Cricket'
,'The boat race - BBC'
...
,'British Open Golf - BBC'
,'Channel 4 Boxing'
,'U S Masters Golf 2011-2014 Sky Sports'
,'Channel 4 Equestrian'
,'ESPN Tennis'
,'BT Sport American Football'
,'Tour de France - Eurosport'
,'Eurosport Ice Hockey'
,'BT Sport Athletics'
,'Channel 5 Wrestling'
,'Premier League Football - Sky Sports (MNF)'
,'Football League - Seasons 2012/13 To 14/15 Sky Sports - others'
,'Channel 4 Football'
,'ESPN Motor Sport'
,'International Freindlies - ESPN'
,'Boxing  - Channel 5'
,'ITV1 Football'
,'Europa League - ITV'
,'ECB (highlights) - Channel 5'
,'ESPN Ice Hockey'
,'Eurosport Racing'
,'BBC Boxing'
,'The Masters Golf - BBC'
,'Eurosport Unknown'
,'Boxing - Matchroom 2012-2014 Sky Sports'
,'Other Darts'
,'Womens Cricket - I C C Cricket Deal  2012-2015 Sky Sports'
,'Australian Open Tennis - Eurosport'
,'Channel 4 Unknown'
,'Channel 4 Extreme'
,'Matchroom Output Deal  2010-2012 (Other)- Sky Sports'
,'Eurosport Basketball'
,'Other Ice Hockey'
,'England Football Internationals - ITV'
,'BT Sport Tennis'
,'Other Extreme'
...
,'Confederations Cup - BBC'
,'Formula One 2012-2018 - (Qualifying Live) Sky Sports'
,'Premier League Football - Sky Sports (non Live)'
,'Eurosport Boxing'
,'Eurosport Motor Sport'
,'ATP Tennis Masters Series  2011-2013 Sky Sports'
,'ESPN Darts'
,'Brazil Football - BT Sport'
)
;
commit;
CREATE LF INDEX idx3 ON dbarnett.v250_rights_broadcast_overall_part_01 (broadcast_date);
CREATE HG INDEX idx2 ON dbarnett.v250_rights_broadcast_overall_part_01 (analysis_right);
commit;


--select count(*) from dbarnett.v250_days_viewing_by_account 
--TO HERE---
--drop table dbarnett.v250_days_right_viewable_by_account_part_01;
...
into dbarnett.v250_days_right_viewable_by_account_part_01
...
--where right(account_number,1) in ('1','2','3')
--group by  a.account_number
--,b.analysis_right
;
select top 500 * from dbarnett.v250_days_right_viewable_by_account_part_01;

drop table dbarnett.v250_days_right_viewable_by_account;
commit;
CREATE HG INDEX idx1 ON dbarnett.v250_days_right_viewable_by_account_part_01 (account_number);
CREATE LF INDEX idx3 ON dbarnett.v250_days_right_viewable_by_account_part_01(broadcast_date);
CREATE HG INDEX idx2 ON dbarnett.v250_days_right_viewable_by_account_part_01 (analysis_right);
commit;
...
from dbarnett.v250_days_right_viewable_by_account_part_01
on a.viewing_date=b.broadcast_date
--where right(account_number,1) in ('1','2','3')
group by  a.account_number
,b.analysis_right
...
commit;
CREATE HG INDEX idx1 ON dbarnett.v250_rights_broadcast_by_live_status (broadcast_date);
commit;
