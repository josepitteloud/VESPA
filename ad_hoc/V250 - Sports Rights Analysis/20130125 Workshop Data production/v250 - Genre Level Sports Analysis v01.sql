...
----select 00 into dbarnett.v250_loop_counter02; drop table dbarnett.v250_all_sports_programmes_viewed;
...
sub_genre_description = ''Sports'' and a.viewing_duration>=180
group by a.account_number
,pk_programme_instance_dim
;
...
commit;
--select count(*) from dbarnett.v250_all_sports_programmes_viewed;
--select top 500 * from  dbarnett.v250_all_sports_programmes_viewed
