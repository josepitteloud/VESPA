...
--select count(*) from dbarnett.v250_epg_live_non_live_lookup
...
from dbarnett.v250_sports_rights_epg_data_for_analysis
where channel_name <>'BBC HD' and service_key in (4523
,3615
,1758
,3150
,3022
...
--select * from #rights_deduped_by_channel where analysis_right_new='NFL - BBC' order by broadcast_datetime_text;
...
---Create Full List of EPG Sports Activity--
