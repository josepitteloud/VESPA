...
--select analysis_right,count(*) from dbarnett.v250_rights_broadcast_overall group by analysis_right order by analysis_right 

--drop table dbarnett.v250_rights_broadcast_overall_test;
select * into dbarnett.v250_rights_broadcast_overall_test from dbarnett.v250_rights_broadcast_overall 
where  analysis_right in ('Welsh Home International Football 2012-2014 Sky Sports');
/*
,'Premier League Darts 2010-2013 - Sky Sports'
,'Other Basketball'
...
;
*/
---remove Accounts that are not to be used in weights--
...
from dbarnett.v250_rights_broadcast_overall as b as a
left outer join dbarnett.v250_days_viewing_by_account as b
...
commit;
--select top 500 * from dbarnett.v250_days_viewing_by_account;
--select count(*) from dbarnett.v250_rights_broadcast_overall;
