...
--drop table #rights_deduped_by_channel;
select channel_name
,analysis_right
,live
,broadcast_datetime_text
,broadcast_date
,max(programme_instance_duration) as programme_duration
into #rights_deduped_by_channel
from dbarnett.v250_sports_rights_epg_data_for_analysis
...
--select * from #rights_deduped_by_channel order by broadcast_datetime_text;
--select * from dbarnett.v250_rights_broadcast_by_live_status;
drop table dbarnett.v250_rights_broadcast_by_live_status;
select analysis_right
,live
,broadcast_date
,sum(programme_duration) as total_broadcast
,count(*) as programmes_broadcast
into dbarnett.v250_rights_broadcast_by_live_status
from #rights_deduped_by_channel
...
commit;
--select top 100 * from dbarnett.v250_sports_rights_epg_data_for_analysis
--select * from dbarnett.v250_rights_broadcast_overall;
...
,count(distinct b.dk_programme_instance_dim) as programmes_viewed
,sum(viewing_events) as total_viewing_events

,sum(case when sub_genre_description in 
...
commit;
--select * from dbarnett.v250_days_right_viewable_by_account;
...
-----
--drop table dbarnett.v250_annualised_activity_table_for_workshop;
select a.account_number
...
/*
,case when d.BILION_broadcast_days_viewed_NON_LIVE=0 then 0  when d.BILION_total_viewing_events_NON_LIVE=0 then 0  when d.BILION_broadcast_days_viewed_NON_LIVE is null then 0  when e.BILION_days_right_viewable_NON_LIVE =0 then 0 when e.BILION_days_right_broadcast_NON_LIVE=0 then 0  else d.BILION_total_viewing_events_NON_LIVE / cast(d.BILION_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_BILION
,case when d.BILION_broadcast_days_viewed_LIVE=0 then 0  when d.BILION_programmes_viewed_over_threshold_LIVE=0 then 0  when d.BILION_broadcast_days_viewed_LIVE is null then 0  when e.BILION_days_right_viewable_LIVE =0 then 0 when e.BILION_days_right_broadcast_LIVE=0 then 0  else d.BILION_total_viewing_events_LIVE / cast(d.BILION_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_BILION
...
,case when d.ENGRUG_broadcast_days_viewed_NON_LIVE=0 then 0  when d.ENGRUG_total_viewing_events_NON_LIVE=0 then 0  when d.ENGRUG_broadcast_days_viewed_NON_LIVE is null then 0  when e.ENGRUG_days_right_viewable_NON_LIVE =0 then 0 when e.ENGRUG_days_right_broadcast_NON_LIVE=0 then 0  else d.ENGRUG_total_viewing_events_NON_LIVE / cast(d.ENGRUG_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_ENGRUG
,case when d.ENGRUG_broadcast_days_viewed_LIVE=0 then 0  when d.ENGRUG_programmes_viewed_over_threshold_LIVE=0 then 0  when d.ENGRUG_broadcast_days_viewed_LIVE is null then 0  when e.ENGRUG_days_right_viewable_LIVE =0 then 0 when e.ENGRUG_days_right_broadcast_LIVE=0 then 0  else d.ENGRUG_total_viewing_events_LIVE / cast(d.ENGRUG_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_ENGRUG
,case when b.ENGRUG_broadcast_days_viewed=0 then 0  when b.ENGRUG_programmes_viewed_over_threshold=0 then 0  when b.ENGRUG_broadcast_days_viewed is null then 0  when c.ENGRUG_days_right_viewable =0 then 0 when c.ENGRUG_days_right_broadcast=0 then 0  else b.ENGRUG_total_viewing_events / cast(b.ENGRUG_programmes_viewed_over_threshold as real) end as AVE_A_ENGRUG
,case when d.CAPCUP_broadcast_days_viewed_NON_LIVE=0 then 0  when d.CAPCUP_total_viewing_events_NON_LIVE=0 then 0  when d.CAPCUP_broadcast_days_viewed_NON_LIVE is null then 0  when e.CAPCUP_days_right_viewable_NON_LIVE =0 then 0 when e.CAPCUP_days_right_broadcast_NON_LIVE=0 then 0  else d.CAPCUP_total_viewing_events_NON_LIVE / cast(d.CAPCUP_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_CAPCUP
,case when d.CAPCUP_broadcast_days_viewed_LIVE=0 then 0  when d.CAPCUP_programmes_viewed_over_threshold_LIVE=0 then 0  when d.CAPCUP_broadcast_days_viewed_LIVE is null then 0  when e.CAPCUP_days_right_viewable_LIVE =0 then 0 when e.CAPCUP_days_right_broadcast_LIVE=0 then 0  else d.CAPCUP_total_viewing_events_LIVE / cast(d.CAPCUP_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_CAPCUP
,case when b.CAPCUP_broadcast_days_viewed=0 then 0  when b.CAPCUP_programmes_viewed_over_threshold=0 then 0  when b.CAPCUP_broadcast_days_viewed is null then 0  when c.CAPCUP_days_right_viewable =0 then 0 when c.CAPCUP_days_right_broadcast=0 then 0  else b.CAPCUP_total_viewing_events / cast(b.CAPCUP_programmes_viewed_over_threshold as real) end as AVE_A_CAPCUP
,case when d.NFLSS_broadcast_days_viewed_NON_LIVE=0 then 0  when d.NFLSS_total_viewing_events_NON_LIVE=0 then 0  when d.NFLSS_broadcast_days_viewed_NON_LIVE is null then 0  when e.NFLSS_days_right_viewable_NON_LIVE =0 then 0 when e.NFLSS_days_right_broadcast_NON_LIVE=0 then 0  else d.NFLSS_total_viewing_events_NON_LIVE / cast(d.NFLSS_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_NFLSS
,case when d.NFLSS_broadcast_days_viewed_LIVE=0 then 0  when d.NFLSS_programmes_viewed_over_threshold_LIVE=0 then 0  when d.NFLSS_broadcast_days_viewed_LIVE is null then 0  when e.NFLSS_days_right_viewable_LIVE =0 then 0 when e.NFLSS_days_right_broadcast_LIVE=0 then 0  else d.NFLSS_total_viewing_events_LIVE / cast(d.NFLSS_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_NFLSS
,case when b.NFLSS_broadcast_days_viewed=0 then 0  when b.NFLSS_programmes_viewed_over_threshold=0 then 0  when b.NFLSS_broadcast_days_viewed is null then 0  when c.NFLSS_days_right_viewable =0 then 0 when c.NFLSS_days_right_broadcast=0 then 0  else b.NFLSS_total_viewing_events / cast(b.NFLSS_programmes_viewed_over_threshold as real) end as AVE_A_NFLSS
,case when d.PGATR_broadcast_days_viewed_NON_LIVE=0 then 0  when d.PGATR_total_viewing_events_NON_LIVE=0 then 0  when d.PGATR_broadcast_days_viewed_NON_LIVE is null then 0  when e.PGATR_days_right_viewable_NON_LIVE =0 then 0 when e.PGATR_days_right_broadcast_NON_LIVE=0 then 0  else d.PGATR_total_viewing_events_NON_LIVE / cast(d.PGATR_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_PGATR
,case when d.PGATR_broadcast_days_viewed_LIVE=0 then 0  when d.PGATR_programmes_viewed_over_threshold_LIVE=0 then 0  when d.PGATR_broadcast_days_viewed_LIVE is null then 0  when e.PGATR_days_right_viewable_LIVE =0 then 0 when e.PGATR_days_right_broadcast_LIVE=0 then 0  else d.PGATR_total_viewing_events_LIVE / cast(d.PGATR_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_PGATR
,case when b.PGATR_broadcast_days_viewed=0 then 0  when b.PGATR_programmes_viewed_over_threshold=0 then 0  when b.PGATR_broadcast_days_viewed is null then 0  when c.PGATR_days_right_viewable =0 then 0 when c.PGATR_days_right_broadcast=0 then 0  else b.PGATR_total_viewing_events / cast(b.PGATR_programmes_viewed_over_threshold as real) end as AVE_A_PGATR
,case when d.SUPLG_broadcast_days_viewed_NON_LIVE=0 then 0  when d.SUPLG_total_viewing_events_NON_LIVE=0 then 0  when d.SUPLG_broadcast_days_viewed_NON_LIVE is null then 0  when e.SUPLG_days_right_viewable_NON_LIVE =0 then 0 when e.SUPLG_days_right_broadcast_NON_LIVE=0 then 0  else d.SUPLG_total_viewing_events_NON_LIVE / cast(d.SUPLG_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_SUPLG
...
,case when b.SUPLG_broadcast_days_viewed=0 then 0  when b.SUPLG_programmes_viewed_over_threshold=0 then 0  when b.SUPLG_broadcast_days_viewed is null then 0  when c.SUPLG_days_right_viewable =0 then 0 when c.SUPLG_days_right_broadcast=0 then 0  else b.SUPLG_total_viewing_events / cast(b.SUPLG_programmes_viewed_over_threshold as real) end as AVE_A_SUPLG
,case when d.LALIGA_broadcast_days_viewed_NON_LIVE=0 then 0  when d.LALIGA_total_viewing_events_NON_LIVE=0 then 0  when d.LALIGA_broadcast_days_viewed_NON_LIVE is null then 0  when e.LALIGA_days_right_viewable_NON_LIVE =0 then 0 when e.LALIGA_days_right_broadcast_NON_LIVE=0 then 0  else d.LALIGA_total_viewing_events_NON_LIVE / cast(d.LALIGA_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_LALIGA
,case when d.LALIGA_broadcast_days_viewed_LIVE=0 then 0  when d.LALIGA_programmes_viewed_over_threshold_LIVE=0 then 0  when d.LALIGA_broadcast_days_viewed_LIVE is null then 0  when e.LALIGA_days_right_viewable_LIVE =0 then 0 when e.LALIGA_days_right_broadcast_LIVE=0 then 0  else d.LALIGA_total_viewing_events_LIVE / cast(d.LALIGA_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_LALIGA
,case when b.LALIGA_broadcast_days_viewed=0 then 0  when b.LALIGA_programmes_viewed_over_threshold=0 then 0  when b.LALIGA_broadcast_days_viewed is null then 0  when c.LALIGA_days_right_viewable =0 then 0 when c.LALIGA_days_right_broadcast=0 then 0  else b.LALIGA_total_viewing_events / cast(b.LALIGA_programmes_viewed_over_threshold as real) end as AVE_A_LALIGA
...
,case when d.TDFEUR_broadcast_days_viewed_LIVE=0 then 0  when d.TDFEUR_programmes_viewed_over_threshold_LIVE=0 then 0  when d.TDFEUR_broadcast_days_viewed_LIVE is null then 0  when e.TDFEUR_days_right_viewable_LIVE =0 then 0 when e.TDFEUR_days_right_broadcast_LIVE=0 then 0  else d.TDFEUR_total_viewing_events_LIVE / cast(d.TDFEUR_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_TDFEUR
,case when b.TDFEUR_broadcast_days_viewed=0 then 0  when b.TDFEUR_programmes_viewed_over_threshold=0 then 0  when b.TDFEUR_broadcast_days_viewed is null then 0  when c.TDFEUR_days_right_viewable =0 then 0 when c.TDFEUR_days_right_broadcast=0 then 0  else b.TDFEUR_total_viewing_events / cast(b.TDFEUR_programmes_viewed_over_threshold as real) end as AVE_A_TDFEUR
...
,case when d.TDFITV_broadcast_days_viewed_LIVE=0 then 0  when d.TDFITV_programmes_viewed_over_threshold_LIVE=0 then 0  when d.TDFITV_broadcast_days_viewed_LIVE is null then 0  when e.TDFITV_days_right_viewable_LIVE =0 then 0 when e.TDFITV_days_right_broadcast_LIVE=0 then 0  else d.TDFITV_total_viewing_events_LIVE / cast(d.TDFITV_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_TDFITV
,case when b.TDFITV_broadcast_days_viewed=0 then 0  when b.TDFITV_programmes_viewed_over_threshold=0 then 0  when b.TDFITV_broadcast_days_viewed is null then 0  when c.TDFITV_days_right_viewable =0 then 0 when c.TDFITV_days_right_broadcast=0 then 0  else b.TDFITV_total_viewing_events / cast(b.TDFITV_programmes_viewed_over_threshold as real) end as AVE_A_TDFITV
,case when d.USMGOLF_broadcast_days_viewed_NON_LIVE=0 then 0  when d.USMGOLF_total_viewing_events_NON_LIVE=0 then 0  when d.USMGOLF_broadcast_days_viewed_NON_LIVE is null then 0  when e.USMGOLF_days_right_viewable_NON_LIVE =0 then 0 when e.USMGOLF_days_right_broadcast_NON_LIVE=0 then 0  else d.USMGOLF_total_viewing_events_NON_LIVE / cast(d.USMGOLF_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_USMGOLF
,case when d.USMGOLF_broadcast_days_viewed_LIVE=0 then 0  when d.USMGOLF_programmes_viewed_over_threshold_LIVE=0 then 0  when d.USMGOLF_broadcast_days_viewed_LIVE is null then 0  when e.USMGOLF_days_right_viewable_LIVE =0 then 0 when e.USMGOLF_days_right_broadcast_LIVE=0 then 0  else d.USMGOLF_total_viewing_events_LIVE / cast(d.USMGOLF_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_USMGOLF
,case when b.USMGOLF_broadcast_days_viewed=0 then 0  when b.USMGOLF_programmes_viewed_over_threshold=0 then 0  when b.USMGOLF_broadcast_days_viewed is null then 0  when c.USMGOLF_days_right_viewable =0 then 0 when c.USMGOLF_days_right_broadcast=0 then 0  else b.USMGOLF_total_viewing_events / cast(b.USMGOLF_programmes_viewed_over_threshold as real) end as AVE_A_USMGOLF
,case when d.USTENSS_broadcast_days_viewed_NON_LIVE=0 then 0  when d.USTENSS_total_viewing_events_NON_LIVE=0 then 0  when d.USTENSS_broadcast_days_viewed_NON_LIVE is null then 0  when e.USTENSS_days_right_viewable_NON_LIVE =0 then 0 when e.USTENSS_days_right_broadcast_NON_LIVE=0 then 0  else d.USTENSS_total_viewing_events_NON_LIVE / cast(d.USTENSS_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_USTENSS
,case when d.USTENSS_broadcast_days_viewed_LIVE=0 then 0  when d.USTENSS_programmes_viewed_over_threshold_LIVE=0 then 0  when d.USTENSS_broadcast_days_viewed_LIVE is null then 0  when e.USTENSS_days_right_viewable_LIVE =0 then 0 when e.USTENSS_days_right_broadcast_LIVE=0 then 0  else d.USTENSS_total_viewing_events_LIVE / cast(d.USTENSS_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_USTENSS
,case when b.USTENSS_broadcast_days_viewed=0 then 0  when b.USTENSS_programmes_viewed_over_threshold=0 then 0  when b.USTENSS_broadcast_days_viewed is null then 0  when c.USTENSS_days_right_viewable =0 then 0 when c.USTENSS_days_right_broadcast=0 then 0  else b.USTENSS_total_viewing_events / cast(b.USTENSS_programmes_viewed_over_threshold as real) end as AVE_A_USTENSS
,case when d.USTENEUR_broadcast_days_viewed_NON_LIVE=0 then 0  when d.USTENEUR_total_viewing_events_NON_LIVE=0 then 0  when d.USTENEUR_broadcast_days_viewed_NON_LIVE is null then 0  when e.USTENEUR_days_right_viewable_NON_LIVE =0 then 0 when e.USTENEUR_days_right_broadcast_NON_LIVE=0 then 0  else d.USTENEUR_total_viewing_events_NON_LIVE / cast(d.USTENEUR_programmes_viewed_over_threshold_NON_LIVE as real) end as AVE_H_USTENEUR
,case when d.USTENEUR_broadcast_days_viewed_LIVE=0 then 0  when d.USTENEUR_programmes_viewed_over_threshold_LIVE=0 then 0  when d.USTENEUR_broadcast_days_viewed_LIVE is null then 0  when e.USTENEUR_days_right_viewable_LIVE =0 then 0 when e.USTENEUR_days_right_broadcast_LIVE=0 then 0  else d.USTENEUR_total_viewing_events_LIVE / cast(d.USTENEUR_programmes_viewed_over_threshold_LIVE as real) end as AVE_L_USTENEUR
,case when b.USTENEUR_broadcast_days_viewed=0 then 0  when b.USTENEUR_programmes_viewed_over_threshold=0 then 0  when b.USTENEUR_broadcast_days_viewed is null then 0  when c.USTENEUR_days_right_viewable =0 then 0 when c.USTENEUR_days_right_broadcast=0 then 0  else b.USTENEUR_total_viewing_events / cast(b.USTENEUR_programmes_viewed_over_threshold as real) end as AVE_A_USTENEUR
*/
...
select
b.USTENSS_broadcast_days_viewed
,c.USTENSS_right_broadcast_duration
,d.BILION_programmes_viewed_over_threshold_LIVE
from dbarnett.v250_master_account_list as a
