...
and panel_id = 12
and cast (instance_start_date_time_utc as date) = '2013-01-15'
--and account_number ='621432260563'

group by account_number
,service_key
;
--select sum(viewing_duration_exc_null_capped_end_date) from #monthly_data_20130115


--drop table  #daily_data_20130115  ;
select           account_number
                ,service_key
...
into #compare_20130115_by_account
from #compare_20130115
group by account_number
;
...
from #compare_20130115_by_account
group by mins
order by mins
;