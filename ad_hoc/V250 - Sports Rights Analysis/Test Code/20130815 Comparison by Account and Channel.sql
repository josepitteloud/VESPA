...
--drop table #monthly_data_20130815;
...
,service_key
;
--select sum(viewing_duration_exc_null_capped_end_date) from #monthly_data_20130815


--drop table  #daily_data_20130815  ;
select           account_number
                ,service_key
                ,sum(viewing_duration)             as duration_instance       
into #daily_data_20130815                                       
from            vespa_analysts.vespa_daily_augs_20130815 as a
...
--select sum(duration_instance) from #daily_data_20130815   where service_key is null
--select count(*) , count(distinct pk_programme_instance_dim) from sk_prod.Vespa_programme_schedule


--drop table  #compare_20130815;
select a.*
,b.duration_instance
into #compare_20130815
from #monthly_data_20130815 as a
left outer join #daily_data_20130815 as b
...
into #compare_20130815_by_account
from #compare_20130815
group by account_number
;
...
from #compare_20130815_by_account
group by mins
order by mins
;
