/*-----------------------------------------------------------------------------------------------------------------
        ...
        Part - Part 06 Sports EPG list for matching to the rights data
        
        Analyst: Dan Barnett
        SK Prod: 5

        Create List of All Sports programmes broadcast from the EPG list to get details by right/sub genre/channel
        of all sports content that could be watched 
*/------------------------------------------------------------------------------------------------------------------
...
--20140207-Create a deduped version to remove SS1 Issue

--Create backup of old table--
select *
into dbarnett.v250_epg_list_copy
from dbarnett.v250_epg_list
;
...
into dbarnett.v250_epg_list_deduped
from dbarnett.v250_epg_list
...
select * into dbarnett.v250_epg_list from dbarnett.v250_epg_list_deduped;
