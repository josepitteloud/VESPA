...
--drop table dbarnett.v250_all_sports_programmes_viewed_deduped;
...
set total_viewing_duration_sports=case when c.total_viewing_duration is null then 0 else c.total_viewing_duration end 
