...
CREATE TABLE "PI_BARB_import_MASTER_05"("imported_text" varchar (10000));

--Creating the tables of Interest in other to obtain the DB1_Station_Code and the Log_Station_Code ----

CREATE TABLE "BARB_DB1_Stations_Reporting_Record_05"
...
CREATE TABLE "BARB_Log_Station_Relationship_to_DB1_Station_Record_05"
                ("file_creation_date" date,
                "file_creation_time" time,
                "file_type" varchar(12),
                "file_version" int,
...
CREATE TABLE "BARB_Split_Stations_Reporting_Record_05"
        ("file_creation_date" date,
        "file_creation_time" time,
        "file_type" varchar(12),
        "file_version" int,
...
create PROCEDURE sp_PI_BARB_IMPORT_MASTER_05 (@in_filename varchar(60)) AS
...
DELETE FROM PI_BARB_IMPORT_MASTER_05
-- import raw data

SET @query = 'LOAD TABLE PI_BARB_IMPORT_MASTER_05 (imported_text '
SET @query = @query || ' ''\n'' ) '
...
SET @audit_row_count = (Select count(1) from PI_BARB_IMPORT_MASTER_05)
...
INSERT INTO BARB_DB1_Stations_Reporting_Record_05
                (file_creation_date,
                file_creation_time,
                file_type,
                file_version,
...
INSERT INTO BARB_Log_Station_Relationship_to_DB1_Station_Record_05
                (file_creation_date,
                file_creation_time,
                file_type,
                file_version,
...
INSERT INTO BARB_Split_Stations_Reporting_Record_05
        (file_creation_date,
        file_creation_time,
        file_type,
        file_version,
...
--Running the Stored procedure i.e sp_PI_BARB_IMPORT_MASTER_05

EXEC sp_PI_BARB_IMPORT_MASTER_05 'PatrickI/MAS_Files/B20120605.MAS'

select top 10* from BARB_Log_Station_Relationship_to_DB1_Station_Record_05
select count(*) from BARB_Log_Station_Relationship_to_DB1_Station_Record_05
