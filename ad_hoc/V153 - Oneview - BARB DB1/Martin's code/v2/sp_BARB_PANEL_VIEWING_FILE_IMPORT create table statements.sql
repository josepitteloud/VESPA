...
CREATE TABLE "neighbom"."BARB_PANEL_VIEWING_FILE_" (
...
CREATE TABLE "neighbom"."BARB_PANEL_VIEWING_FILE_HOME_CHARACTERISTICS" (
        "file_creation_date" date DEFAULT NULL,
        "file_creation_time" time DEFAULT NULL,
        "file_type"          varchar(12) DEFAULT NULL,
        "file_version"       int DEFAULT NULL,
...
CREATE TABLE "neighbom"."BARB_PANEL_VIEWING_FILE_INDIVIDAL_PANEL_MEMBER_DETAILS" (
        "file_creation_date" date DEFAULT NULL,
        "file_creation_time" time DEFAULT NULL,
        "file_type"          varchar(12) DEFAULT NULL,
        "file_version"       int DEFAULT NULL,
...
CREATE TABLE "neighbom"."BARB_PANEL_VIEWING_FILE_RESPONSE_WEIGHT_VIEWING_CATEGORY" (
        "file_creation_date" date DEFAULT NULL,
        "file_creation_time" time DEFAULT NULL,
        "file_type"          varchar(12) DEFAULT NULL,
        "file_version"       int DEFAULT NULL,
...
CREATE TABLE "neighbom"."BARB_PANEL_VIEWING_FILE_TV_SET_CHARACTERISTICS" (
        "file_creation_date" date DEFAULT NULL,
        "file_creation_time" time DEFAULT NULL,
        "file_type"          varchar(12) DEFAULT NULL,
        "file_version"       int DEFAULT NULL,
...
CREATE TABLE "neighbom"."BARB_PANEL_VIEWING_FILE_VIEWING_RECORD_GUESTS" (
        "file_creation_date" date DEFAULT NULL,
        "file_creation_time" time DEFAULT NULL,
        "file_type"          varchar(12) DEFAULT NULL,
        "file_version"       int DEFAULT NULL,
...
CREATE TABLE "neighbom"."BARB_PANEL_VIEWING_FILE_VIEWING_RECORD_PANEL_MEMBERS" (
        "file_creation_date" date DEFAULT NULL,
        "file_creation_time" time DEFAULT NULL,
        "file_type"          varchar(12) DEFAULT NULL,
        "file_version"       int DEFAULT NULL,
