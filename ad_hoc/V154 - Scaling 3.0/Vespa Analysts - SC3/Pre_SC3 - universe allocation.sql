/******************************************************************************
** IMPORTANT: DO NOT RUN THIS CODE UNLESS THERE IS A RULE CHANGE IN ALLOCATION
** OF VIEWERS WHO HAVE NOT GIVEN VIEWING CONSENT.
** Code is only kept for completeness just in case such a change occurs.
** This code was initially used to allocate adsmartable accounts, who had given
** consent, into a different universe to mimic adsmartable accounts who had not
** given consent. The reason for this was because initially adsmartable accounts
** who had not given consent were not included in the Vespa panel, but this
** was later changed and they are now there.
******************************************************************************/
