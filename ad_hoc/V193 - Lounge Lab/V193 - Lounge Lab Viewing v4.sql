...
,case when q7 like '%4Seven%' then 1 else 0 end as Channel_Watched_4Seven
,case when q7 like '%5 USA%' then 1 else 0 end as Channel_Watched_5_USA
,case when q7 like '%5*%' then 1 else 0 end as Channel_Watched_5Star
,case when q7 like '%Alibi%' then 1 else 0 end as Channel_Watched_Alibi
,case when q7 like '%Animal Planet%' then 1 else 0 end as Channel_Watched_Animal_Planet
,case when q7 like '%BBC 1%' then 1 else 0 end as Channel_Watched_BBC_1
,case when q7 like '%BBC News%' then 1 else 0 end as Channel_Watched_BBC_News
,case when q7 like '%BBC2%' then 1 else 0 end as Channel_Watched_BBC2
,case when q7 like '%BBC3%' then 1 else 0 end as Channel_Watched_BBC3
,case when q7 like '%BBC4%' then 1 else 0 end as Channel_Watched_BBC4
,case when q7 like '%Bio%' then 1 else 0 end as Channel_Watched_Bio
,case when q7 like '%Cartoon Network%' then 1 else 0 end as Channel_Watched_Cartoon_Network
,case when q7 like '%CBBC%' then 1 else 0 end as Channel_Watched_CBBC
,case when q7 like '%CBeebies%' then 1 else 0 end as Channel_Watched_CBeebies
,case when q7 like '%Challenge%' then 1 else 0 end as Channel_Watched_Challenge
,case when q7 like '%Channel 4%' then 1 else 0 end as Channel_Watched_Channel_4
,case when q7 like '%Channel 5%' then 1 else 0 end as Channel_Watched_Channel_5
,case when q7 like '%Comedy Central%' then 1 else 0 end as Channel_Watched_Comedy_Central
,case when q7 like '%Crime & Investigation Network%' then 1 else 0 end as Channel_Watched_Crime___Investigation_Network
,case when q7 like '%Dave%' then 1 else 0 end as Channel_Watched_Dave
,case when q7 like '%Discovery Channel%' then 1 else 0 end as Channel_Watched_Discovery_Channel
,case when q7 like '%Discovery History%' then 1 else 0 end as Channel_Watched_Discovery_History
,case when q7 like '%Discovery Home & Health%' then 1 else 0 end as Channel_Watched_Discovery_Home___Health
,case when q7 like '%Discovery Science%' then 1 else 0 end as Channel_Watched_Discovery_Science
,case when q7 like '%Discovery Shed%' then 1 else 0 end as Channel_Watched_Discovery_Shed
,case when q7 like '%Discovery Turbo%' then 1 else 0 end as Channel_Watched_Discovery_Turbo
,case when q7 like '%Disney Channel%' then 1 else 0 end as Channel_Watched_Disney_Channel
,case when q7 like '%Disney Junior%' then 1 else 0 end as Channel_Watched_Disney_Junior
,case when q7 like '%Disney XD%' then 1 else 0 end as Channel_Watched_Disney_XD
,case when q7 like '%DMAX%' then 1 else 0 end as Channel_Watched_DMAX
,case when q7 like '%Drama%' then 1 else 0 end as Channel_Watched_Drama
,case when q7 like '%E! Entertainment%' then 1 else 0 end as Channel_Watched_E__Entertainment
,case when q7 like '%E4%' then 1 else 0 end as Channel_Watched_E4
,case when q7 like '%Eden%' then 1 else 0 end as Channel_Watched_Eden
,case when q7 like '%ESPN %' then 1 else 0 end as Channel_Watched_ESPN_
,case when q7 like '%ESPN Classic%' then 1 else 0 end as Channel_Watched_ESPN_Classic
,case when q7 like '%Eurosport%' then 1 else 0 end as Channel_Watched_Eurosport
,case when q7 like '%Extreme Sports%' then 1 else 0 end as Channel_Watched_Extreme_Sports
,case when q7 like '%Film4%' then 1 else 0 end as Channel_Watched_Film4
,case when q7 like '%FOX%' then 1 else 0 end as Channel_Watched_FOX
,case when q7 like '%G.O.L.D%' then 1 else 0 end as Channel_Watched_G_O_L_D
,case when q7 like '%Good Food%' then 1 else 0 end as Channel_Watched_Good_Food
,case when q7 like '%H2%' then 1 else 0 end as Channel_Watched_H2
,case when q7 like '%History Channel%' then 1 else 0 end as Channel_Watched_History_Channel
,case when q7 like '%Home%' then 1 else 0 end as Channel_Watched_Home
,case when q7 like '%Investigation Discovery%' then 1 else 0 end as Channel_Watched_Investigation_Discovery
,case when q7 like '%ITV1%' then 1 else 0 end as Channel_Watched_ITV1
,case when q7 like '%ITV2%' then 1 else 0 end as Channel_Watched_ITV2
,case when q7 like '%ITV3%' then 1 else 0 end as Channel_Watched_ITV3
,case when q7 like '%ITV4%' then 1 else 0 end as Channel_Watched_ITV4
,case when q7 like '%More4%' then 1 else 0 end as Channel_Watched_More4
,case when q7 like '%MTV%' then 1 else 0 end as Channel_Watched_MTV
,case when q7 like '%Nat Geo%' then 1 else 0 end as Channel_Watched_Nat_Geo
,case when q7 like '%Nat Geo Wild%' then 1 else 0 end as Channel_Watched_Nat_Geo_Wild
,case when q7 like '%Nick Jr%' then 1 else 0 end as Channel_Watched_Nick_Jr
,case when q7 like '%Nickelodeon%' then 1 else 0 end as Channel_Watched_Nickelodeon
,case when q7 like '%PBS America%' then 1 else 0 end as Channel_Watched_PBS_America
,case when q7 like '%Pick TV%' then 1 else 0 end as Channel_Watched_Pick_TV
,case when q7 like '%QVC%' then 1 else 0 end as Channel_Watched_QVC
,case when q7 like '%Really%' then 1 else 0 end as Channel_Watched_Really
,case when q7 like '%Sky 1%' then 1 else 0 end as Channel_Watched_Sky_1
,case when q7 like '%Sky 2%' then 1 else 0 end as Channel_Watched_Sky_2
,case when q7 like '%Sky Arts%' then 1 else 0 end as Channel_Watched_Sky_Arts
,case when q7 like '%Sky Atlantic%' then 1 else 0 end as Channel_Watched_Sky_Atlantic
,case when q7 like '%Sky Living%' then 1 else 0 end as Channel_Watched_Sky_Living
,case when q7 like '%Sky Movies%' then 1 else 0 end as Channel_Watched_Sky_Movies
,case when q7 like '%Sky News%' then 1 else 0 end as Channel_Watched_Sky_News
,case when q7 like '%Sky Sports%' then 1 else 0 end as Channel_Watched_Sky_Sports
,case when q7 like '%Sky Sports F1%' then 1 else 0 end as Channel_Watched_Sky_Sports_F1
,case when q7 like '%Sky Sports News%' then 1 else 0 end as Channel_Watched_Sky_Sports_News
,case when q7 like '%Star Life OK%' then 1 else 0 end as Channel_Watched_Star_Life_OK
,case when q7 like '%Star Plus%' then 1 else 0 end as Channel_Watched_Star_Plus
,case when q7 like '%Syfy%' then 1 else 0 end as Channel_Watched_Syfy
,case when q7 like '%TCM%' then 1 else 0 end as Channel_Watched_TCM
,case when q7 like '%The Food Network%' then 1 else 0 end as Channel_Watched_The_Food_Network
,case when q7 like '%TLC%' then 1 else 0 end as Channel_Watched_TLC
,case when q7 like '%Universal%' then 1 else 0 end as Channel_Watched_Universal
,case when q7 like '%Watch%' then 1 else 0 end as Channel_Watched_Watch
,case when q7 like '%Yesterday%' then 1 else 0 end as Channel_Watched_Yesterday
from dbarnett.project193_loungelab_survey_results
; 



--select top 100 * from dbarnett.project193_loungelab_survey_results;
