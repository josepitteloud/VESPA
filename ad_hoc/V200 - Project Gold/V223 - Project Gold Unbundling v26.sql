...
select account_number
,rank() over (  ORDER BY  annualised_programmes_engaged_pay_sport_total desc) as rank_prog_engaged_pay_sports
...
when abs(rank_prog_engaged_pay_sports/(@total_programmes_3min_plus_pay_sports/100))+1 >100 then 100 
else abs(rank_prog_engaged_pay_sports/(@total_programmes_3min_plus_pay_sports/100))+1 end
,phase_2_decile_engaged_pay_sports = case when annualised_programmes_3min_plus_pay_sport_total=0 then 99 
when abs(rank_prog_engaged_pay_sports/(@total_programmes_3min_plus_pay_sports/10))+1 >10 then 10 
else 
abs(rank_prog_engaged_pay_sports/(@total_programmes_3min_plus_pay_sports/10))+1 end
;
commit;
...
update dbarnett.v223_Unbundling_pivot_activity_data
set phase_2_percentile_engaged_pay_sports = case when annualised_programmes_engaged_pay_sport_total=0 then 999 
...
,phase_2_decile_engaged_pay_sports = case when annualised_programmes_engaged_pay_sport_total=0 then 99 
