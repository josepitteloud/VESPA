...
,value_segment
,case when affluence_septile is null then 'U' 
        when affluence_septile = '0' then '0: Lowest Affluence' 
        when affluence_septile = '6' then '6: Highest Affluence' else affluence_septile end as affluence_septile_type
,box_type_group
...
--select average_total_tv_viewing_duration ,count(*) from dbarnett.v220_pivot_activity_data group by average_total_tv_viewing_duration order by average_total_tv_viewing_duration
