...
,rank_minutes_football_fa_cup_sky_sports integer
...
,rank_prog_3min_plus_football_fa_cup_sky_sports integer
...
,rank_prog_engaged_football_fa_cup_sky_sports integer
...
,annualised_programmes_3min_plus_sport_espn =programmes_3min_plus_espn_total/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_sport_terrestrial =programmes_3min_plus_Terrestrial_total/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_sport_football_terrestrial =programmes_3min_plus_Terrestrial_football/60*(365/cast(days_with_viewing as real))

,annualised_programmes_3min_plus_sport_sky_sports_news =programmes_3min_plus_Sky_Sports_News/60*(365/cast(days_with_viewing as real))

,annualised_programmes_3min_plus_football_premier_league_sky_sports =case when sky_premier_league_days=0 then -1 
when cast(sky_premier_league_days as real)/total_sky_premier_league_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_premier_league/60*(total_sky_premier_league_days/cast(sky_premier_league_days as real)) end
...
programmes_3min_plus_ESPN_premier_league)/60*(total_espn_premier_league_days
/cast(espn_bt_premier_league_days as real)) end

,annualised_programmes_3min_plus_football_champions_league_sky_sports =case when sky_champions_league_days=0 then -1 
when cast(sky_champions_league_days as real)/total_sky_champions_league_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_champions_league/60*(total_sky_champions_league_days/cast(sky_champions_league_days as real)) end

,annualised_programmes_3min_plus_football_champions_league_non_sky_sports =case when other_champions_league_days =0 then -1 
when cast(other_champions_league_days as real)/total_other_champions_league_days <0.5 then -1 
else programmes_3min_plus_non_sky_Sports_champions_league/60*(total_other_champions_league_days 
/cast(other_champions_league_days as real)) end


,annualised_programmes_3min_plus_football_europa_league_ESPN_BT =case when espn_bt_europa_league_days=0 then -1 
when cast(espn_bt_europa_league_days as real)/total_espn_bt_europa_league_days<0.5 then -1 
else programmes_3min_plus_espn_bt_Sports_europa_league/60*(total_espn_bt_europa_league_days
/cast(espn_bt_europa_league_days as real)) end


,annualised_programmes_3min_plus_football_europa_league_Other_Channels =case when non_sky_europa_league_days=0 then -1 
when cast(non_sky_europa_league_days as real)/total_non_sky_europa_league_days<0.5 then -1 
else programmes_3min_plus_non_sky_Sports_europa_league/60*(total_non_sky_europa_league_days
/cast(non_sky_europa_league_days as real)) end

,annualised_programmes_3min_plus_football_fa_cup_ESPN_BT =case when espn_bt_fa_cup_days=0 then -1 
when cast(espn_bt_fa_cup_days as real)/total_espn_bt_fa_cup_days<0.5 then -1 
else (programmes_3min_plus_BT_Sport_FA_Cup+programmes_3min_plus_ESPN_FA_Cup)/60*(total_espn_bt_fa_cup_days
/cast(espn_bt_fa_cup_days as real)) end

,annualised_programmes_3min_plus_football_fa_cup_Other_Channels =case when other_fa_cup_days=0 then -1 
when cast(other_fa_cup_days as real)/total_other_fa_cup_days<0.5 then -1 
else programmes_3min_plus_other_FA_Cup/60*(total_other_fa_cup_days
/cast(other_fa_cup_days as real)) end

,annualised_programmes_3min_plus_football_world_cup_qualifier_sky_sports =case when sky_World_Cup_Qualifiers_days=0 then -1 
when cast(sky_World_Cup_Qualifiers_days as real)/total_sky_World_Cup_Qualifiers_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_World_Cup_Qualifiers/60*(total_sky_World_Cup_Qualifiers_days/cast(sky_World_Cup_Qualifiers_days as real)) end
...
when cast(other_World_Cup_Qualifiers_days as real)/total_other_World_Cup_Qualifiers_days<0.5 then -1 
else programmes_3min_plus_non_sky_Sports_World_Cup_Qualifiers/60*(total_other_World_Cup_Qualifiers_days/cast(other_World_Cup_Qualifiers_days as real)) end
...
when cast(sky_international_friendlies_days as real)/total_sky_international_friendlies_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_international_friendlies/60*(total_sky_international_friendlies_days/cast(sky_international_friendlies_days as real)) end
...
when cast(other_international_friendlies_days as real)/total_other_international_friendlies_days<0.5 then -1 
else programmes_3min_plus_non_sky_Sports_international_friendlies/60*(total_other_international_friendlies_days/cast(other_international_friendlies_days as real)) end

,annualised_programmes_3min_plus_football_scottish_football_sky_sports =case when sky_scottish_football_days=0 then -1 
when cast(sky_scottish_football_days as real)/total_sky_scottish_football_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_scottish_football/60*(total_sky_scottish_football_days/cast(sky_scottish_football_days as real)) end
...
when cast(espn_bt_scottish_football_days as real)/total_espn_bt_scottish_football_days<0.5 then -1 
else programmes_3min_plus_non_sky_sports_scottish_football/60*(total_espn_bt_scottish_football_days/cast(espn_bt_scottish_football_days as real)) end


,annualised_programmes_3min_plus_football_Capital_One_Cup_sky_sports =case when sky_capital_one_cup_days=0 then -1 
when cast(sky_capital_one_cup_days as real)/total_sky_capital_one_cup_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_capital_one_cup/60*(total_sky_capital_one_cup_days/cast(sky_capital_one_cup_days as real)) end


,annualised_programmes_3min_plus_football_La_Liga_sky_sports =case when sky_la_liga_days=0 then -1 
when cast(sky_la_liga_days as real)/total_sky_la_liga_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_la_liga/60*(total_sky_la_liga_days/cast(sky_la_liga_days as real)) end

,annualised_programmes_3min_plus_football_football_league_sky_sports =case when sky_football_league_days=0 then -1 
when cast(sky_football_league_days as real)/total_sky_football_league_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_football_league/60*(total_sky_football_league_days/cast(sky_football_league_days as real)) end

,annualised_programmes_3min_plus_cricket_ashes_sky_sports =case when sky_ashes_days=0 then -1 
when cast(sky_ashes_days as real)/total_sky_ashes_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_cricket_ashes/60*(total_sky_ashes_days/cast(sky_ashes_days as real)) end
...
,annualised_programmes_3min_plus_cricket_non_ashes_sky_sports =programmes_3min_plus_Sky_Sports_cricket_exc_ashes/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_cricket_non_ashes_non_sky_sports =
programmes_3min_plus_cricket_exc_ashes_non_Sky_Sports_or_SSN/60*(365/cast(days_with_viewing as real))
...
programmes_3min_plus_Sky_Sports_golf_major)/60*(365/cast(days_with_viewing as real))
...
,annualised_programmes_3min_plus_tennis_sky_sports =programmes_3min_plus_Sky_Sports_tennis/60*(365/cast(days_with_viewing as real))

,annualised_programmes_3min_plus_tennis_non_sky_sports =
(programmes_3min_plus_non_Sky_Sports_or_SSN_tennis_exc_wimbledon+
programmes_3min_plus_non_Sky_Sports_or_SSN_wimbledon)/60*(365/cast(days_with_viewing as real))

,annualised_programmes_3min_plus_motor_sport_sky_sports =programmes_3min_plus_Sky_Sports_motor_sport_exc_f1/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_motor_sport_non_sky_sports =programmes_3min_plus_non_Sky_Sports_or_SSN_motor_sport_exc_f1/60*(365/cast(days_with_viewing as real))


,annualised_programmes_3min_plus_F1_sky_sports =case when sky_f1_days=0 then -1 
when cast(sky_f1_days as real)/total_sky_f1_days<0.5 then -1 
else programmes_3min_plus_Sky_Sports_motor_sport_Formula_1/60*(total_sky_f1_days/cast(sky_f1_days as real)) end

,annualised_programmes_3min_plus_F1_non_sky_sports =case when other_f1_days=0 then -1 
when cast(other_f1_days as real)/total_other_f1_days<0.5 then -1 
else programmes_3min_plus_non_Sky_Sports_or_SSN_Formula_1/60*(total_other_f1_days/cast(other_f1_days as real)) end


,annualised_programmes_3min_plus_horse_racing_sky_sports =programmes_3min_plus_Sky_Sports_horse_racing/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_horse_racing_non_sky_sports =programmes_3min_plus_non_Sky_Sports_or_SSN_horse_racing/60*(365/cast(days_with_viewing as real))

,annualised_programmes_3min_plus_snooker_pool_sky_sports =programmes_3min_plus_Sky_Sports_snooker_pool/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_snooker_pool_non_sky_sports =programmes_3min_plus_non_Sky_Sports_or_SSN_snooker_pool/60*(365/cast(days_with_viewing as real))

,annualised_programmes_3min_plus_rugby_sky_sports =programmes_3min_plus_Sky_Sports_Rugby/60*(365/cast(days_with_viewing as real))
...
,annualised_programmes_3min_plus_wrestling_sky_sports =programmes_3min_plus_Sky_Sports_inc_SBO_wrestling/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_wrestling_non_sky_sports =programmes_3min_plus_non_Sky_Sports_or_SBO_wrestling/60*(365/cast(days_with_viewing as real))

---WWE--

,annualised_programmes_3min_plus_wwe =programmes_3min_plus_WWE/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_wwe_sky_sports =programmes_3min_plus_Sky_Sports_WWE/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_wwe_sbo =programmes_3min_plus_SBO_WWE/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_wwe_sky_1_or_2 =programmes_3min_plus_Sky_1_or_2_WWE/60*(365/cast(days_with_viewing as real))

,annualised_programmes_3min_plus_darts_sky_sports =programmes_3min_plus_Sky_Sports_Darts/60*(365/cast(days_with_viewing as real))
,annualised_programmes_3min_plus_darts_non_sky_sports =programmes_3min_plus_non_Sky_Sports_Darts/60*(365/cast(days_with_viewing as real))
...
,annualised_programmes_engaged_sport_espn =programmes_engaged_espn_total/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_sport_terrestrial =programmes_engaged_Terrestrial_total/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_sport_football_terrestrial =programmes_engaged_Terrestrial_football/60*(365/cast(days_with_viewing as real))

,annualised_programmes_engaged_sport_sky_sports_news =programmes_engaged_Sky_Sports_News/60*(365/cast(days_with_viewing as real))

,annualised_programmes_engaged_football_premier_league_sky_sports =case when sky_premier_league_days=0 then -1 
when cast(sky_premier_league_days as real)/total_sky_premier_league_days<0.5 then -1 
else programmes_engaged_Sky_Sports_premier_league/60*(total_sky_premier_league_days/cast(sky_premier_league_days as real)) end
...
programmes_engaged_ESPN_premier_league)/60*(total_espn_premier_league_days
/cast(espn_bt_premier_league_days as real)) end

,annualised_programmes_engaged_football_champions_league_sky_sports =case when sky_champions_league_days=0 then -1 
when cast(sky_champions_league_days as real)/total_sky_champions_league_days<0.5 then -1 
else programmes_engaged_Sky_Sports_champions_league/60*(total_sky_champions_league_days/cast(sky_champions_league_days as real)) end

,annualised_programmes_engaged_football_champions_league_non_sky_sports =case when other_champions_league_days =0 then -1 
when cast(other_champions_league_days as real)/total_other_champions_league_days <0.5 then -1 
else programmes_engaged_non_sky_Sports_champions_league/60*(total_other_champions_league_days 
/cast(other_champions_league_days as real)) end


,annualised_programmes_engaged_football_europa_league_ESPN_BT =case when espn_bt_europa_league_days=0 then -1 
when cast(espn_bt_europa_league_days as real)/total_espn_bt_europa_league_days<0.5 then -1 
else programmes_engaged_espn_bt_Sports_europa_league/60*(total_espn_bt_europa_league_days
/cast(espn_bt_europa_league_days as real)) end


,annualised_programmes_engaged_football_europa_league_Other_Channels =case when non_sky_europa_league_days=0 then -1 
when cast(non_sky_europa_league_days as real)/total_non_sky_europa_league_days<0.5 then -1 
else programmes_engaged_non_sky_Sports_europa_league/60*(total_non_sky_europa_league_days
/cast(non_sky_europa_league_days as real)) end

,annualised_programmes_engaged_football_fa_cup_ESPN_BT =case when espn_bt_fa_cup_days=0 then -1 
when cast(espn_bt_fa_cup_days as real)/total_espn_bt_fa_cup_days<0.5 then -1 
else (programmes_engaged_BT_Sport_FA_Cup+programmes_engaged_ESPN_FA_Cup)/60*(total_espn_bt_fa_cup_days
/cast(espn_bt_fa_cup_days as real)) end

,annualised_programmes_engaged_football_fa_cup_Other_Channels =case when other_fa_cup_days=0 then -1 
when cast(other_fa_cup_days as real)/total_other_fa_cup_days<0.5 then -1 
else programmes_engaged_other_FA_Cup/60*(total_other_fa_cup_days
/cast(other_fa_cup_days as real)) end

,annualised_programmes_engaged_football_world_cup_qualifier_sky_sports =case when sky_World_Cup_Qualifiers_days=0 then -1 
when cast(sky_World_Cup_Qualifiers_days as real)/total_sky_World_Cup_Qualifiers_days<0.5 then -1 
else programmes_engaged_Sky_Sports_World_Cup_Qualifiers/60*(total_sky_World_Cup_Qualifiers_days/cast(sky_World_Cup_Qualifiers_days as real)) end
...
when cast(other_World_Cup_Qualifiers_days as real)/total_other_World_Cup_Qualifiers_days<0.5 then -1 
else programmes_engaged_non_sky_Sports_World_Cup_Qualifiers/60*(total_other_World_Cup_Qualifiers_days/cast(other_World_Cup_Qualifiers_days as real)) end
...
when cast(sky_international_friendlies_days as real)/total_sky_international_friendlies_days<0.5 then -1 
else programmes_engaged_Sky_Sports_international_friendlies/60*(total_sky_international_friendlies_days/cast(sky_international_friendlies_days as real)) end
...
when cast(other_international_friendlies_days as real)/total_other_international_friendlies_days<0.5 then -1 
else programmes_engaged_non_sky_Sports_international_friendlies/60*(total_other_international_friendlies_days/cast(other_international_friendlies_days as real)) end

,annualised_programmes_engaged_football_scottish_football_sky_sports =case when sky_scottish_football_days=0 then -1 
when cast(sky_scottish_football_days as real)/total_sky_scottish_football_days<0.5 then -1 
else programmes_engaged_Sky_Sports_scottish_football/60*(total_sky_scottish_football_days/cast(sky_scottish_football_days as real)) end
...
when cast(espn_bt_scottish_football_days as real)/total_espn_bt_scottish_football_days<0.5 then -1 
else programmes_engaged_non_sky_sports_scottish_football/60*(total_espn_bt_scottish_football_days/cast(espn_bt_scottish_football_days as real)) end


,annualised_programmes_engaged_football_Capital_One_Cup_sky_sports =case when sky_capital_one_cup_days=0 then -1 
when cast(sky_capital_one_cup_days as real)/total_sky_capital_one_cup_days<0.5 then -1 
else programmes_engaged_Sky_Sports_capital_one_cup/60*(total_sky_capital_one_cup_days/cast(sky_capital_one_cup_days as real)) end


,annualised_programmes_engaged_football_La_Liga_sky_sports =case when sky_la_liga_days=0 then -1 
when cast(sky_la_liga_days as real)/total_sky_la_liga_days<0.5 then -1 
else programmes_engaged_Sky_Sports_la_liga/60*(total_sky_la_liga_days/cast(sky_la_liga_days as real)) end

,annualised_programmes_engaged_football_football_league_sky_sports =case when sky_football_league_days=0 then -1 
when cast(sky_football_league_days as real)/total_sky_football_league_days<0.5 then -1 
else programmes_engaged_Sky_Sports_football_league/60*(total_sky_football_league_days/cast(sky_football_league_days as real)) end

,annualised_programmes_engaged_cricket_ashes_sky_sports =case when sky_ashes_days=0 then -1 
when cast(sky_ashes_days as real)/total_sky_ashes_days<0.5 then -1 
else programmes_engaged_Sky_Sports_cricket_ashes/60*(total_sky_ashes_days/cast(sky_ashes_days as real)) end
...
,annualised_programmes_engaged_cricket_non_ashes_sky_sports =programmes_engaged_Sky_Sports_cricket_exc_ashes/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_cricket_non_ashes_non_sky_sports =
programmes_engaged_cricket_exc_ashes_non_Sky_Sports_or_SSN/60*(365/cast(days_with_viewing as real))
...
programmes_engaged_Sky_Sports_golf_major)/60*(365/cast(days_with_viewing as real))
...
,annualised_programmes_engaged_tennis_sky_sports =programmes_engaged_Sky_Sports_tennis/60*(365/cast(days_with_viewing as real))

,annualised_programmes_engaged_tennis_non_sky_sports =
(programmes_engaged_non_Sky_Sports_or_SSN_tennis_exc_wimbledon+
programmes_engaged_non_Sky_Sports_or_SSN_wimbledon)/60*(365/cast(days_with_viewing as real))

,annualised_programmes_engaged_motor_sport_sky_sports =programmes_engaged_Sky_Sports_motor_sport_exc_f1/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_motor_sport_non_sky_sports =programmes_engaged_non_Sky_Sports_or_SSN_motor_sport_exc_f1/60*(365/cast(days_with_viewing as real))


,annualised_programmes_engaged_F1_sky_sports =case when sky_f1_days=0 then -1 
when cast(sky_f1_days as real)/total_sky_f1_days<0.5 then -1 
else programmes_engaged_Sky_Sports_motor_sport_Formula_1/60*(total_sky_f1_days/cast(sky_f1_days as real)) end

,annualised_programmes_engaged_F1_non_sky_sports =case when other_f1_days=0 then -1 
when cast(other_f1_days as real)/total_other_f1_days<0.5 then -1 
else programmes_engaged_non_Sky_Sports_or_SSN_Formula_1/60*(total_other_f1_days/cast(other_f1_days as real)) end


,annualised_programmes_engaged_horse_racing_sky_sports =programmes_engaged_Sky_Sports_horse_racing/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_horse_racing_non_sky_sports =programmes_engaged_non_Sky_Sports_or_SSN_horse_racing/60*(365/cast(days_with_viewing as real))

,annualised_programmes_engaged_snooker_pool_sky_sports =programmes_engaged_Sky_Sports_snooker_pool/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_snooker_pool_non_sky_sports =programmes_engaged_non_Sky_Sports_or_SSN_snooker_pool/60*(365/cast(days_with_viewing as real))

,annualised_programmes_engaged_rugby_sky_sports =programmes_engaged_Sky_Sports_Rugby/60*(365/cast(days_with_viewing as real))
...
,annualised_programmes_engaged_wrestling_sky_sports =programmes_engaged_Sky_Sports_inc_SBO_wrestling/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_wrestling_non_sky_sports =programmes_engaged_non_Sky_Sports_or_SBO_wrestling/60*(365/cast(days_with_viewing as real))

---WWE--

,annualised_programmes_engaged_wwe =programmes_engaged_WWE/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_wwe_sky_sports =programmes_engaged_Sky_Sports_WWE/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_wwe_sbo =programmes_engaged_SBO_WWE/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_wwe_sky_1_or_2 =programmes_engaged_Sky_1_or_2_WWE/60*(365/cast(days_with_viewing as real))

,annualised_programmes_engaged_darts_sky_sports =programmes_engaged_Sky_Sports_Darts/60*(365/cast(days_with_viewing as real))
,annualised_programmes_engaged_darts_non_sky_sports =programmes_engaged_non_Sky_Sports_Darts/60*(365/cast(days_with_viewing as real))
...
--,rank_minutes_football_ESPN_BT  =b.rank_minutes_football_ESPN_BT 
...
,rank_prog_engaged_sport  =b.rank_prog_engaged_sport 
...
update v223_unbundling_viewing_summary_by_account 
set  
percentile_minutes_sport =case when minutes_sport =-1 then 999 when minutes_sport =0 then 10 else abs(rank_minutes_sport /3000)+1 end
,percentile_minutes_sport_sky_sports =case when minutes_sport_sky_sports =-1 then 999 when minutes_sport_sky_sports =0 then 10 else abs(rank_minutes_sport_sky_sports /3000)+1 end
,percentile_minutes_sport_sky_sports_news =case when minutes_sport_sky_sports_news =-1 then 999 when minutes_sport_sky_sports_news =0 then 10 else abs(rank_minutes_sport_sky_sports_news /3000)+1 end

,percentile_minutes_sport_terrestrial =case when minutes_sport_terrestrial =-1 then 999 when minutes_sport_terrestrial =0 then 10 else abs(rank_minutes_sport_terrestrial /3000)+1 end
,percentile_minutes_sport_football_terrestrial =case when minutes_sport_football_terrestrial =-1 then 999 when minutes_sport_football_terrestrial =0 then 10 else abs(rank_minutes_sport_football_terrestrial /3000)+1 end


,percentile_minutes_sport_espn =case when minutes_sport_espn =-1 then 999 when minutes_sport_espn =0 then 10 else abs(rank_minutes_sport_espn /3000)+1 end

,percentile_minutes_football_sky_sports =case when minutes_football_sky_sports =-1 then 999 when minutes_football_sky_sports =0 then 10 else abs(rank_minutes_football_sky_sports /3000)+1 end

,percentile_minutes_football_premier_league_sky_sports =case when minutes_football_premier_league_sky_sports =-1 then 999 when minutes_football_premier_league_sky_sports =0 then 10 else abs(rank_minutes_football_premier_league_sky_sports /3000)+1 end
,percentile_minutes_football_premier_league_ESPN_BT =case when minutes_football_premier_league_ESPN_BT =-1 then 999 when minutes_football_premier_league_ESPN_BT =0 then 10 else abs(rank_minutes_football_premier_league_ESPN_BT /3000)+1 end

,percentile_minutes_football_champions_league_sky_sports =case when minutes_football_champions_league_sky_sports =-1 then 999 when minutes_football_champions_league_sky_sports =0 then 10 else abs(rank_minutes_football_champions_league_sky_sports /3000)+1 end
,percentile_minutes_football_champions_league_non_sky_sports =case when minutes_football_champions_league_non_sky_sports =-1 then 999 when minutes_football_champions_league_non_sky_sports =0 then 10 else abs(rank_minutes_football_champions_league_non_sky_sports /3000)+1 end

--,percentile_minutes_football_fa_cup_sky_sports =case when minutes_football_fa_cup_sky_sports =-1 then 999 when minutes_football_fa_cup_sky_sports =0 then 10 else abs(rank_minutes_football_fa_cup_sky_sports /3000)+1 end
,percentile_minutes_football_europa_league_ESPN_BT =case when minutes_football_europa_league_ESPN_BT =-1 then 999 when minutes_football_europa_league_ESPN_BT =0 then 10 else abs(rank_minutes_football_europa_league_ESPN_BT /3000)+1 end
,percentile_minutes_football_europa_league_Other_Channels =case when minutes_football_europa_league_Other_Channels =-1 then 999 when minutes_football_europa_league_Other_Channels =0 then 10 else abs(rank_minutes_football_europa_league_Other_Channels /3000)+1 end

,percentile_minutes_football_fa_cup_ESPN_BT =case when minutes_football_fa_cup_ESPN_BT =-1 then 999 when minutes_football_fa_cup_ESPN_BT =0 then 10 else abs(rank_minutes_football_fa_cup_ESPN_BT /3000)+1 end
,percentile_minutes_football_fa_cup_Other_Channels =case when minutes_football_fa_cup_Other_Channels =-1 then 999 when minutes_football_fa_cup_Other_Channels =0 then 10 else abs(rank_minutes_football_fa_cup_Other_Channels /3000)+1 end


,percentile_minutes_football_world_cup_qualifier_sky_sports =case when minutes_football_world_cup_qualifier_sky_sports =-1 then 999 when minutes_football_world_cup_qualifier_sky_sports =0 then 10 else abs(rank_minutes_football_world_cup_qualifier_sky_sports /3000)+1 end
,percentile_minutes_football_world_cup_qualifier_non_sky_sports =case when minutes_football_world_cup_qualifier_non_sky_sports =-1 then 999 when minutes_football_world_cup_qualifier_non_sky_sports =0 then 10 else abs(rank_minutes_football_world_cup_qualifier_non_sky_sports /3000)+1 end

,percentile_minutes_football_international_friendly_sky_sports =case when minutes_football_international_friendly_sky_sports =-1 then 999 when minutes_football_international_friendly_sky_sports =0 then 10 else abs(rank_minutes_football_international_friendly_sky_sports /3000)+1 end
,percentile_minutes_football_international_friendly_non_sky_sports =case when minutes_football_international_friendly_non_sky_sports =-1 then 999 when minutes_football_international_friendly_non_sky_sports =0 then 10 else abs(rank_minutes_football_international_friendly_non_sky_sports /3000)+1 end

,percentile_minutes_football_Capital_One_Cup_sky_sports =case when minutes_football_Capital_One_Cup_sky_sports =-1 then 999 when minutes_football_Capital_One_Cup_sky_sports =0 then 10 else abs(rank_minutes_football_Capital_One_Cup_sky_sports /3000)+1 end

,percentile_minutes_football_La_Liga_sky_sports =case when minutes_football_La_Liga_sky_sports =-1 then 999 when minutes_football_La_Liga_sky_sports =0 then 10 else abs(rank_minutes_football_La_Liga_sky_sports /3000)+1 end

,percentile_minutes_football_football_league_sky_sports =case when minutes_football_football_league_sky_sports =-1 then 999 when minutes_football_football_league_sky_sports =0 then 10 else abs(rank_minutes_football_football_league_sky_sports /3000)+1 end

,percentile_minutes_cricket_ashes_sky_sports =case when minutes_cricket_ashes_sky_sports =-1 then 999 when minutes_cricket_ashes_sky_sports =0 then 10 else abs(rank_minutes_cricket_ashes_sky_sports /3000)+1 end
,percentile_minutes_cricket_ashes_non_sky_sports =case when minutes_cricket_ashes_non_sky_sports =-1 then 999 when minutes_cricket_ashes_non_sky_sports =0 then 10 else abs(rank_minutes_cricket_ashes_non_sky_sports /3000)+1 end

,percentile_minutes_cricket_non_ashes_sky_sports =case when minutes_cricket_non_ashes_sky_sports =-1 then 999 when minutes_cricket_non_ashes_sky_sports =0 then 10 else abs(rank_minutes_cricket_non_ashes_sky_sports /3000)+1 end
,percentile_minutes_cricket_non_ashes_non_sky_sports =case when minutes_cricket_non_ashes_non_sky_sports =-1 then 999 when minutes_cricket_non_ashes_non_sky_sports =0 then 10 else abs(rank_minutes_cricket_non_ashes_non_sky_sports /3000)+1 end



,percentile_minutes_golf_sky_sports =case when minutes_golf_sky_sports =-1 then 999 when minutes_golf_sky_sports =0 then 10 else abs(rank_minutes_golf_sky_sports /3000)+1 end
,percentile_minutes_golf_non_sky_sports =case when minutes_golf_non_sky_sports =-1 then 999 when minutes_golf_non_sky_sports =0 then 10 else abs(rank_minutes_golf_non_sky_sports /3000)+1 end

,percentile_minutes_tennis_sky_sports =case when minutes_tennis_sky_sports =-1 then 999 when minutes_tennis_sky_sports =0 then 10 else abs(rank_minutes_tennis_sky_sports /3000)+1 end
,percentile_minutes_tennis_non_sky_sports =case when minutes_tennis_non_sky_sports =-1 then 999 when minutes_tennis_non_sky_sports =0 then 10 else abs(rank_minutes_tennis_non_sky_sports /3000)+1 end

,percentile_minutes_motor_sport_sky_sports =case when minutes_motor_sport_sky_sports =-1 then 999 when minutes_motor_sport_sky_sports =0 then 10 else abs(rank_minutes_motor_sport_sky_sports /3000)+1 end
,percentile_minutes_motor_sport_non_sky_sports =case when minutes_motor_sport_non_sky_sports =-1 then 999 when minutes_motor_sport_non_sky_sports =0 then 10 else abs(rank_minutes_motor_sport_non_sky_sports /3000)+1 end

,percentile_minutes_F1_sky_sports =case when minutes_F1_sky_sports =-1 then 999 when minutes_F1_sky_sports =0 then 10 else abs(rank_minutes_F1_sky_sports /3000)+1 end
,percentile_minutes_F1_non_sky_sports =case when minutes_F1_non_sky_sports =-1 then 999 when minutes_F1_non_sky_sports =0 then 10 else abs(rank_minutes_F1_non_sky_sports /3000)+1 end

,percentile_minutes_horse_racing_sky_sports =case when minutes_horse_racing_sky_sports =-1 then 999 when minutes_horse_racing_sky_sports =0 then 10 else abs(rank_minutes_horse_racing_sky_sports /3000)+1 end
,percentile_minutes_horse_racing_non_sky_sports =case when minutes_horse_racing_non_sky_sports =-1 then 999 when minutes_horse_racing_non_sky_sports =0 then 10 else abs(rank_minutes_horse_racing_non_sky_sports /3000)+1 end

,percentile_minutes_snooker_pool_sky_sports =case when minutes_snooker_pool_sky_sports =-1 then 999 when minutes_snooker_pool_sky_sports =0 then 10 else abs(rank_minutes_snooker_pool_sky_sports /3000)+1 end
,percentile_minutes_snooker_pool_non_sky_sports =case when minutes_snooker_pool_non_sky_sports =-1 then 999 when minutes_snooker_pool_non_sky_sports =0 then 10 else abs(rank_minutes_snooker_pool_non_sky_sports /3000)+1 end

,percentile_minutes_rugby_sky_sports =case when minutes_rugby_sky_sports =-1 then 999 when minutes_rugby_sky_sports =0 then 10 else abs(rank_minutes_rugby_sky_sports /3000)+1 end
,percentile_minutes_rugby_non_sky_sports =case when minutes_rugby_non_sky_sports =-1 then 999 when minutes_rugby_non_sky_sports =0 then 10 else abs(rank_minutes_rugby_non_sky_sports /3000)+1 end

,percentile_minutes_wrestling_sky_sports =case when minutes_wrestling_sky_sports =-1 then 999 when minutes_wrestling_sky_sports =0 then 10 else abs(rank_minutes_wrestling_sky_sports /3000)+1 end
,percentile_minutes_wrestling_non_sky_sports =case when minutes_wrestling_non_sky_sports =-1 then 999 when minutes_wrestling_non_sky_sports =0 then 10 else abs(rank_minutes_wrestling_non_sky_sports /3000)+1 end

,percentile_minutes_wwe =case when minutes_wwe =-1 then 999 when minutes_wwe =0 then 10 else abs(rank_minutes_wwe /3000)+1 end
,percentile_minutes_wwe_sky_sports =case when minutes_wwe_sky_sports =-1 then 999 when minutes_wwe_sky_sports =0 then 10 else abs(rank_minutes_wwe_sky_sports /3000)+1 end
,percentile_minutes_wwe_sbo =case when minutes_wwe_sbo =-1 then 999 when minutes_wwe_sbo =0 then 10 else abs(rank_minutes_wwe_sbo /3000)+1 end
,percentile_minutes_sky_1_or_2 =case when minutes_wwe_sky_1_or_2 =-1 then 999 when minutes_wwe_sky_1_or_2 =0 then 10 else abs(rank_minutes_wwe_sky_1_or_2 /3000)+1 end

,percentile_minutes_darts_sky_sports =case when minutes_darts_sky_sports =-1 then 999 when minutes_darts_sky_sports =0 then 10 else abs(rank_minutes_darts_sky_sports /3000)+1 end
,percentile_minutes_darts_non_sky_sports =case when minutes_darts_non_sky_sports =-1 then 999 when minutes_darts_non_sky_sports =0 then 10 else abs(rank_minutes_darts_non_sky_sports /3000)+1 end

,percentile_minutes_boxing_sky_sports =case when minutes_boxing_sky_sports =-1 then 999 when minutes_boxing_sky_sports =0 then 10 else abs(rank_minutes_boxing_sky_sports /3000)+1 end
,percentile_minutes_boxing_non_sky_sports =case when minutes_boxing_non_sky_sports =-1 then 999 when minutes_boxing_non_sky_sports =0 then 10 else abs(rank_minutes_boxing_non_sky_sports /3000)+1 end
