...
---WWE--
,sum(case when programme_sub_genre_type='WWE' and (viewing_duration>=180 or viewing_duration/cast(programme_instance_duration as real)>=0.6) then 1 else 0 end) as programmes_engaged_WWE
...
,percentile_minutes_wwe_sky_sports  
,percentile_minutes_wwe_sbo 
,percentile_minutes_sky_1_or_2 as percentile_minutes_wwe_sky_1_or_2 


,percentile_minutes_wrestling_sky_sports  as percentile_minutes_non_wwe_wrestling_sky_sports
,percentile_minutes_wrestling_non_sky_sports  as percentile_minutes_non_wwe_wrestling_non_sky_sports
...
,case when (minutes_wwe_sbo *account_weight)<0 then 0 else (minutes_wwe_sbo *account_weight) end  as minutes_wwe_sbo_total
,case when (minutes_wwe_sky_1_or_2 *account_weight)<0 then 0 else (minutes_wwe_sky_1_or_2 *account_weight) end  as minutes_wwe_sky_1_or_2_total
,case when (minutes_wrestling_sky_sports *account_weight)<0 then 0 else (minutes_wrestling_sky_sports *account_weight) end  as minutes_non_wwe_wrestling_sky_sports_total
,case when (minutes_wrestling_non_sky_sports *account_weight)<0 then 0 else (minutes_wrestling_non_sky_sports *account_weight) end  as minutes_non_wwe_wrestling_non_sky_sports_total
...
/*
select percentile_prog_3min_plus_sport 
,percentile_prog_engaged_sport 
,count(*)
from dbarnett.v223_Unbundling_pivot_activity_data
group by percentile_prog_3min_plus_sport 
,percentile_prog_engaged_sport 
*/
