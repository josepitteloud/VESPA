...
,minutes_snooker_pool_sky_sports =viewing_duration_Sky_Sports_snooker_pool/60*(365/days_with_viewing)
,minutes_snooker_pool_non_sky_sports =viewing_duration_non_Sky_Sports_or_SSN_snooker_pool/60*(365/days_with_viewing)

,minutes_rugby_sky_sports =viewing_duration_Sky_Sports_Rugby/60*(365/days_with_viewing)
,minutes_rugby_non_sky_sports =(viewing_duration_BT_Sport_rugby+
viewing_duration_ESPN_rugby+
viewing_duration_rugby_other_channels)
/60*(365/days_with_viewing)

,minutes_wrestling_sky_sports =viewing_duration_Sky_Sports_inc_SBO_wrestling/60*(365/days_with_viewing)
,minutes_wrestling_non_sky_sports =viewing_duration_non_Sky_Sports_or_SBO_wrestling/60*(365/days_with_viewing)

,minutes_darts_sky_sports =viewing_duration_Sky_Sports_Darts/60*(365/days_with_viewing)
,minutes_darts_non_sky_sports =viewing_duration_non_Sky_Sports_Darts/60*(365/days_with_viewing)
