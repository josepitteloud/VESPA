...
alter table dbarnett.v223_Unbundling_pivot_activity_data add annualised_programmes_3min_plus_pay_sport real;

update dbarnett.v223_Unbundling_pivot_activity_data
set annualised_programmes_3min_plus_pay_sport= annualised_programmes_3min_plus_sport_sky_sports_total+annualised_programmes_3min_plus_sport_espn_total
from dbarnett.v223_Unbundling_pivot_activity_data as a
;

alter table dbarnett.v223_Unbundling_pivot_activity_data add annualised_programmes_engaged_pay_sport real;

update dbarnett.v223_Unbundling_pivot_activity_data
set annualised_programmes_engaged_pay_sport= annualised_programmes_engaged_sport_sky_sports_total+annualised_programmes_engaged_sport_espn_total
from dbarnett.v223_Unbundling_pivot_activity_data as a
;
commit;
...
,rank() over (  ORDER BY  annualised_programmes_3min_plus_pay_sport desc) as rank_minutes_sport
