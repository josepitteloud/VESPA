...
--select * from shaha.F_Fixtures_EPG;
--select * from dbarnett.F_Fixtures_EPG;

--select * from dbarnett.F_Daily_CL_Pick order by fixtures_date;
commit;
...
--select count(*) from dbarnett.v223_all_sports_programmes_viewed_sample where programme_sub_genre_type = 'Champions League'

grant all on dbarnett.v223_all_sports_programmes_viewed_sample to public;
...
--select Phase_2_percentile_3mins_plus_pay_sport from dbarnett.v223_Unbundling_pivot_activity_data
...
----Add on Package details as at start April
--drop table #dtv_package;
SELECT          account_number
,max(current_short_description) as package_code
                INTO            #dtv_package
FROM            sk_prod.cust_subs_hist
WHERE           subscription_sub_type  IN ('DTV Primary Viewing')
AND             effective_from_dt <= '2013-03-31'
AND             effective_to_dt    >  '2013-03-31'
...
SELECT          account_number
                INTO            #espn
FROM            sk_prod.cust_subs_hist
WHERE           subscription_sub_type  IN ('ESPN') 
AND             effective_from_dt <= '2013-03-31'
AND             effective_to_dt    >  '2013-03-31'
and status_code in ('AC','AB','PC')
...
alter table dbarnett.v223_Unbundling_pivot_activity_data add sky_sports_apr_2013 tinyint;
alter table dbarnett.v223_Unbundling_pivot_activity_data add espn_apr_2013 tinyint;

update dbarnett.v223_Unbundling_pivot_activity_data
set sky_sports_apr_2013= case when c.prem_sports>0 then 1 else 0 end
from dbarnett.v223_Unbundling_pivot_activity_data as a
left outer join #dtv_package as b
on a.account_number = b.account_number
left outer join sk_prod.cust_entitlement_lookup as c
on b.package_code = c.short_description
;
update dbarnett.v223_Unbundling_pivot_activity_data
set espn_apr_2013= case when b.account_number is not null then 1 else 0 end
from dbarnett.v223_Unbundling_pivot_activity_data as a
...
---Add in Deciles/Percentiles for Total Pay Sport--

--alter table dbarnett.v223_Unbundling_pivot_activity_data delete annualised_programmes_3min_plus_pay_sport;
--alter table dbarnett.v223_Unbundling_pivot_activity_data delete annualised_programmes_engaged_pay_sport;

alter table dbarnett.v223_Unbundling_pivot_activity_data add annualised_programmes_3min_plus_pay_sport_total real;

update dbarnett.v223_Unbundling_pivot_activity_data
set annualised_programmes_3min_plus_pay_sport_total= annualised_programmes_3min_plus_sport_sky_sports_total+annualised_programmes_3min_plus_sport_espn_total
from dbarnett.v223_Unbundling_pivot_activity_data as a
;

alter table dbarnett.v223_Unbundling_pivot_activity_data add annualised_programmes_engaged_pay_sport_total real;

update dbarnett.v223_Unbundling_pivot_activity_data
set annualised_programmes_engaged_pay_sport_total= annualised_programmes_engaged_sport_sky_sports_total+annualised_programmes_engaged_sport_espn_total
from dbarnett.v223_Unbundling_pivot_activity_data as a
;
commit;
--Create Ranks for 3min and Engaged Progs

--select top 100 annualised_programmes_engaged_pay_sport from dbarnett.v223_Unbundling_pivot_activity_data

select account_number
,rank() over (  ORDER BY  annualised_programmes_3min_plus_pay_sport_total desc) as rank_prog_3min_plus_pay_sports
into #rank_pay_sports_3min_plus
from dbarnett.v223_Unbundling_pivot_activity_data
where annualised_programmes_3min_plus_pay_sport_total>0
;
commit;
--drop table #rank_pay_sports_engaged;
select account_number
,rank() over (  ORDER BY  annualised_programmes_engaged_pay_sport_total desc ,annualised_programmes_3min_plus_pay_sport_total desc ,minutes_sport_sky_sports_total desc) as rank_prog_engaged_pay_sports
into #rank_pay_sports_engaged
from dbarnett.v223_Unbundling_pivot_activity_data
where annualised_programmes_3min_plus_pay_sport_total>0
;
commit;
--select rank_prog_engaged_pay_sports , count(*) as records from #rank_pay_sports_engaged group by rank_prog_engaged_pay_sports order by records desc
/*
alter table dbarnett.v223_Unbundling_pivot_activity_data delete rank_engaged_pay_sports ;
alter table dbarnett.v223_Unbundling_pivot_activity_data delete rank_3min_plus_pay_sports ;
*/

alter table dbarnett.v223_Unbundling_pivot_activity_data add rank_prog_3min_plus_pay_sports integer;

update dbarnett.v223_Unbundling_pivot_activity_data
set rank_prog_3min_plus_pay_sports=b.rank_prog_3min_plus_pay_sports
from dbarnett.v223_Unbundling_pivot_activity_data as a
left outer join #rank_pay_sports_3min_plus as b
on a.account_number=b.account_number
;
--select max(rank_prog_engaged_pay_sports) from dbarnett.v223_Unbundling_pivot_activity_data
alter table dbarnett.v223_Unbundling_pivot_activity_data add rank_prog_engaged_pay_sports integer;

update dbarnett.v223_Unbundling_pivot_activity_data
set rank_prog_engaged_pay_sports=b.rank_prog_engaged_pay_sports
from dbarnett.v223_Unbundling_pivot_activity_data as a
left outer join #rank_pay_sports_engaged as b
on a.account_number=b.account_number
;


create variable @total_programmes_3min_plus_pay_sports integer;
set @total_programmes_3min_plus_pay_sports
=( select count(*) from #rank_pay_sports_3min_plus );

--select @total_programmes_engaged_pay_sports
create variable @total_programmes_engaged_pay_sports integer;
set @total_programmes_engaged_pay_sports
=( select count(*) from #rank_pay_sports_engaged );


alter table dbarnett.v223_Unbundling_pivot_activity_data  add phase_2_percentile_3min_plus_pay_sports integer;
alter table dbarnett.v223_Unbundling_pivot_activity_data add phase_2_decile_3min_plus_pay_sports integer;

update dbarnett.v223_Unbundling_pivot_activity_data
set phase_2_percentile_3min_plus_pay_sports = case when annualised_programmes_3min_plus_pay_sport_total=0 then 999 
when abs(rank_prog_3min_plus_pay_sports/(@total_programmes_3min_plus_pay_sports/100))+1 >100 then 100 
else abs(rank_prog_3min_plus_pay_sports/(@total_programmes_3min_plus_pay_sports/100))+1 end
,phase_2_decile_3min_plus_pay_sports = case when annualised_programmes_3min_plus_pay_sport_total=0 then 99 
when abs(rank_prog_3min_plus_pay_sports/(@total_programmes_3min_plus_pay_sports/10))+1 >10 then 10 
else 
abs(rank_prog_3min_plus_pay_sports/(@total_programmes_3min_plus_pay_sports/10))+1 end
;
commit;



alter table dbarnett.v223_Unbundling_pivot_activity_data  add phase_2_percentile_engaged_pay_sports integer;
alter table dbarnett.v223_Unbundling_pivot_activity_data  add phase_2_decile_engaged_pay_sports integer;

update dbarnett.v223_Unbundling_pivot_activity_data
set phase_2_percentile_engaged_pay_sports = case when annualised_programmes_3min_plus_pay_sport_total=0 then 999 
when abs(rank_prog_engaged_pay_sports/(@total_programmes_engaged_pay_sports/100))+1 >100 then 100 
else abs(rank_prog_engaged_pay_sports/(@total_programmes_engaged_pay_sports/100))+1 end
,phase_2_decile_engaged_pay_sports = case when annualised_programmes_3min_plus_pay_sport_total=0 then 99 
when abs(rank_prog_engaged_pay_sports/(@total_programmes_engaged_pay_sports/10))+1 >10 then 10 
else 
abs(rank_prog_engaged_pay_sports/(@total_programmes_engaged_pay_sports/10))+1 end
;
commit;

--select phase_2_decile_engaged_pay_sports  ,count(*),sum(account_weight) from dbarnett.v223_Unbundling_pivot_activity_data group by phase_2_decile_engaged_pay_sports  order by phase_2_decile_engaged_pay_sports 
--select annualised_programmes_3min_plus_pay_sport_total,count(*) from dbarnett.v223_Unbundling_pivot_activity_data group by annualised_programmes_3min_plus_pay_sport_total order by phase_2_decile_engaged_pay_sports


--select phase_2_decile_3min_plus_pay_sports  ,count(*) from dbarnett.v223_Unbundling_pivot_activity_data group by phase_2_decile_3min_plus_pay_sports order by phase_2_decile_3min_plus_pay_sports
...
--dbarnett.v223_Unbundling_pivot_activity_data

--select phase_2_decile_engaged_pay_sports  ,count(*) from dbarnett.v223_Unbundling_pivot_activity_data group by phase_2_decile_engaged_pay_sports  order by phase_2_decile_engaged_pay_sports 
/*
select account_number
,sum(case when channel_name_inc_hd_staggercast_channel_families in ('Sky Sports Channels' ,'Sky Sports News','Sky 3D','BT Sport','ESPN')
 then  viewing_duration else 0 end) as viewing_duration_paid_sports
,sum(case when channel_name_inc_hd_staggercast_channel_families in  ('Sky Sports Channels' ,'Sky Sports News','Sky 3D','BT Sport','ESPN')
 and  viewing_duration>=180 then 1 else 0 end) as programmes_3min_plus_paid_sports
,sum(case when channel_name_inc_hd_staggercast_channel_families in ('Sky Sports Channels' ,'Sky Sports News','Sky 3D','BT Sport','ESPN')
 and  (viewing_duration>=3600 or viewing_duration/cast(programme_instance_duration as real)>=0.6) then 1 else 0 end) as programmes_endgaged_paid_sports
into #pad_sports_by_account
...
--select distinct subscription_sub_type from sk_prod.cust_subs_hist where effective_to_dt = '9999-09-09'
--select top 100 * from sk_prod.cust_subs_hist WHERE           subscription_sub_type  IN ('DTV Primary Viewing')
...
--select sum(annualised_programmes_engaged_heineken_cup_rugby_total),sum(account_weight) from dbarnett.v223_Unbundling_pivot_activity_datadbarnett.v223_Unbundling_pivot_activity_data
...
select phase_2_decile_3min_plus_football_premier_league_sky_sports , count(*),sum(account_weight) from dbarnett.v223_Unbundling_pivot_activity_data group by phase_2_decile_3min_plus_football_premier_league_sky_sports order by phase_2_decile_3min_plus_football_premier_league_sky_sports
...
commit;
select phase_2_decile_3min_plus_football_premier_league_sky_sports , count(*),sum(account_weight) from v223_unbundling_viewing_summary_by_account group by phase_2_decile_3min_plus_football_premier_league_sky_sports order by phase_2_decile_3min_plus_football_premier_league_sky_sports

update dbarnett.v223_Unbundling_pivot_activity_data
set  phase_2_decile_3min_plus_football_premier_league_sky_sports=b.phase_2_decile_3min_plus_football_premier_league_sky_sports
from dbarnett.v223_Unbundling_pivot_activity_data as a
left outer join v223_unbundling_viewing_summary_by_account as b
on a.account_number = b.account_number
commit;
...
--select top 500 * from shaha.F_DATA_CUBE
...
where capping_end_date_time_utc >instance_start_date_time_utc
and panel_id = 12 and genre_description='Sports' and 
programme_name='UCL Man United v Real Madrid'
group by programme_name
order by viewing_duration desc
;
select top 100 *  from  sk_prod.vespa_dp_prog_viewed_201303
...
;
commit;
select * from dbarnett.v223_sports_epg_lookup_aug_12_jul_13 where dk_programme_instance_dim=703800805
select * from dbarnett.v223_sports_epg_lookup_aug_12_jul_13 where cast(broadcast_start_date_time_local as date) = '2013-04-24'
and channel_name = 'Sky Sports 2'


select * from dbarnett.v223_all_sports_programmes_viewed where dk_programme_instance_dim=703800805
...
,sum( case  when capping_end_date_time_utc<instance_end_date_time_utc 
            then datediff(second,instance_start_date_time_utc,capping_end_date_time_utc)
            else datediff(second,instance_start_date_time_utc,instance_end_date_time_utc) end) as viewing_duration from sk_prod.vespa_dp_prog_viewed_201303
where capping_end_date_time_utc >instance_start_date_time_utc
and panel_id = 12 and dk_programme_instance_dim=703800805
group by account_number
,genre_description
,sub_genre_description
;

select  * from sk_prod.Vespa_programme_schedule where dk_programme_instance_dim=705827234;
commit;
*/
