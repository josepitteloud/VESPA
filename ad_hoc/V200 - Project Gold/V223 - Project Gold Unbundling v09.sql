...
when cast(espn_bt_premier_league_days as real)/total_espn_bt_premier_league_days<0.5 then -1 
else (viewing_duration_BT_Sport_premier_league+
viewing_duration_ESPN_premier_league)/60*(total_espn_bt_premier_league_days/cast(espn_bt_premier_league_days as real)) end
...
,minutes_football_champions_league_non_sky_sports =case when non_sky_champions_league_days=0 then -1 
when cast(non_sky_champions_league_days as real)/total_non_sky_champions_league_days<0.5 then -1 
else viewing_duration_non_sky_Sports_champions_league/60*(total_non_sky_champions_league_days
/cast(non_sky_champions_league_days as real)) end
...
else viewing_duration_espn_bt_Sports_fa_cup/60*(total_espn_bt_fa_cup_days
/cast(espn_bt_fa_cup_days as real)) end

,minutes_football_fa_cup_Other_Channels =case when non_sky_fa_cup_days=0 then -1 
when cast(non_sky_fa_cup_days as real)/total_non_sky_fa_cup_days<0.5 then -1 
else viewing_duration_non_sky_Sports_fa_cup/60*(total_non_sky_fa_cup_days
/cast(non_sky_fa_cup_days as real)) end
...
,minutes_football_world_cup_qualifier_non_sky_sports =case when non_sky_World_Cup_Qualifiers_days=0 then -1 
when cast(non_sky_World_Cup_Qualifiers_days as real)/other_World_Cup_Qualifiers_days<0.5 then -1 
else viewing_duration_non_sky_Sports_World_Cup_Qualifiers/60*(other_World_Cup_Qualifiers_days/cast(non_sky_World_Cup_Qualifiers_days as real)) end
...
,minutes_football_international_friendly_non_sky_sports =case when non_sky_international_friendlies_days=0 then -1 
when cast(non_sky_international_friendlies_days as real)/other_international_friendlies_days<0.5 then -1 
else viewing_duration_non_sky_Sports_international_friendlies/60*(other_international_friendlies_days/cast(non_sky_international_friendlies_days as real)) end
...
,minutes_cricket_non_ashes_sky_sports =viewing_duration_Sky_Sports_cricket_exc_ashes/60*(365/days_with_viewing)
,minutes_cricket_non_ashes_non_sky_sports =
viewing_duration_cricket_exc_ashes_non_Sky_Sports_or_SSN/60*(365/days_with_viewing)

,minutes_golf_sky_sports =
(viewing_duration_Sky_Sports_golf_other+
viewing_duration_Sky_Sports_golf_ryder_cup+
viewing_duration_Sky_Sports_golf_major)/60*(365/days_with_viewing)

,minutes_golf_non_sky_sports =(viewing_duration_non_sky_sports_golf_other+
viewing_duration_non_sky_sports_golf_ryder_cup+
viewing_duration_non_sky_sports_golf_major)/60*(365/days_with_viewing)

,minutes_tennis_sky_sports =viewing_duration_Sky_Sports_tennis/60*(365/days_with_viewing)

,minutes_tennis_non_sky_sports =
(viewing_duration_non_Sky_Sports_or_SSN_tennis_exc_wimbledon+
viewing_duration_non_Sky_Sports_or_SSN_wimbledon)/60*(365/days_with_viewing)

,minutes_motor_sport_sky_sports =viewing_duration_Sky_Sports_motor_sport_exc_f1/60*(365/days_with_viewing)
,minutes_motor_sport_non_sky_sports =viewing_duration_non_Sky_Sports_or_SSN_motor_sport_exc_f1/60*(365/days_with_viewing)
...
,minutes_horse_racing_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)
,minutes_horse_racing_non_sky_sports =viewing_duration_non_Sky_Sports_or_SSN_horse_racing/60*(365/days_with_viewing)

,minutes_snooker_pool_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)
,minutes_snooker_pool_non_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)

,minutes_rugby_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)
,minutes_rugby_non_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)

,minutes_wrestling_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)
,minutes_wrestling_non_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)

,minutes_darts_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)
,minutes_darts_non_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)

,minutes_boxing_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)
,minutes_boxing_non_sky_sports =viewing_duration_Sky_Sports_horse_racing/60*(365/days_with_viewing)
...
,cast(sky_premier_league_days as real)/total_sky_premier_league_days
,case when sky_premier_league_days=0 then -1 
when cast(sky_premier_league_days as real)/total_sky_premier_league_days<0.5 then -1 
else viewing_duration_Sky_Sports_premier_league/60*(total_sky_premier_league_days/cast(sky_premier_league_days as real)) end
as group_detail
from v223_unbundling_viewing_summary_by_account as a
...
select top 10 * from v223_days_viewing_genre_types_by_account
*/