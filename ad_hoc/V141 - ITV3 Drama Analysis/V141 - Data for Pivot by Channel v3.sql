...
,min(case when a.channel_name_inc_staggercast = 'Zee Café' and (channel_sov>=(average_share_of_viewing*1.5) or total_duration>=average_duration*1.5) then '01: High Viewing'  when a.channel_name_inc_staggercast = 'Zee Café' and total_duration>0 then '02: Low Viewing' else '03: No Viewing' end) as Zee_Cafe_Viewing
