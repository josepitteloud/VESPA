...
IF object_id('scaling_get_weekly_sample_nonlethal') IS NOT NULL
    DROP PROCEDURE scaling_get_weekly_sample_nonlethal;
commit;
go
    
CREATE PROCEDURE scaling_get_weekly_sample_nonlethal
AS
BEGIN

insert into crash_tracking (flag_name) values ('Start: nonlethal UNCLEANSED test')
...
insert into crash_tracking (flag_name) values ('Complete: nonlethal UNCLEANSED test')
