...
select distinct account_number
     ...
     where (event_start_date_time_utc >= @date_from and event_start_date_time_utc < @date_to) --- Date Change
       and (Panel_id = 12 or Panel_id = 11)
       and account_number is not null
       and subscriber_id is not null
commit
...
select distinct
    ...
    and csh.effective_from_dt <= @date_thursday -- Thursday
    and csh.effective_to_dt > @date_thursday -- Thursday
commit
