...
begin
     ...
     FROM ''/SKP2x2f1/prod/sky/olive/data/share/clarityq/export/Jon/slots/B' || replace(@dt,'-','') || '.CET.dat_dis.csv''
     QUOTES OFF
     ESCAPES OFF
     NOTIFY 1000
     delimited by ''¿''')
...
begin
     ...
     FROM ''/SKP2x2f1/prod/sky/olive/data/share/clarityq/export/Jon/slots/B' || replace(@dt,'-','') || '.PSP.dat_dis.csv''
     QUOTES OFF
     ESCAPES OFF
     NOTIFY 1000
     delimited by ''¿''')
...
LOAD TABLE data_raw(dta'\n')
     FROM '/SKP2x2f1/prod/sky/olive/data/share/clarityq/export/Jon/slots/B20120529.PS2.csv'
     QUOTES OFF
     ESCAPES OFF
     NOTIFY 1000;

LOAD TABLE data_raw(dta'\n')
     FROM '/SKP2x2f1/prod/sky/olive/data/share/clarityq/export/Jon/slots/B20120529.CE1.csv'
     QUOTES OFF
     ESCAPES OFF
     NOTIFY 1000;

LOAD TABLE data_raw(dta'\n')
     FROM '/SKP2x2f1/prod/sky/olive/data/share/clarityq/export/Jon/slots/B20120529.CE3.csv'
     QUOTES OFF
     ESCAPES OFF
     NOTIFY 1000;
...
begin
     ...
     FROM ''/SKP2x2f1/prod/sky/olive/data/share/clarityq/export/Jon/slots/BSS-PROMO-SPONS_' || replace(@dt,'-','') || '.dat_dis.csv'' --I deleted the time part of the file name
     QUOTES OFF
     ESCAPES OFF
     NOTIFY 1000
     delimited by ''¿'''
...
LOAD TABLE landmark_data_raw(dta'\n')
  FROM '/staging2/LANDMARK_DUMP.dat'
  QUOTES OFF
  ESCAPES OFF;
...
begin
     ...
     FROM ''/SKP2x2f1/prod/sky/olive/data/share/clarityq/export/Jon/slots/aw' || replace(@dt,'-','') || '.sky.csv'' --these are the weekly files containing all data for week commencing
     QUOTES OFF
     ESCAPES OFF
     NOTIFY 1000
     ')
...
LOAD TABLE  data_raw(     dta'\n')
FROM '/SKP2x2f1/prod/sky/olive/data/share/clarityq/export/Jon/slots/ma20120226.sky.csv'
QUOTES OFF
ESCAPES OFF
NOTIFY 1000
;
