...
/******************************************************************************
**
** Project Vespa: Data_Quality_Vespa_Basic_Checks_UAT
**
...
if object_id('Data_Quality_Vespa_Basic_Checks_uat') is not null drop procedure Data_Quality_Vespa_Basic_Checks_uat
commit

go

create procedure Data_Quality_Vespa_Basic_Checks_UAT
...
execute dq_basic_checks_uat @table_name,@column_name,@creator,@dq_check_type,@dq_run_id,@target_date,@CP2_build_ID
