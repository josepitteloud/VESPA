...
/******************************************************************************
**
** Project Vespa: Data Quality Data Processing UAT
**
...
if object_id('data_quality_data_processing_date_uat') is not null drop procedure data_quality_data_processing_date_uat
commit

go

create procedure data_quality_data_processing_date_uat
@run_type varchar(20)
...
from sk_uat.vespa_dp_prog_viewed_201304 vdpvc
...
where viq_date.broadcast_day_date = @analysis_date_current
...
execute Data_Quality_Vespa_Basic_Checks_uat 'VESPA_DATA_QUALITY',@analysis_date_current,@CP2_build_ID
...
--execute Data_Quality_Vespa_STB_Checks_UAT @analysis_date_current, @CP2_build_ID     

----now lets do some Vespa specific metrics 
execute Data_Quality_Vespa_Metric_Run_UAT @analysis_date_current, @CP2_build_ID     
