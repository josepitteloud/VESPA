...
EXECUTE logger_add_event @RunID , 3,' Adsmart Analytical Metrics Process Start for Date : '||cast (@load_date as varchar(20))
...
EXECUTE logger_add_event @RunID , 3,'Adsmart Analytical Metrics Process End for Date : '||cast (@load_date as varchar(20))
