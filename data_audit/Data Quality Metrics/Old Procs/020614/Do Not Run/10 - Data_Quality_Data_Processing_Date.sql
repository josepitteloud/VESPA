...
if object_id('data_quality_data_processing_date') is not null drop procedure data_quality_data_processing_date
commit
...
grant execute on data_quality_data_processing_date to vespa_group_low_security, sk_prodreg