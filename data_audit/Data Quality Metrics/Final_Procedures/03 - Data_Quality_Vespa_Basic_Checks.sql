...
/******************************************************************************
**
** Project Vespa: Data_Quality_Vespa_Basic_Checks
**
...
if object_id('Data_Quality_Vespa_Basic_Checks') is not null drop procedure Data_Quality_Vespa_Basic_Checks
commit

go

create procedure Data_Quality_Vespa_Basic_Checks
...
EXECUTE logger_add_event @CP2_build_ID , 3,'Data Quality Basic Checks Start for Date '||cast (@target_date as varchar(20))
...
where UPPER(metric_short_name) like 'VDQ%'
...
EXECUTE logger_add_event @CP2_build_ID , 3,'Data Quality Basic Checks End for Date '||cast (@target_date as varchar(20))
...
grant execute on Data_Quality_Vespa_Basic_Checks to vespa_group_low_security, sk_prodreg, buxceys, kinnairt