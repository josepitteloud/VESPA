...
/******************************************************************************
**
** Project Vespa: Data_Quality_Adsmart_Metric_Checks
**
...
if object_id('Data_Quality_Adsmart_Metric_Run') is not null drop procedure Data_Quality_Adsmart_Metric_Run
commit

go

create procedure Data_Quality_Adsmart_Metric_Run
...
EXECUTE logger_add_event @RunID , 3,' Adsmart Analytical Metrics Process Start for Date : '||cast (@analysis_date_current as varchar(20))
...
into #tmp_dqvm
 ...
 where upper(metric_short_name) like 'MTC%ADSMART%'
and current_flag = 1
...
EXECUTE logger_add_event @RunID , 3,'Adsmart Analytical Metrics Process End for Date : '||cast (@analysis_date_current as varchar(20))

end

go

grant execute on Data_Quality_Adsmart_Metric_Run to vespa_group_low_security, sk_prodreg, buxceys, kinnairt