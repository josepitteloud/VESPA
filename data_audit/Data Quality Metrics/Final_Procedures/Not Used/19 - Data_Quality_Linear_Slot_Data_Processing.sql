...
left outer join
sk_prod.spot_position spos
on
slot_inst.spot_position_key = spos.spot_position_key
left outer join
sk_prod.sales_house sales
on
...
from sk_prod.slot_instance slot_inst
left outer join sk_prod.slot slot
on
...
grant execute on data_quality_slot_day_processing to vespa_group_low_security, sk_prodreg, sawkinss, kinnairt
