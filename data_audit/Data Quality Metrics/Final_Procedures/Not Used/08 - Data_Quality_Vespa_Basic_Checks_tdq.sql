...
/******************************************************************************
**
** Project Vespa: Data_Quality_Vespa_Basic_Checks_tdq
**
...
if object_id('Data_Quality_Vespa_Basic_Checks_tdq') is not null drop procedure Data_Quality_Vespa_Basic_Checks_tdq
commit

go

create procedure Data_Quality_Vespa_Basic_Checks_tdq
...
EXECUTE logger_add_event @RunID , 3,'Data Quality Basic Checks TDQ Start for Date '||cast (@target_date as varchar(20))
...
EXECUTE logger_add_event @RunID , 3,'Data Quality Basic Checks TDQ End for Date '||cast (@target_date as varchar(20))
...
grant execute on Data_Quality_Vespa_Basic_Checks_tdq to vespa_group_low_security, sk_prodreg, sawkinss,kinnairt 