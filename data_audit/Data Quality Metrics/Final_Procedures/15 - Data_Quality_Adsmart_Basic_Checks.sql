...
create procedure Data_Quality_Adsmart_Basic_Checks
    @run_type varchar(40) = 'ADSMART_DATA_QUALITY'
...
where UPPER(metric_short_name) like 'ADSM%'
...
grant execute on Data_Quality_Adsmart_Basic_Checks to vespa_group_low_security, sk_prodreg, buxceys, kinnairt