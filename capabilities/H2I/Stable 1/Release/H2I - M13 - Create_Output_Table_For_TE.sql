...
as begin
		...
		IF @fresh_start = 1  AND EXISTS(SELECT tname FROM syscatalog WHERE creator = '${SQLFILE_ARG001}' and tabletype = 'TABLE' and upper(tname) = UPPER ('V289_M13_individual_viewing_working_table'))  
		DROP TABLE ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table
		
		IF NOT EXISTS(SELECT tname FROM syscatalog WHERE creator = '${SQLFILE_ARG001}' and tabletype = 'TABLE' and upper(tname) = UPPER ('V289_M13_individual_viewing_working_table'))  
		BEGIN 
			create table ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table (
			...
			create hg index hg1 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(event_id)     
			create hg index hg2 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(overlap_batch)
			create hg index hg3 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(account_number)
			create hg index hg4 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(subscriber_id) 
			create hg index hg5 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(service_key)  
			create hg index hg6 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(parent_service_key)   
			create hg index hg7 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(event_start_date_time)
			create hg index hg8 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(event_end_date_time)  
			create hg index hg9 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(barb_min_start_date_time_utc) 
			create hg index hg10 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(barb_min_end_date_time_utc)  
			create hg index hg11 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(pk_viewing_prog_instance_fact)       
			create hg index hg12 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(event_start_date_BARB)       
			create hg index hg13 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(barb_min_start_date) 
			create lf index lf1 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(HD_flag)      
			create lf index lf2 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table(live_recorded)
			commit -- ; --(^_^)
		END 
		...
		DELETE ${SQLFILE_ARG001}.V289_M13_individual_viewing_working_table 
