...
-- BARB_PVF06_Viewing_Record_Panel_Members
        ...
        begin
                ...
                create hg index ind_household_number on ${SQLFILE_ARG001}.BARB_PVF06_Viewing_Record_Panel_Members(household_number)
                create hg index ind_db1 on ${SQLFILE_ARG001}.BARB_PVF06_Viewing_Record_Panel_Members(db1_station_code)
                create hg index ind_start on ${SQLFILE_ARG001}.BARB_PVF06_Viewing_Record_Panel_Members(Start_time_of_session)
                create hg index ind_end on ${SQLFILE_ARG001}.BARB_PVF06_Viewing_Record_Panel_Members(End_time_of_session)
                create hg index ind_date on ${SQLFILE_ARG001}.BARB_PVF06_Viewing_Record_Panel_Members(Barb_date_of_activity)
...
-- BARB_PVF04_Individual_Member_Details
        ...
        begin
                ...
                commit
                create hg index ind_hhd         on ${SQLFILE_ARG001}.BARB_PVF04_Individual_Member_Details(Household_number)
                create lf index ind_person      on ${SQLFILE_ARG001}.BARB_PVF04_Individual_Member_Details(person_number)
                create lf index ind_create      on ${SQLFILE_ARG001}.BARB_PVF04_Individual_Member_Details(file_creation_date)
...
---- V289_PIV_Grouped_Segments_desc
 ...
 ------------------------------------------------------------------
            ...
            (8,8,'Terrestrial non-commercial','prime','Unknown')
                        ...
                        COMMIT
                CREATE LF INDEX id1 ON ${SQLFILE_ARG001}.V289_PIV_Grouped_Segments_desc(segment_id)
                CREATE LF INDEX id2 ON ${SQLFILE_ARG001}.V289_PIV_Grouped_Segments_desc(channel_pack)
                CREATE LF INDEX id3 ON ${SQLFILE_ARG001}.V289_PIV_Grouped_Segments_desc(daypart)
                CREATE LF INDEX id4 ON ${SQLFILE_ARG001}.V289_PIV_Grouped_Segments_desc(Genre)
    ...
    , Updated_By            VARCHAR(30) DEFAULT '${SQLFILE_ARG001}'     not null)
        ...
        create hg index hg1 on ${SQLFILE_ARG001}.V289_M08_SKY_HH_composition (account_number)
        create hg index hg2 on ${SQLFILE_ARG001}.V289_M08_SKY_HH_composition (cb_key_household)
        create hg index hg3 on ${SQLFILE_ARG001}.V289_M08_SKY_HH_composition (exp_cb_key_db_person)
        create hg index hg4 on ${SQLFILE_ARG001}.V289_M08_SKY_HH_composition (cb_address_line_1)
        create hg index hg5 on ${SQLFILE_ARG001}.V289_M08_SKY_HH_composition (row_id)
        commit
    ...
    , Updated_By            VARCHAR(30) DEFAULT '${SQLFILE_ARG001}'     NOT NULL)
        ...
        CREATE HG INDEX idac ON ${SQLFILE_ARG001}.V289_M08_SKY_HH_view(account_number)
        CREATE HG INDEX idal ON ${SQLFILE_ARG001}.V289_M08_SKY_HH_view(cb_address_line_1)
        CREATE HG INDEX idhh ON ${SQLFILE_ARG001}.V289_M08_SKY_HH_view(cb_key_household)
        CREATE HG INDEX idcc ON ${SQLFILE_ARG001}.V289_M08_SKY_HH_view(Children_count)
    COMMIT
...
-- v289_genderage_lookup
        ...
        begin
                ...
                create unique index key1 on ${SQLFILE_ARG001}.v289_genderage_lookup(the_id)
                commit
...
-- v289_M06_dp_raw_data
        ...
        begin
                ...
                create unique index key1 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(pk_viewing_prog_instance_fact)
                create hg index hg0 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(dth_event_id)
                create hg index hg1 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(dk_event_start_datehour_dim)
                create hg index hg2 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(dk_broadcast_start_datehour_dim)
                create hg index hg3 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(dk_instance_start_datehour_dim)
                create hg index hg5 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(service_key)
                create hg index hg6 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(account_number)
                create hg index hg7 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(subscriber_id)
                create hg index hg8 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(programme_name)
                create hg index hg9 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(dk_barb_min_start_datehour_dim)
                create hg index hg10 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(dk_barb_min_start_time_dim)
                create hg index hg11 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(dk_barb_min_end_datehour_dim)
                create hg index hg12 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(dk_barb_min_end_time_dim)
                create hg index hg13 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(event_end_date_time_utc)
                create hg index hg14 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(event_start_date_time_utc)
                create lf index lf1 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(genre_description)
                create lf index lf2 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(live_recorded)
                create dttm index dttm1 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(barb_min_start_date_time_utc)
                create dttm index dttm2 on ${SQLFILE_ARG001}.v289_M06_dp_raw_data(barb_min_end_date_time_utc)
...
-- v289_M17_vod_raw_data
        ...
        begin
                ...
                create table ${SQLFILE_ARG001}.v289_M17_vod_raw_data(
                        ...
                        ,provider_id_number                     bigint							null    default -1
                ...
                create unique index key1 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(pk_viewing_prog_instance_fact)
                create hg index hg0 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(dth_event_id)
                create hg index hg1 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(dk_event_start_datehour_dim)
                create hg index hg2 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(dk_broadcast_start_datehour_dim)
                create hg index hg3 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(dk_instance_start_datehour_dim)
                create hg index hg5 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(service_key)
                create hg index hg6 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(account_number)
                create hg index hg7 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(subscriber_id)
                create hg index hg8 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(programme_name)
                create lf index lf1 on ${SQLFILE_ARG001}.v289_M17_vod_raw_data(genre_description)
                commit
...
-- V289_M07_dp_data
        ...
        begin
                ...
                create hg index hg1     on ${SQLFILE_ARG001}.v289_m07_dp_data(account_number)
                create hg index hg2     on ${SQLFILE_ARG001}.v289_m07_dp_data(subscriber_id)
                create hg index hg3     on ${SQLFILE_ARG001}.v289_m07_dp_data(event_start_dim)
                create hg index hg4     on ${SQLFILE_ARG001}.v289_m07_dp_data(event_end_dim)
                create hg index hg5 on ${SQLFILE_ARG001}.v289_m07_dp_data(segment_id)
                create hg index hg6 on ${SQLFILE_ARG001}.v289_m07_dp_data(overlap_batch)
                create hg index hg7 on ${SQLFILE_ARG001}.v289_m07_dp_data(event_id)
                create dttm index dttim1 on ${SQLFILE_ARG001}.v289_m07_dp_data(event_start_utc)
                create dttm index dttim2 on ${SQLFILE_ARG001}.v289_m07_dp_data(event_end_utc)
                create dttm index dttim3 on ${SQLFILE_ARG001}.v289_m07_dp_data(chunk_start)
                create dttm index dttim4 on ${SQLFILE_ARG001}.v289_m07_dp_data(chunk_end)
                commit
...
-- SC3I_Variables_lookup_v1_1
        ...
        begin
                ...
                create lf index ind1 on ${SQLFILE_ARG001}.SC3I_Variables_lookup_v1_1(id)
                create lf index ind2 on ${SQLFILE_ARG001}.SC3I_Variables_lookup_v1_1(scaling_variable)
                commit
...
-- SC3I_Sky_base_segment_snapshots
        ...
        begin
                ...
                create hg index ind1 on ${SQLFILE_ARG001}.SC3I_Sky_base_segment_snapshots(account_number)
                create lf index ind2 on ${SQLFILE_ARG001}.SC3I_Sky_base_segment_snapshots(profiling_date)
                create lf index ind3 on ${SQLFILE_ARG001}.SC3I_Sky_base_segment_snapshots(HH_person_number)
                create hg index ind4 on ${SQLFILE_ARG001}.SC3I_Sky_base_segment_snapshots(population_scaling_segment_id)
                create hg index ind5 on ${SQLFILE_ARG001}.SC3I_Sky_base_segment_snapshots(vespa_scaling_segment_id)
                commit
...
-- SC3I_Todays_panel_members
        ...
        begin
                ...
                create hg index ind1 on ${SQLFILE_ARG001}.SC3I_Todays_panel_members(account_number)
                create lf index ind2 on ${SQLFILE_ARG001}.SC3I_Todays_panel_members(HH_person_number)
                create hg index ind3 on ${SQLFILE_ARG001}.SC3I_Todays_panel_members(scaling_segment_id)
                commit
...
-- SC3I_weighting_working_table
        ...
        begin
                ...
                CREATE HG INDEX indx_un on ${SQLFILE_ARG001}.SC3I_weighting_working_table(sky_base_universe)
                commit
...
-- SC3I_category_working_table
        ...
        begin
                ...
                create hg index indx_universe on ${SQLFILE_ARG001}.SC3I_category_working_table(sky_base_universe)
                create hg index indx_profile on ${SQLFILE_ARG001}.SC3I_category_working_table(profile)
                create hg index indx_value on ${SQLFILE_ARG001}.SC3I_category_working_table(value)
...
-- SC3I_category_subtotals
        ...
        begin
                ...
                create index indx_date on ${SQLFILE_ARG001}.SC3I_category_subtotals(scaling_date)
                create hg index indx_universe on ${SQLFILE_ARG001}.SC3I_category_subtotals(sky_base_universe)
                create hg index indx_profile on ${SQLFILE_ARG001}.SC3I_category_subtotals(profile)
                commit
...
-- SC3I_metrics
        ...
        begin
                ...
                create index indx_date on ${SQLFILE_ARG001}.SC3I_metrics(scaling_date)
                commit
...
-- SC3I_non_convergences
        ...
        begin
                ...
                create index indx_date on ${SQLFILE_ARG001}.SC3I_non_convergences(scaling_date)
                commit
...
-- SC3I_Weightings
        ...
        begin
                ...
                create date index idx1 on ${SQLFILE_ARG001}.SC3I_Weightings(scaling_day)
                create hg index idx2 on ${SQLFILE_ARG001}.SC3I_Weightings(scaling_segment_ID)
...
-- SC3I_Intervals
        ...
        begin
                ...
                create index for_joining on ${SQLFILE_ARG001}.SC3I_Intervals (scaling_segment_ID, reporting_starts)
                create hg index idx1 on ${SQLFILE_ARG001}.SC3I_Intervals (account_number)
                create hg index idx2 on ${SQLFILE_ARG001}.SC3I_Intervals (HH_person_number)
                commit
...
-- V289_M11_04_VESPA_INDIVIDUAL_WEIGHTING
        ...
        begin
                ...
                create dttm index for_loading on ${SQLFILE_ARG001}.V289_M11_04_VESPA_INDIVIDUAL_WEIGHTING (build_date)
                create hg index idx1 on ${SQLFILE_ARG001}.V289_M11_04_VESPA_INDIVIDUAL_WEIGHTING (account_number)
                create date index idx3 on ${SQLFILE_ARG001}.V289_M11_04_VESPA_INDIVIDUAL_WEIGHTING (scaling_date)
                create hg index idx4 on ${SQLFILE_ARG001}.V289_M11_04_VESPA_INDIVIDUAL_WEIGHTING (HH_person_number)
                commit
...
-- V289_M11_04_Barb_weighted_population
        ...
        begin
                ...
                create lf index ind1 on ${SQLFILE_ARG001}.V289_M11_04_Barb_weighted_population(ageband)
                create lf index ind2 on ${SQLFILE_ARG001}.V289_M11_04_Barb_weighted_population(gender)
                create lf index ind3 on ${SQLFILE_ARG001}.V289_M11_04_Barb_weighted_population(viewed_tv)
                create lf index ind4 on ${SQLFILE_ARG001}.V289_M11_04_Barb_weighted_population(head_of_hhd)
                create lf index ind5 on ${SQLFILE_ARG001}.V289_M11_04_Barb_weighted_population(hh_size)
...
-- SC3_Weightings
        ...
        begin
                ...
                create date index idx1 on ${SQLFILE_ARG001}.SC3_Weightings(scaling_day)
                create hg index idx2 on ${SQLFILE_ARG001}.SC3_Weightings(scaling_segment_ID)
                commit
...
-- SC3_Intervals
        ...
        begin
                ...
                create index for_joining on ${SQLFILE_ARG001}.SC3_Intervals (scaling_segment_ID, reporting_starts)
                create hg index idx1 on ${SQLFILE_ARG001}.SC3_Intervals (account_number)
                commit
...
-- VESPA_HOUSEHOLD_WEIGHTING
        ...
        begin
                ...
                create dttm index for_loading on ${SQLFILE_ARG001}.VESPA_HOUSEHOLD_WEIGHTING (build_date)
                create hg index idx1 on ${SQLFILE_ARG001}.VESPA_HOUSEHOLD_WEIGHTING (account_number)
                create hg index idx2 on ${SQLFILE_ARG001}.VESPA_HOUSEHOLD_WEIGHTING (cb_key_household)
                create date index idx3 on ${SQLFILE_ARG001}.VESPA_HOUSEHOLD_WEIGHTING (scaling_date)
                commit
...
-- SC3_scaling_weekly_sample
        ...
        begin
                ...
                CREATE INDEX for_segment_identification_raw ON ${SQLFILE_ARG001}.SC3_scaling_weekly_sample(isba_tv_region,hhcomposition, tenure, package, no_of_stbs, hd_subscription, pvr)
                CREATE INDEX experian_joining ON ${SQLFILE_ARG001}.SC3_scaling_weekly_sample (consumerview_cb_row_id)
                CREATE INDEX for_grouping1 ON ${SQLFILE_ARG001}.SC3_scaling_weekly_sample (population_scaling_segment_id)
                CREATE INDEX for_grouping2 ON ${SQLFILE_ARG001}.SC3_scaling_weekly_sample (vespa_scaling_segment_id)
                COMMIT
...
-- SC3_weighting_working_table
        ...
        begin
                ...
                CREATE HG INDEX indx_un on ${SQLFILE_ARG001}.SC3_weighting_working_table(sky_base_universe)
                COMMIT
...
-- SC3_category_working_table
        ...
        begin
                ...
                create hg index indx_universe on ${SQLFILE_ARG001}.SC3_category_working_table(sky_base_universe)
                create hg index indx_profile on ${SQLFILE_ARG001}.SC3_category_working_table(profile)
                create hg index indx_value on ${SQLFILE_ARG001}.SC3_category_working_table(value)
                COMMIT
...
-- SC3_category_subtotals
        ...
        begin
                ...
                create index indx_date on ${SQLFILE_ARG001}.SC3_category_subtotals(scaling_date)
                create hg index indx_universe on ${SQLFILE_ARG001}.SC3_category_subtotals(sky_base_universe)
                create hg index indx_profile on ${SQLFILE_ARG001}.SC3_category_subtotals(profile)
                COMMIT
...
-- SC3_metrics
        ...
        begin
                ...
                create index indx_date on ${SQLFILE_ARG001}.SC3_metrics(scaling_date)
                commit
...
-- SC3_non_convergences
        ...
        begin
                ...
                create index indx_date on ${SQLFILE_ARG001}.SC3_non_convergences(scaling_date)
                commit
...
-- BARB_PVF05_Panel_Member_Responses_Weights_and_Viewing_Categories
        ...
        begin
                ...
                create table ${SQLFILE_ARG001}.BARB_PVF05_Panel_Member_Responses_Weights_and_Viewing_Categories (
                        ...
                        ,Processing_Weight                                                      int DEFAULT NULL		NULL
                ...
                create hg index ind_hhd on ${SQLFILE_ARG001}.BARB_PVF05_Panel_Member_Responses_Weights_and_Viewing_Categories(Household_Number)
                create lf index ind_person on ${SQLFILE_ARG001}.BARB_PVF05_Panel_Member_Responses_Weights_and_Viewing_Categories(Person_Number)
                create lf index ind_panel on ${SQLFILE_ARG001}.BARB_PVF05_Panel_Member_Responses_Weights_and_Viewing_Categories(Reporting_Panel_Code)
                create lf index ind_date on ${SQLFILE_ARG001}.BARB_PVF05_Panel_Member_Responses_Weights_and_Viewing_Categories(Date_of_Activity_DB1)
                commit
...
-- V289_M13_individual_viewing_live_vosdal
                ...
                begin
                        ...
                        create hg index hg_idx_1 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_live_vosdal(SUBSCRIBER_ID)
                        create hg index hg_idx_2 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_live_vosdal(ACCOUNT_NUMBER)
                        create hg index hg_idx_3 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_live_vosdal(DTH_VIEWING_EVENT_ID)
                        commit
...
-- V289_M13_individual_viewing_timeshift_pullvod
                ...
                begin
                        ...
                        create hg index hg_idx_1 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_timeshift_pullvod(SUBSCRIBER_ID)
                        create hg index hg_idx_2 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_timeshift_pullvod(ACCOUNT_NUMBER)
                        create hg index hg_idx_3 on ${SQLFILE_ARG001}.V289_M13_individual_viewing_timeshift_pullvod(DTH_VIEWING_EVENT_ID)
                        commit
...
-- V289_M13_individual_details
                ...
                begin
                        ...
                        create hg index hg_idx_1 on ${SQLFILE_ARG001}.V289_M13_individual_details(account_number)
                        commit
...
-- barb_rawview
        ...
        IF EXISTS(SELECT tname FROM syscatalog WHERE creator = '${SQLFILE_ARG001}' and tabletype = 'VIEW' and upper(tname) = 'BARB_RAWVIEW')
            drop view ${SQLFILE_ARG001}.BARB_RAWVIEW
...
-- Barb_skytvs
        ...
        IF EXISTS(SELECT tname FROM syscatalog WHERE creator = '${SQLFILE_ARG001}' and tabletype = 'VIEW' and upper(tname) = 'BARB_SKYTVS')
            drop view ${SQLFILE_ARG001}.BARB_SKYTVS
