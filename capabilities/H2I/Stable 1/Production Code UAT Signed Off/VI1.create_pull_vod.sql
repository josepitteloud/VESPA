...
--------------------------
                        ...
                        if  exists(  select tname from syscatalog
                                        ...
                                        and     tabletype = 'TABLE')
                                        truncate table ${SQLFILE_ARG001}.v289_M17_vod_raw_data
                        ...
                        if  exists(  select tname from syscatalog
                         ...
                         -- verifying our step table is free for re-usage
                                        drop table ${SQLFILE_ARG001}.v289_m17_pseudo
                        ...
                        set @query =    'if  exists(  select tname from syscatalog where upper(creator) = ''${SQLFILE_ARG001}'' and upper(tname) = upper('''||@dp_tname||''')  ) '||
