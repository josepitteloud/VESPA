...
-- Create procedure
create or replace procedure ${SQLFILE_ARG001}.v289_M10_individuals_selection as begin
...
-- Initialise progress log and update
                        ...
                        and     tabletype = 'TABLE')
                                drop table ${SQLFILE_ARG001}.V289_M10_log commit --(^_^ )!

create table ${SQLFILE_ARG001}.V289_M10_log(
...
insert into ${SQLFILE_ARG001}.V289_M10_log(section_id)
select section_id
from
        (
...
update ${SQLFILE_ARG001}.V289_M10_log
set
                dt_completed    =       now()
        ,       completed               =       1
...
if
    (
                ...
                begin
                        insert into ${SQLFILE_ARG001}.V289_M10_log(
                                        section_id
                                ,       dt_completed
                                )
                        select 
...
-- Combined event data that gives all possible audience individuals from the household of each viewing event and their PIV
                        ...
                        and     tabletype = 'TABLE')
                                drop table ${SQLFILE_ARG001}.V289_M10_combined_event_data commit --(^_^ )!

create table ${SQLFILE_ARG001}.V289_M10_combined_event_data(
...
create hg       index   V289_M10_combined_event_data_hg_idx_1   on ${SQLFILE_ARG001}.V289_M10_combined_event_data(account_number) commit --(^_^ )!
create hg       index   V289_M10_combined_event_data_hg_idx_2   on ${SQLFILE_ARG001}.V289_M10_combined_event_data(event_id) commit --(^_^ )!
create hg       index   V289_M10_combined_event_data_hg_idx_3   on ${SQLFILE_ARG001}.V289_M10_combined_event_data(numrow) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_lf_idx_4   on ${SQLFILE_ARG001}.V289_M10_combined_event_data(session_size) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_lf_idx_5   on ${SQLFILE_ARG001}.V289_M10_combined_event_data(person_gender) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_lf_idx_6   on ${SQLFILE_ARG001}.V289_M10_combined_event_data(person_ageband) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_lf_idx_7   on ${SQLFILE_ARG001}.V289_M10_combined_event_data(household_size) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_lf_idx_8   on ${SQLFILE_ARG001}.V289_M10_combined_event_data(viewer_hhsize) commit --(^_^ )!
...
-- Date-agnostic gender-age PIV (default)
                        ...
                        and     tabletype = 'TABLE')
                                drop table ${SQLFILE_ARG001}.V289_M10_PIV_default commit --(^_^ )!

create table ${SQLFILE_ARG001}.V289_M10_PIV_default(
...
-- Date-agnostic gender-age PIV (by date)
                        ...
                        and     tabletype = 'TABLE')
                                drop table ${SQLFILE_ARG001}.V289_M10_PIV_by_date commit --(^_^ )!

create table ${SQLFILE_ARG001}.V289_M10_PIV_by_date(
...
-- It will only viewing events from the input table [V289_M07_dp_data] if certain conditions are met, such as there being a valid session_size etc.
                        ...
                        and     tabletype = 'TABLE')
                                drop table ${SQLFILE_ARG001}.V289_M10_session_individuals
commit --(^_^ )!

create table ${SQLFILE_ARG001}.V289_M10_session_individuals(
...
create hg index                 V289_M10_session_individuals_hg_idx_1           on ${SQLFILE_ARG001}.V289_M10_session_individuals(event_id) commit --(^_^ )!
create hg index                 V289_M10_session_individuals_hg_idx_2           on ${SQLFILE_ARG001}.V289_M10_session_individuals(account_number) commit --(^_^ )!
create lf index                 V289_M10_session_individuals_lf_idx_3           on ${SQLFILE_ARG001}.V289_M10_session_individuals(overlap_batch) commit --(^_^ )!
create dttm index               V289_M10_session_individuals_dttm_idx_4         on ${SQLFILE_ARG001}.V289_M10_session_individuals(chunk_start) commit --(^_^ )!
create date index               V289_M10_session_individuals_dttm_idx_5         on ${SQLFILE_ARG001}.V289_M10_session_individuals(event_date) commit --(^_^ )!
create dttm index               V289_M10_session_individuals_dttm_idx_6         on ${SQLFILE_ARG001}.V289_M10_session_individuals(last_modified_dt) commit --(^_^ )!
...
-- Initiate log of unique individuals/viewers to be used to reduce the number of unassigned viewers at the end of the process
                        ...
                        and     tabletype = 'TABLE')
                                drop table ${SQLFILE_ARG001}.V289_M10_UNIQUE_VIEWERS_EVENT_ASSIGNMENT
commit --(^_^ )!
...
CREATE UNIQUE HG INDEX UHG_IDX_1 ON ${SQLFILE_ARG001}.V289_M10_UNIQUE_VIEWERS_EVENT_ASSIGNMENT(PERSON_ID)
commit --(^_^ )!
CREATE HG INDEX HG_IDX_1 ON ${SQLFILE_ARG001}.V289_M10_UNIQUE_VIEWERS_EVENT_ASSIGNMENT(ACCOUNT_NUMBER)
commit --(^_^ )!
CREATE HG INDEX HG_IDX_2 ON ${SQLFILE_ARG001}.V289_M10_UNIQUE_VIEWERS_EVENT_ASSIGNMENT(HH_PERSON_NUMBER)
commit --(^_^ )!
...
-- Combined event data that gives all possible audience individuals from the household of each viewing event and their PIV
                        ...
                        and     tabletype = 'TABLE')
                                drop table ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj commit --(^_^ )!

create table ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(
        account_number                  varchar(20)             not     null
        ,       hh_person_number                tinyint                 not     null
    ,   subscriber_id                   decimal(10)             not     null
    ,   event_id                        bigint                  not     null
...
create hg       index   V289_M10_combined_event_data_adj_hg_idx_1   on ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(account_number) commit --(^_^ )!
create hg       index   V289_M10_combined_event_data_adj_hg_idx_2   on ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(event_id) commit --(^_^ )!
create hg       index   V289_M10_combined_event_data_adj_hg_idx_3   on ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(numrow) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_adj_lf_idx_4   on ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(session_size) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_adj_lf_idx_5   on ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(person_gender) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_adj_lf_idx_6   on ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(person_ageband) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_adj_lf_idx_7   on ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(household_size) commit --(^_^ )!
create lf       index   V289_M10_combined_event_data_adj_lf_idx_8   on ${SQLFILE_ARG001}.V289_M10_combined_event_data_adj(viewer_hhsize) commit --(^_^ )!
