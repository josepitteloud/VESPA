...
create or replace procedure ${SQLFILE_ARG001}.v289_m08_Experian_data_preparation
AS BEGIN
       ...
       if (datediff(day,@last_update_dt,today()) > 6 or @last_update_dt is null)
        begin
                ...
                if  exists(  select tname from syscatalog
                        ...
                        and     tabletype = 'TABLE')                
                TRUNCATE TABLE ${SQLFILE_ARG001}.V289_M08_SKY_HH_view   commit
           ...
           MESSAGE cast(now() as timestamp)||' | @ M08.3 2nd round finished ' TO CLIENT 
                ...
                if  exists(  select tname from syscatalog
                        ...
                        and     tabletype = 'TABLE')
                TRUNCATE TABLE ${SQLFILE_ARG001}.V289_M08_SKY_HH_composition
                ...
                FROM    PLAYPEN_CONSUMERVIEW_PERSON_AND_HOUSEHOLD e
