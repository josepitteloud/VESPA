create or replace procedure pitteloudj.v289_M19_Non_Viewing_Households (@processing_day DATE)
AS
BEGIN
	message convert(TIMESTAMP, now()) || ' | Begining M19.0 - Initialising Environment' TO client message convert(TIMESTAMP, now()) || ' | @ M19.0: Initialising Environment DONE' TO client 
