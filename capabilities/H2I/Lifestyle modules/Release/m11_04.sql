CREATE OR REPLACE PROCEDURE ${SQLFILE_ARG001}.V289_M11_04_SC3I_v1_1__make_weights_sv_BARB_sv (
	@profiling_date DATE
	,@scaling_day DATE
...
BEGIN
	...
	TRUNCATE TABLE ${SQLFILE_ARG001}.V289_M11_04_Barb_weighted_population_sv
	...
	BEGIN
		TRUNCATE TABLE ${SQLFILE_ARG001}.SC3I_category_working_table_sv
	...
	IF EXISTS (SELECT tname FROM syscatalog WHERE creator = '${SQLFILE_ARG001}'  AND upper(tname) = upper('SC3I_weighting_working_table_2_sv') AND tabletype = 'TABLE' )
	DROP TABLE SC3I_weighting_working_table_2_sv
	...
	IF EXISTS (SELECT tname FROM syscatalog WHERE creator = '${SQLFILE_ARG001}'  AND upper(tname) = upper('SC3I_Weightings_2_sv') AND tabletype = 'TABLE' )
	DROP TABLE SC3I_Weightings_2_sv
	...
	------------------------------ FINAL OUTPUT
	TRUNCATE TABLE ${SQLFILE_ARG001}.V289_M11_04_VESPA_INDIVIDUAL_WEIGHTING_sv
