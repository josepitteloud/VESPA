-- If running after a stable run (assuming this is not in stable, but still in dev)
-- then do the following to apply NonViewing Households Sclaing effects to the results:
-- 1. Run SQL: alter table V289_M08_SKY_HH_COMPOSITION add  nonviewer_household   TINYINT
-- 2. Run SQL: drop table V289_M11_04_Barb_weighted_population;
...
--
-- 3. execute this module
-- 4. execute the scaling new modules
...
--------------------------------------
        ...
        select
                ...
                ,       case
                                ...
                                WHEN age BETWEEN 20 AND 24      then '20-44'
                                WHEN age >= 45                          then '45+'
                        end                                             as      ageband
