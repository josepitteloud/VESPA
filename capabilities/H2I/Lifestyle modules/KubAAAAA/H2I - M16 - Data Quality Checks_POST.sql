...
create or replace procedure v289_m16_data_quality_checks_post
	@proc_date 		date = null
	,@sample_proc	INT
...
---- PARAMETERS
	...
	IF NOT EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'V289_M16_POST_METRICS')		
