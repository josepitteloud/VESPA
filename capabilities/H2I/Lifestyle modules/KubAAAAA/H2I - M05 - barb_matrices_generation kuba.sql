...
--******************************************************************************************************
--------------------------------------------------------------------------------------------------------.
IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'PROP_TABLE')   drop table prop_table
IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'V289_VSIZEALLOC_MATRIX_SMALL')   drop table v289_vsizealloc_matrix_small
IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'V289_VSIZEALLOC_MATRIX_BIG')   drop table v289_vsizealloc_matrix_big
...
---------------------------------------------------------------------------------------------------------------------------------------
        ...
        IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'V289_NONVIEWERS_MATRIX')   drop table v289_nonviewers_matrix
        ...
        /*
                ...
                and programme genre...
        */
        IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'V289_GENDERAGE_MATRIX')   drop table v289_genderage_matrix
        ...
        */
        ...
        IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'V289_SESSIONSIZE_MATRIX')   drop table v289_sessionsize_matrix
    ...
    IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'V289_SESSIONSIZE_MATRIX_ID')   drop table v289_sessionsize_matrix_ID
    ...
    commit
        ...
        IF  EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'V289_SESSIONSIZE_MATRIX_DEFAULT')   drop table v289_sessionsize_matrix_default
