...
--------------------------------------
                ...
                */
                ...
                select  mega.*
                                                ,z.sex
                                                ,case   when z.age between 0 and 19             then '0-19'
														when z.age between 20 and 44    then '20-44'
                                                        when z.age >= 45                then '45+'  
														end     as ageband
                ...
                from    (
                                                        ...
                                                        from    (
                                                                                ...
                                                                                select  viewing.household_number
                                                                                                ...
                                                                                                ,coalesce(viewing.genre_description,'Unknown')  as programme_genre
                                                                                ...
                                                                                from    ripolile.barb_daily_ind_prog_viewed_output  as viewing                                                                                  -- [UNCOMENT FOR FINAL VERSION]
                                                                                                ...
                                                                                                left join
                                                                                                            (select     s.service_key, l.programme_genre, s.EFFECTIVE_FROM, s.EFFECTIVE_TO
                                                                                                            from        vespa_Analysts.CHANNEL_MAP_PROD_SERVICE_KEY_ATTRIBUTES s
                                                                                                            inner join  V289_M04_Channel_Genre_Lookup l on s.channel_genre = l.channel_genre) ska
                                                                                                on viewing.service_key = ska.service_key
                                                                                                and viewing.local_start_time_of_session between ska.EFFECTIVE_FROM and ska.EFFECTIVE_TO
