...
-- BARB_Individual_Panel_Member_Details
	...
	IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'BARB_INDIVIDUAL_PANEL_MEMBER_DETAILS') 
...
-- BARB_PVF04_Individual_Member_Details
	...
	IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'BARB_PVF04_INDIVIDUAL_MEMBER_DETAILS') 
...
-- BARB_Panel_Member_Responses_Weights_and_Viewing_Categories
	...
	IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'BARB_PANEL_MEMBER_RESPONSES_WEIGHTS_AND_VIEWING_CATEGORIES') 
...
-- BARB_PVF_Viewing_Record_Panel_Members
	...
	IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'BARB_PVF_VIEWING_RECORD_PANEL_MEMBERS')
...
-- BARB_PVF06_Viewing_Record_Panel_Members
	...
	IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'BARB_PVF06_VIEWING_RECORD_PANEL_MEMBERS') 
...
-- BARB_Panel_Demographic_Data_TV_Sets_Characteristics	
	...
	IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'BARB_PANEL_DEMOGRAPHIC_DATA_TV_SETS_CHARACTERISTICS') 
...
-- BARB_PVF05_Panel_Member_Responses_Weights_and_Viewing_Categories
	...
	IF EXISTS(SELECT tname FROM syscatalog WHERE creator = user_name() and tabletype = 'TABLE' and upper(tname) = 'BARB_PVF05_PANEL_MEMBER_RESPONSES_WEIGHTS_AND_VIEWING_CATEGORIES') 
