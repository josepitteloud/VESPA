...
IF object_id('v289_vsizealloc_matrix_small') IS NOT NULL      DROP TABLE v289_vsizealloc_matrix_small
IF object_id('v289_vsizealloc_matrix_big') IS NOT NULL      DROP TABLE v289_vsizealloc_matrix_big
...
---------------------------------------------------------------------------------------------------------------------------------------
        ...
        if object_id('v289_nonviewers_matrix') is not null
    ...
    group   by  segment_id
        ...
        FROM    (SELECT  DISTINCT         segment_ID      FROM    v289_sessionsize_matrix_ID)   as a
