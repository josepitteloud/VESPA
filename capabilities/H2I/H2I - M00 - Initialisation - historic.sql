...
-- BARB_PVF05_Panel_Member_Responses_Weights_and_Viewing_Categories
    ...
    /*    
 -- Run table logs creation 
 

        if object_id('V289_Master_run_log') is null
        begin
         
			CREATE TABLE V289_Master_run_log (
				  row_id 			INT IDENTITY
				, run_id 			INT DEFAULT 0
				, run_date 			DATE DEFAULT TIMESTAMP
				, start_date 		DATE DEFAULT NULL
				, end_date 			DATE DEFAULT NULL
				, sample_size 		tinyint DEFAULT NULL
				, fresh_start		BIT DEFAULT 0 
		...
		*/
		...
		/*
		if object_id('v289_Process_dates') is null
        begin
			CREATE TABLE v289_Process_dates (
					  calendar_date			AS DATE 
					, processed 			AS BIT 
					, process_started 		AS DATE
					, process_ended 		AS DATE
					, execution_code 		AS INT 
					, run_id 				AS INT 
					, Updated_By       		AS VARCHAR(30) DEFAULT user_name())
...
-- barb_weights
        ...
        if object_id('barb_weights') is null
        begin
