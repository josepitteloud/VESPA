...
# - Input table (VESPA_MinAttr_Phase1_02_All_Live_Viewing) with the following fields:
#     - viewing_starts
#     - viewing_stops
#     - Viewing_Starts_Min
#     - Viewing_Stops_Min
...
# 23/08/2012  SBE   v02 - adjusted to meet requirements of C02 v03
#
###############################################################################*/


if object_id('Minute_Attribution_QA_Phase1_v03') is not null then drop procedure Minute_Attribution_QA_Phase1_v03 endif;
commit;

create procedure Minute_Attribution_QA_Phase1_v03
...
begin
 -- #### (procedure start) #####
      ...
      set @varProcessIdentifier        = 'Vespa_MinAttrP1QAV03'
                ...
                from (select
                        ...
                        from (select
                              ...
                              select
                                    ...
                                    '1) Surfing' as Source
                                from VESPA_SURF_MINUTES_PHASE1) det
