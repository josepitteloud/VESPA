 ...
 commit
    ...
    EXEC barbera.vespa_comscore_skygo_run_build @data_run_date, @suppress_stats_universe_build, @lower_limit, @stddev_over_rows, @weighting_rows



  /* code_location_A02 *********************************************************
     *****                                                                      **
     *****   Example of running the process for a number of consecutive dates   **
     *****                                                                      **
     *****************************************************************************/
    ...
    -- CHANGE THESE DATES
    SET @date_start = '2016-06-02'
    SET @date_end   = '2016-06-05'
    ...
    while datediff(DAY, @date_start, @date_end) >= 0
        BEGIN
                SET @data_run_date = @date_start
                --do stuff
    ...
    commit
    select top 1000 *
      from barbera.VESPA_Comscore_SkyGo_log_tbl
     order by log_datetime asc

        --VESPA_Comscore_SkyGo_log_tbl

--tables changed name for + logging proc name
  barbera.VESPA_Comscore_SkyGo_log_tbl
  barbera.VESPA_Comscore_SkyGo_universe_tbl
  barbera.VESPA_Comscore_SkyGo_SAV_account_type_tbl
  barbera.VESPA_Comscore_SkyGo_SAV_summary_tbl
  barbera.VESPA_Comscore_SkyGo_audit_stats_tbl
  barbera.VESPA_Comscore_SkyGo_audit_run_tbl
  barbera.VESPA_Comscore_SkyGo_201408

--logging proc change
barbera.VESPA_Comscore_log  --->  VESPA_Comscore_SkyGo_log
...
commit
    ...
    select top 1000 *
      from barbera.VESPA_Comscore_SkyGo_SAV_account_type_tbl
    ...
    select count(1) sample_count
      from barbera.VESPA_Comscore_SkyGo_201408
    ...
    select max(latest_data_utc) latest_data_received_utc,
      ...
      from barbera.VESPA_Comscore_universe_tbl
...
commit
select top 100 *
from barbera.V239_comscore_event_tmp3
where sam_profileid = 10006184
...
commit
select top 100 *
from barbera.V239_comscore_event_tmp2
where sam_profileid = 10006184
order by uniqid

--strips out events like end - pause, pause - end
select top 100 *
from barbera.V239_comscore_event_tmp
...
commit
select top 100 *
from barbera.V239_comscore_view2
where sam_profileid = 10006184
...
commit
select *
from barbera.VESPA_SkyGo_Comscore_201408
...
select distinct ns_st_ci over()
  from barbera.Comscore_201408



--drop table barbera.VESPA_SkyGo_Comscore_201408
commit
*/
...
--log maintenance
delete barbera.VESPA_Comscore_SkyGo_log_tbl
...
--processing table
select top 1000 *
from barbera.V239_comscore_event_tmp4   ... _tmp
...
grant select on barbera.VESPA_Comscore_audit_stats_tbl to thompsonja
grant select on barbera.VESPA_Comscore_audit_run_tbl to thompsonja

grant select on barbera.VESPA_Comscore_SkyGo_linear_channel_mapping_audit_tbl to thompsonja

grant select on barbera.VESPA_Comscore_universe_tbl to thompsonja

grant select on barbera.VESPA_SkyGo_Comscore_201408 to thompsonja
