...
IF object_id('SC2_v2_1__do_weekly_segmentation') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__do_weekly_segmentation END IF;

create procedure SC2_v2_1__do_weekly_segmentation
...
end; -- of procedure "SC2_v2_1__do_weekly_segmentation"
commit;
...
IF object_id('SC2_v2_1__prepare_panel_members') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__prepare_panel_members END IF;

create procedure SC2_v2_1__prepare_panel_members
...
end; -- of procedure "SC2_v2_1__prepare_panel_members"
commit;



IF object_id('SC2_v2_1__make_weights') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__make_weights END IF;

create procedure SC2_v2_1__make_weights
...
end; -- of procedure "SC2_v2_1__make_weights"
commit;



-- These are the things we want to test each time some scaling is built for a day:
IF object_id('SC2_v2_1__daily_QA_units') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__daily_QA_units END IF;

create procedure SC2_v2_1__daily_QA_units
...
begin
     ...
     commit
     execute logger_add_event @Scale_refresh_logging_ID, 3, 'SC2: daily QA complete!'
     commit

end; -- of procedure "SC2_v2_1__daily_QA_units"
commit;



-- Whereas other unit tests are only applied each time the weely segmentation is refreshed:
IF object_id('SC2_v2_1__weekly_QA_units') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__weekly_QA_units END IF;

create procedure SC2_v2_1__weekly_QA_units
    @Scale_refresh_logging_ID   bigint
    ,@checkdate                 date
as
begin
     ...
     from SC2_Intervals as l
     inner join SC2_Intervals as r
     ...
     from SC2_Intervals as i
     left join SC2_scaling_weekly_sample as s
     ...
     commit
     execute logger_add_event @Scale_refresh_logging_ID, 3, 'SC2: weekly QA complete!'
     commit

end; -- of procedure "SC2_v2_1__weekly_QA_units"
commit;
...
-- table.
IF object_id('SC2_v2_1__scale_Vespa_panel') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__scale_Vespa_panel END IF;

create procedure SC2_v2_1__scale_Vespa_panel
...
begin
    ...
    -- Do all the work!
    EXECUTE SC2_v2_1__prepare_panel_members   @scaling_day, @batch_date, @Scale_refresh_logging_ID
    ...
    commit
    EXECUTE SC2_v2_1__make_weights            @scaling_day, @batch_date, @Scale_refresh_logging_ID
    commit
...
end; -- of procedure "SC2_v2_1__scale_Vespa_panel"
...
--grant execute on SC2_v2_1__do_weekly_segmentation     to CITeam, vespa_analysts, sk_prod, sk_prodreg;
--grant execute on SC2_v2_1__prepare_panel_members      to CITeam, vespa_analysts, sk_prod, sk_prodreg;
--grant execute on SC2_v2_1__make_weights               to CITeam, vespa_analysts, sk_prod, sk_prodreg;
--grant execute on SC2_v2_1__daily_QA_units             to CITeam, vespa_analysts, sk_prod, sk_prodreg;
--grant execute on SC2_v2_1__scale_Vespa_panel          to CITeam, vespa_analysts, sk_prod, sk_prodreg;
