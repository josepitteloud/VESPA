...
-- ####################################################################################################
-- ####################################################################################################
--            This version uses the OLD data model (i.e VESPA_EVENTS_ALL)
-- ####################################################################################################
-- ####################################################################################################
-- ####################################################################################################
...
IF object_id('SC2_v2_1__do_weekly_segmentation_VEA') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__do_weekly_segmentation_VEA END IF;

create procedure SC2_v2_1__do_weekly_segmentation_VEA
...
end; -- of procedure "SC2_v2_1__do_weekly_segmentation_VEA"
commit;
...
IF object_id('SC2_v2_1__prepare_panel_members_VEA') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__prepare_panel_members_VEA END IF;

create procedure SC2_v2_1__prepare_panel_members_VEA
...
end; -- of procedure "SC2_v2_1__prepare_panel_members_VEA"
commit;



IF object_id('SC2_v2_1__make_weights_VEA') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__make_weights_VEA END IF;

create procedure SC2_v2_1__make_weights_VEA
...
end; -- of procedure "SC2_v2_1__make_weights_VEA"
commit;
...
-- table.
IF object_id('SC2_v2_1__scale_Vespa_panel_VEA') IS NOT NULL THEN DROP PROCEDURE SC2_v2_1__scale_Vespa_panel_VEA END IF;

create procedure SC2_v2_1__scale_Vespa_panel_VEA
...
begin
    ...
    -- Do all the work!
    EXECUTE SC2_v2_1__prepare_panel_members_VEA   @scaling_day, @batch_date, @Scale_refresh_logging_ID
    ...
    commit
    EXECUTE SC2_v2_1__make_weights_VEA            @scaling_day, @batch_date, @Scale_refresh_logging_ID
    commit
...
end; -- of procedure "SC2_v2_1__scale_Vespa_panel_VEA"
...
--grant execute on SC2_v2_1__do_weekly_segmentation_VEA     to CITeam, vespa_analysts, sk_prod, sk_prodreg;
--grant execute on SC2_v2_1__prepare_panel_members_VEA      to CITeam, vespa_analysts, sk_prod, sk_prodreg;
--grant execute on SC2_v2_1__make_weights_VEA               to CITeam, vespa_analysts, sk_prod, sk_prodreg;
--grant execute on SC2_v2_1__daily_QA_units             to CITeam, vespa_analysts, sk_prod, sk_prodreg;
--grant execute on SC2_v2_1__scale_Vespa_panel_VEA          to CITeam, vespa_analysts, sk_prod, sk_prodreg;
