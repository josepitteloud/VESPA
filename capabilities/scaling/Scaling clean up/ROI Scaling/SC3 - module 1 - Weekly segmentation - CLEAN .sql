CREATE OR REPLACE PROCEDURE SC3_ROI_do_weekly_segmentation 
...
*/
    ...
    FROM SC3_ROI_scaling_weekly_sample AS a
	JOIN /*vespa_analysts.*/SC3_ROI_Segments_lookup AS ssl ON trim(lower(a.sky_base_universe)) = trim(lower(ssl.sky_base_universe))
