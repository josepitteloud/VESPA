...
begin
    ...
    set     @playback_days = 28                     -- Want to be able to treat timeshifting of up to 28 days (consistency with BARB)
    ...
    declare @min_view_duration_sec  tinyint         -- The bound below which views are ignored, in seconds ("surfing")
