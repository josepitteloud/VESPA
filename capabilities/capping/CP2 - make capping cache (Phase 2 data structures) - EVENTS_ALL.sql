...
if object_id('CP2_build_days_caps_VEA') is not null drop procedure CP2_build_days_caps_VEA;
commit;

go

create procedure CP2_build_days_caps_VEA
...
end; -- procedure CP2_build_days_caps_VEA
...
if object_id('CP2_Profile_Boxes_VEA') is not null drop procedure CP2_Profile_Boxes_VEA;
commit;

go

create procedure CP2_Profile_Boxes_VEA
...
end; -- procedure CP2_Profile_Boxes_VEA
