...
UPDATE ${CBAF_DB_DATA_SCHEMA}.ADSMART a
 ...
 ,  residency =  CASE  WHEN sav.PTY_COUNTRY_CODE LIKE 'GBR' THEN 'UK'
                       WHEN sav.PTY_COUNTRY_CODE LIKE 'IRL' THEN 'ROI'
                       ELSE  'Unknown'
                 END
...
UPDATE ${CBAF_DB_DATA_SCHEMA}.ADSMART SET
	...
	family_lifestage		= 'Unknown',
        bundle_type                     = 'Unknown',
    sky_endoffer_tv        	= 'Unknown',
    sky_endoffer_bb        	= 'Unknown',
    sky_endoffer_talk_lr    = 'Unknown',
    sky_cyclical        	= 'Unknown',
    mobile_usage_segment    = 'Unknown',
    impression_demand       = 'Unknown',
    revenue_demand        	= 'Unknown',
    non_sky_sport_viewing   = 'Unknown',
    skyq        			= 'Unknown',
