...
# Description:  Gives a user a sample select for identifying postcode mosaic type
#		for Scottish Households.
#
#################################################################################
# Dependencies
# ------------------------------------------------------------------------------
...
/*###############################################################################
#pc_mosaic_scotland_type	Postcode mosaic Scotland type	
#
#
#Mosaic Scotland is a geodemographic classification which provides the most detailed and meaningful information 
#about people living in Scotland. Covering 2.4 million households, Mosaic Scotland classifies 
#each Scottish postcode into one of 10 groups and 44 types.  
#Mosaic Scotland is designed specifically to help identify the characteristics that make living in Scotland 
#different from the rest of the UK. It paints a rich picture of Scottish consumers in terms of socio-demographics, 
...
else 'Unclassified' end 'Postcode mosaic Scotland type'
from sk_prod.experian_consumerview
where pc_mosaic_scotland_type is not null
