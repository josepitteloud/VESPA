...
# Description:  Gives a user a sample select for identifying the UK HH Mosaic type
#
#################################################################################
# Dependencies
# ------------------------------------------------------------------------------
...
/*###############################################################################
#h_mosaic_uk_type	Household mosaic UK type	
#
#Mosaic UK 2009 is a geodemographic classification that paints a rich picture of UK consumers in terms of socio-demographics, 
...
else null end 'Household mosaic UK type'
from sk_prod.experian_consumerview where h_mosaic_uk_type is not null
