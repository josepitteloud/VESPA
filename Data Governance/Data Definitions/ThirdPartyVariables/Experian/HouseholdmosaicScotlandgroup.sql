...
# Description:  Gives a user a sample select for Scottish Mosaic HH Group
#
#################################################################################
# Dependencies
# ------------------------------------------------------------------------------
...
/*###############################################################################
#h_mosaic_scotland_group	Household mosaic Scotland group	
#
#Mosaic Scotland is a geodemographic classification which provides the most detailed 
#and meaningful information about people living in Scotland. 
#Covering 2.4 million households, Mosaic Scotland classifies each Scottish postcode 
...
case h_mosaic_scotland_household_groups 
...
else 'Unclassified' end 'Household mosaic Scotland group'
from sk_prod.experian_consumerview
where h_mosaic_scotland_household_groups is not null
